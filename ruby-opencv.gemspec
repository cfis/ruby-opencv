...
Gem::Specification.new do |spec|
  ...
  spec.extensions = ["ext/opencv2/CMakeLists.txt"]
  ...
  spec.files = Dir.glob([".gitignore",
                         ...
                         "config.yml",
                         "examples/**/*.rb",
                         "ext/opencv2/CMakeLists.txt",
                         "ext/opencv2/CMakePresets.txt",
                         "ext/opencv2/ruby_opencv.def",
                         "ext/opencv2/ruby_opencv-rb.cpp",
                         "ext/opencv2/ruby_opencv-rb.hpp",
                         "ext/opencv2/*.*",
                         "test/*.rb"])
