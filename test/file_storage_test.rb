...
class FileStorageTest < OpenCVTestCase
  def test_write
    ...
    camera_matrix = Cv::Mat1d.new(3, 3, [1000, 0, 320, 0, 1000, 240, 0, 0, 1])
    dist_coeffs = Cv::Mat1d.new(5, 1, [0.1, 0.01, -0.001, 0, 0])
    ...
    expected = <<~EOS.chomp
      ...
      ---
      frameCount: 5
      calibrationDate: \"2024-01-27T00:00:00+00:00\"
      cameraMatrix: !!opencv-matrix
         rows: 3
         cols: 3
         dt: d
         data: [ -1.4568159901474629e+144, -1.4568159901474629e+144,
             -1.4568159901474629e+144, -1.4568159901474629e+144,
             -1.4568159901474629e+144, -1.4568159901474629e+144,
             -1.4568159901474629e+144, -1.4568159901474629e+144,
             -1.4568159901474629e+144 ]
      distCoeffs: !!opencv-matrix
         rows: 5
         cols: 1
         dt: d
         data: [ 0.10000000000000001, 0.01, -0.001, 0., 0. ]
      features:
         - { x:0, y:0, lbp:[ 0, 1, 0, 1, 0, 1, 0, 1 ] }
         - { x:1, y:1, lbp:[ 0, 1, 0, 1, 0, 1, 0, 1 ] }
         - { x:2, y:2, lbp:[ 0, 1, 0, 1, 0, 1, 0, 1 ] }
  ...
  def test_read
    ...
    assert_in_delta(-1.4568159901474629e+144, element)
