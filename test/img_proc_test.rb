...
class ImgProcTest < OpenCVTestCase
  ...
  def test_cvt_color
    ...
    Cv::cvt_color(image.input_array, gray_image.output_array, Cv::ColorConversionCodes::COLOR_BGR2GRAY)
  ...
  def test_pre_corner_detect
    ...
    transformed = Cv::Mat.new
    Cv::pre_corner_detect(image.input_array, transformed.output_array, 5)
    assert_equal('ec3e88035bb98b5c5f1a08c8e07ab0a8', hash_img(transformed))
    show_image(transformed)
  end
  ...
  def test_corner_eigen_vals_and_vecs
    ...
    transformed = Cv::Mat.new
    transformed = Cv::Mat6FC
    Cv::corner_eigen_vals_and_vecs(image.input_array, transformed.output_array, 3, 3)
