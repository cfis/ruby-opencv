...
class ImgProcTest < OpenCVTestCase
  ...
  def test_copy_make_border
    mat = Cv::Mat.new(32, 32, CV_8UC1, Cv::Scalar.new(128))

    mat1 = mat.copy_make_border(16, 80, 8, 56, Cv::BorderTypes::BORDER_CONSTANT)
    assert_equal('540d2cdcdfba283a0af77524a5cc2c14', hash_img(mat1))
  end
  ...
  def test_corner_min_eigen_val
    ...
    mat1 = mat.corner_min_eigen_val(3, ksize: 3)
