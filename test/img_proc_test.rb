...
class ImgProcTest < OpenCVTestCase
  ...
  #   mask = create_mat(mat0.rows, mat0.cols, :cv8u, 1) { |j, i, c|
  ...
  #
  # def test_erode
  #   mat0 = create_mat(9, 9, :cv8u, 1) { |j, i, c|
  ...
  #     end
  #   }
  #   mat1 = create_mat(9, 9, :cv8u, 1) { |j, i, c|
  ...
  #     end
  #   }
  #   mat2 = create_mat(5, 5, :cv8u, 1) { |j, i, c|
  #     if i == 2 or j == 2
  #       Cv::Scalar.new(255)
  #     else
  #       Cv::Scalar.new(0)
  ...
  #     end
  #   }
  #   mat1 = create_mat(5, 5, :cv8u, 1) { |j, i, c|
  #     if i == 2 or j == 2
  #       Cv::Scalar.new(255)
  #     else
  #       Cv::Scalar.new(0)
  ...
  #
  # def test_morphology
  #   mat0 = create_mat(64, 64, :cv8u, 1) { |j, i, c|
  ...
  #   mat0 = create_mat(32, 32, :cv8u, 1) { Cv::Scalar.new(128) }
  ...
  #
  # def test_integral
  #   mat0 = create_mat(3, 3, :cv8u, 1) { |j, i, n| Cv::Scalar.new(n) }
  #   result_sum = []
  #   result_sqsum = []
  #   result_tiled_sum = []
  ...
  # def test_flood_fill
  #   mat0 = create_mat(128, 256, :cv8u, 1) { |j, i, c|
  ...
  #
  # def test_moments
  #   mat = create_mat(128, 128, :cv8u, 1) { |j, i|
  ...
  #   size = 128
  #   prev = create_mat(size, size, :cv8u, 1) { |j, i|
  ...
  #     end
  #   }
  #   curr = create_mat(size, size, :cv8u, 1) { |j, i|
  ...
  #
  #   # use mask
  #   mask = create_mat(mat0.rows, mat0.cols, :cv8u, 1) { |j, i|
  #     if i < mat0.cols / 2
  #       Cv::Scalar.new(1)
  #     else
  #       Cv::Scalar.new(0)
