...
class OpenCVTestCase < Minitest::Test
  ...
  FILENAME_CAT = File.join(SAMPLE_DIR, 'cat.jpg')
  FILENAME_FRUITS = File.join(SAMPLE_DIR, 'fruits.jpg')
  FILENAME_CONTOURS = File.join(__dir__, 'samples', 'contours.jpg')
  FILENAME_CHESSBOARD = File.join(SAMPLE_DIR, 'chessboard.jpg')
  FILENAME_LINES = File.join(SAMPLE_DIR, 'lines.jpg')
  HAARCASCADE_FRONTALFACE_ALT = File.join(SAMPLE_DIR, 'haarcascade_frontalface_alt.xml.gz')
  AVI_SAMPLE = File.join(SAMPLE_DIR, 'movie_sample.avi')
