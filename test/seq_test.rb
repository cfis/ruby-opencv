...
# Tests for OpenCV::Cv::Seq
class SeqTest < OpenCVTestCase
  def test_initialize
    ...
    types.each { |type|
      kinds.each { |kind|
        flags.each { |flag|
          ...
          assert_equal(Cv::Seq, Cv::Seq.new(seq_flag).class)
        }
      }
    }
  ...
  def test_total
    seq1 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT)
    assert_equal(0, seq1.total)
    seq1.push(Cv::Point.new(1, 2))
    assert_equal(1, seq1.total)
    seq1.push(Cv::Point.new(3, 4))
  ...
  def test_empty
    assert(Cv::Seq.new(CV_SEQ_ELTYPE_POINT).empty?)
  end

  
  def test_aref
    seq1 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT)
    seq1.push(Cv::Point.new(10, 20), Cv::Point.new(30, 40), Cv::Point.new(50, 60))
    assert_equal(Cv::Point, seq1[0].class)
    ...
    seq2 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX)
    seq2.push(10, 20, 30)
  ...
  def test_push
    seq1 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT).push(Cv::Point.new(10, 20), Cv::Point.new(30, 40))
    
    assert_equal(2, seq1.total)
    assert_equal(Cv::Point, seq1[0].class)
    assert_equal(10, seq1[0].x)
    assert_equal(20, seq1[0].y)
    assert_equal(Cv::Point, seq1[1].class)
    assert_equal(30, seq1[1].x)
    assert_equal(40, seq1[1].y)
    seq2 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT).push(Cv::Point.new(50, 60))
    seq2.push(seq1)
    assert_equal(3, seq2.total)
    assert_equal(Cv::Point, seq2[0].class)
    assert_equal(50, seq2[0].x)
    assert_equal(60, seq2[0].y)
    assert_equal(Cv::Point, seq2[1].class)
    assert_equal(10, seq2[1].x)
    assert_equal(20, seq2[1].y)
    assert_equal(Cv::Point, seq2[2].class)
    assert_equal(30, seq2[2].x)
    assert_equal(40, seq2[2].y)
    seq3 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX).push(10)
    seq4 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX).push(20, 30)
    seq3.push(seq4)
    ...
    assert_raise(TypeError) {
      seq3 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX).push(55, 66)
      seq1.push(seq3)
    }
  end
  ...
  def test_pop
    seq1 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT).push(Cv::Point.new(10, 20), Cv::Point.new(30, 40))
    point1 = seq1.pop
    assert_equal(Cv::Point, point1.class)
    ...
    assert_equal(10, seq1[0].x)
    assert_equal(20, seq1[0].y)
    assert_nil(Cv::Seq.new(CV_SEQ_ELTYPE_POINT).pop)
    seq2 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX).push(10, 20, 30)
  ...
  def test_unshift
    seq1 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT).unshift(Cv::Point.new(10, 20), Cv::Point.new(30, 40))
    ...
    seq2 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT).unshift(Cv::Point.new(50, 60))
    seq2.unshift(seq1)
    assert_equal(3, seq2.total)
    assert_equal(Cv::Point, seq1[0].class)
    assert_equal(30, seq1[0].x)
    ...
    seq3 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX).unshift(10, 20, 30)
    assert_equal(3, seq3.total)
    ...
    assert_raise(TypeError) {
      seq3 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX).push(10, 20, 30)
      seq1.unshift(seq3)
    }
  end
  ...
  def test_shift
    ...
    assert_nil(Cv::Seq.new(CV_SEQ_ELTYPE_POINT).shift)
  end

  def test_first
    seq1 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT).push(Cv::Point.new(10, 20), Cv::Point.new(30, 40), Cv::Point.new(50, 60))
    point1 = seq1.first
    assert_equal(Cv::Point, point1.class)
    assert_equal(10, point1.x)
    assert_equal(20, point1.y)
  ...
  def test_insert
    seq1 = Cv::Seq.new(CV_SEQ_ELTYPE_POINT).push(Cv::Point.new(10, 20), Cv::Point.new(30, 40))
    seq1.insert(1, Cv::Point.new(50, 60))
    ...
    assert_equal(Cv::Point, seq1[2].class)
    assert_equal(30, seq1[2].x)
    assert_equal(40, seq1[2].y)
    seq2 = Cv::Seq.new(CV_SEQ_ELTYPE_INDEX).push(10, 20)
    seq2.insert(1, 15)
    assert_equal(3, seq2.total)
    assert_equal(10, seq2[0])
  ...
  # def test_h_prev
  #   flunk('FIXME: Cv::Seq#h_prev is not tested yet.')
  # end
  # def test_h_next
  #   flunk('FIXME: Cv::Seq#h_next is not tested yet.')
  # end
  # def test_v_prev
  #   flunk('FIXME: Cv::Seq#v_prev is not tested yet.')
  # end
  # def test_v_next
  #   flunk('FIXME: Cv::Seq#v_next is not tested yet.')
  # end
end
