...
# Tests for OpenCV::Cv::SURFParams
class TestSURFParams < OpenCVTestCase
  def setup
    @surf_param1 = Cv::SURFParams.new(345.6)
  end

  
  def test_initialize
    sp1 = Cv::SURFParams.new(345.6)
    ...
    sp2 = Cv::SURFParams.new(456.7, true, 4, 5)
