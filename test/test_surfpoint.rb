...
# Tests for OpenCV::Cv::SURFPoint
class TestSURFPoint < OpenCVTestCase
  def setup
    @surf_point1 = Cv::SURFPoint.new(Cv::Point2D32f.new(0, 0), 0, 0, 0, 0)
  end

  
  def test_initialize
    sp1 = Cv::SURFPoint.new(Cv::Point2D32f.new(1.1, 2.2), 1, 10, 12.3, 45.6)
  ...
  def test_pt
    ...
    @surf_point1.pt = Cv::Point2D32f.new(12.3, 45.6)
