...
inline void GCGraph_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cv::detail::GCGraph::GCGraph<TWeight>>()).
    ...
    template define_method("create", &cv::detail::GCGraph<TWeight>::create,
      Arg("vtx_count"), Arg("edge_count")).
    template define_method("add_vtx", &cv::detail::GCGraph<TWeight>::addVtx).
    template define_method("add_edges", &cv::detail::GCGraph<TWeight>::addEdges,
      Arg("i"), Arg("j"), Arg("w"), Arg("revw")).
    template define_method("add_term_weights", &cv::detail::GCGraph<TWeight>::addTermWeights,
      Arg("i"), Arg("source_w"), Arg("sink_w")).
    template define_method("max_flow", &cv::detail::GCGraph<TWeight>::maxFlow).
    template define_method("in_source_segment?", &cv::detail::GCGraph<TWeight>::inSourceSegment,
      Arg("i")).
