...
void Init_Hal()
{
  ...
  Class rb_cCvHalFilter2D = define_class_under<cv::hal::Filter2D>(rb_mCvHal, "Filter2D").
    define_singleton_function<cv::Ptr<cv::hal::Filter2D>(*)(uchar*, ::size_t, int, int, int, int, int, int, int, int, double, int, int, bool, bool)>("create", &cv::hal::Filter2D::create,
  ...
  Class rb_cCvHalSepFilter2D = define_class_under<cv::hal::SepFilter2D>(rb_mCvHal, "SepFilter2D").
    define_singleton_function<cv::Ptr<cv::hal::SepFilter2D>(*)(int, int, int, uchar*, int, uchar*, int, int, int, double, int)>("create", &cv::hal::SepFilter2D::create,
  ...
  Class rb_cCvHalMorph = define_class_under<cv::hal::Morph>(rb_mCvHal, "Morph").
    define_singleton_function<cv::Ptr<cv::hal::Morph>(*)(int, int, int, int, int, int, uchar*, ::size_t, int, int, int, int, int, const double*, int, bool, bool)>("create", &cv::hal::Morph::create,
  ...
  rb_mCvHal.define_module_function<void(*)(int, int, int, uchar*, ::size_t, uchar*, ::size_t, int, int, int, int, int, int, uchar*, ::size_t, int, int, int, int, double, int, bool)>("filter2_d", &cv::hal::filter2D,
  ...
  rb_mCvHal.define_module_function<void(*)(int, int, int, uchar*, ::size_t, uchar*, ::size_t, int, int, int, int, int, int, uchar*, int, uchar*, int, int, int, double, int)>("sep_filter2_d", &cv::hal::sepFilter2D,
  ...
  rb_mCvHal.define_module_function<void(*)(int, const uchar*, ::size_t, int, int, uchar*, ::size_t, int, int, const double[6], int, int, const double[4])>("warp_affine", &cv::hal::warpAffine,
    Arg("src_type"), Arg("src_data"), Arg("src_step"), Arg("src_width"), Arg("src_height"), Arg("dst_data"), Arg("dst_step"), Arg("dst_width"), Arg("dst_height"), Arg("m") = 6, Arg("interpolation"), Arg("border_type"), Arg("border_value") = 4);
  ...
  rb_mCvHal.define_module_function<void(*)(int, const uchar*, ::size_t, int, int, uchar*, ::size_t, int, int, const double[9], int, int, const double[4])>("warp_perspective", &cv::hal::warpPerspective,
    Arg("src_type"), Arg("src_data"), Arg("src_step"), Arg("src_width"), Arg("src_height"), Arg("dst_data"), Arg("dst_step"), Arg("dst_width"), Arg("dst_height"), Arg("m") = 9, Arg("interpolation"), Arg("border_type"), Arg("border_value") = 4);
  ...
  rb_mCvHal.define_module_function<void(*)(const uchar*, ::size_t, uchar*, ::size_t, int, int, int, int, bool, bool)>("cvt_bg_rto_yuv", &cv::hal::cvtBGRtoYUV,
    Arg("src_data"), Arg("src_step"), Arg("dst_data"), Arg("dst_step"), Arg("width"), Arg("height"), Arg("depth"), Arg("scn"), Arg("swap_blue"), Arg("is_cb_cr"));
  
  rb_mCvHal.define_module_function<void(*)(const uchar*, ::size_t, uchar*, ::size_t, int, int, int, int, bool, bool)>("cvt_yu_vto_bgr", &cv::hal::cvtYUVtoBGR,
  ...
  rb_mCvHal.define_module_function<void(*)(const uchar*, ::size_t, uchar*, ::size_t, int, int, int, bool, int)>("cvt_three_plane_yu_vto_bgr", &cv::hal::cvtThreePlaneYUVtoBGR,
    Arg("src_data"), Arg("src_step"), Arg("dst_data"), Arg("dst_step"), Arg("dst_width"), Arg("dst_height"), Arg("dcn"), Arg("swap_blue"), Arg("u_idx"));
  
  rb_mCvHal.define_module_function<void(*)(const uchar*, ::size_t, uchar*, ::size_t, int, int, int, bool, int)>("cvt_bg_rto_three_plane_yuv", &cv::hal::cvtBGRtoThreePlaneYUV,
  ...
  rb_mCvHal.define_module_function<void(*)(const uchar*, ::size_t, uchar*, ::size_t, int, int, int, bool, int, int)>("cvt_one_plane_yu_vto_bgr", &cv::hal::cvtOnePlaneYUVtoBGR,
    Arg("src_data"), Arg("src_step"), Arg("dst_data"), Arg("dst_step"), Arg("width"), Arg("height"), Arg("dcn"), Arg("swap_blue"), Arg("u_idx"), Arg("ycn"));
  
  rb_mCvHal.define_module_function<void(*)(const uchar*, ::size_t, uchar*, ::size_t, int, int, int, bool, int, int)>("cvt_one_plane_bg_rto_yuv", &cv::hal::cvtOnePlaneBGRtoYUV,
