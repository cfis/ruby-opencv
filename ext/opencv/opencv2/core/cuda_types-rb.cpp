...
void Init_CudaTypes()
{
  ...
  Class rb_cPtrStepSzb = define_class_under<cv::cuda::PtrStepSz<unsigned char>>(rb_mCvCuda, "PtrStepSzb").
    define(&PtrStepSz_builder<Data_Type<cv::cuda::PtrStepSz<unsigned char>>, unsigned char>);
  
  Class rb_cPtrStepSzus = define_class_under<cv::cuda::PtrStepSz<unsigned short>>(rb_mCvCuda, "PtrStepSzus").
    define(&PtrStepSz_builder<Data_Type<cv::cuda::PtrStepSz<unsigned short>>, unsigned short>);
  
  Class rb_cPtrStepSzf = define_class_under<cv::cuda::PtrStepSz<float>>(rb_mCvCuda, "PtrStepSzf").
    define(&PtrStepSz_builder<Data_Type<cv::cuda::PtrStepSz<float>>, float>);
  
  Class rb_cPtrStepSzi = define_class_under<cv::cuda::PtrStepSz<int>>(rb_mCvCuda, "PtrStepSzi").
    define(&PtrStepSz_builder<Data_Type<cv::cuda::PtrStepSz<int>>, int>);
  
  Class rb_cPtrStepb = define_class_under<cv::cuda::PtrStep<unsigned char>>(rb_mCvCuda, "PtrStepb").
    define(&PtrStep_builder<Data_Type<cv::cuda::PtrStep<unsigned char>>, unsigned char>);
  
  Class rb_cPtrStepus = define_class_under<cv::cuda::PtrStep<unsigned short>>(rb_mCvCuda, "PtrStepus").
    define(&PtrStep_builder<Data_Type<cv::cuda::PtrStep<unsigned short>>, unsigned short>);
  
  Class rb_cPtrStepf = define_class_under<cv::cuda::PtrStep<float>>(rb_mCvCuda, "PtrStepf").
    define(&PtrStep_builder<Data_Type<cv::cuda::PtrStep<float>>, float>);
  
  Class rb_cPtrStepi = define_class_under<cv::cuda::PtrStep<int>>(rb_mCvCuda, "PtrStepi").
