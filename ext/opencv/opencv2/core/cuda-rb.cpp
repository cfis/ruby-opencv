...
void Init_Cuda()
{
  ...
  Class rb_cCvCudaGpuMat = define_class_under<cv::cuda::GpuMat>(rb_mCvCuda, "GpuMat").
    ...
    define_method("is_continuous?", &cv::cuda::GpuMat::isContinuous).
  ...
  Class rb_cCvCudaGpuMatND = define_class_under<cv::cuda::GpuMatND>(rb_mCvCuda, "GpuMatND").
    ...
    define_method<void(cv::cuda::GpuMatND::*)(cv::OutputArray, cv::cuda::Stream&) const>("download", &cv::cuda::GpuMatND::download,
      Arg("dst"), Arg("stream")).
    define_method("is_continuous?", &cv::cuda::GpuMatND::isContinuous).
    define_method("is_submatrix?", &cv::cuda::GpuMatND::isSubmatrix).
  ...
  rb_mCvCuda.define_module_function<void(*)(cv::Size, int, cv::OutputArray)>("ensure_size_is_enough", &cv::cuda::ensureSizeIsEnough,
    Arg("rows"), Arg("cols"), Arg("type"), Arg("arr"));
  ...
  Class rb_cCvCudaHostMem = define_class_under<cv::cuda::HostMem>(rb_mCvCuda, "HostMem").
    ...
    define_method("is_continuous?", &cv::cuda::HostMem::isContinuous).
  ...
  Class rb_cCvCudaDeviceInfo = define_class_under<cv::cuda::DeviceInfo>(rb_mCvCuda, "DeviceInfo").
    ...
    define_method("supports?", &cv::cuda::DeviceInfo::supports,
      Arg("feature_set")).
    define_method("is_compatible?", &cv::cuda::DeviceInfo::isCompatible);
