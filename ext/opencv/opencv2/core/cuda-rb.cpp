...
void Init_Cuda()
{
  ...
  Class rb_cCvCudaGpuMat = define_class_under<cv::cuda::GpuMat>(rb_mCvCuda, "GpuMat").
    ...
    define_constructor(Constructor<cv::cuda::GpuMat, cv::Size_<int>, int, cv::cuda::GpuMat::Allocator*>()).
    define_constructor(Constructor<cv::cuda::GpuMat, int, int, int, cv::Scalar_<double>, cv::cuda::GpuMat::Allocator*>()).
    define_constructor(Constructor<cv::cuda::GpuMat, cv::Size_<int>, int, cv::Scalar_<double>, cv::cuda::GpuMat::Allocator*>()).
    define_constructor(Constructor<cv::cuda::GpuMat, const cv::cuda::GpuMat&>()).
    define_constructor(Constructor<cv::cuda::GpuMat, int, int, int, void*, unsigned long long>()).
    define_constructor(Constructor<cv::cuda::GpuMat, cv::Size_<int>, int, void*, unsigned long long>()).
    define_constructor(Constructor<cv::cuda::GpuMat, const cv::cuda::GpuMat&, cv::Range, cv::Range>()).
    define_constructor(Constructor<cv::cuda::GpuMat, const cv::cuda::GpuMat&, cv::Rect_<int>>()).
    define_constructor(Constructor<cv::cuda::GpuMat, const cv::_InputArray &, cv::cuda::GpuMat::Allocator*>()).
    ...
    define_method<void(cv::cuda::GpuMat::*)(cv::Size_<int>, int)>("create", &cv::cuda::GpuMat::create).
    ...
    define_method<void(cv::cuda::GpuMat::*)(const cv::_InputArray &)>("upload", &cv::cuda::GpuMat::upload).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_InputArray &, cv::cuda::Stream&)>("upload", &cv::cuda::GpuMat::upload).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &) const>("download", &cv::cuda::GpuMat::download).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, cv::cuda::Stream&) const>("download", &cv::cuda::GpuMat::download).
    define_method<cv::cuda::GpuMat(cv::cuda::GpuMat::*)() const>("clone", &cv::cuda::GpuMat::clone).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<void(cv::cuda::GpuMat::*)(cv::cuda::GpuMat&) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, cv::cuda::Stream&) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<void(cv::cuda::GpuMat::*)(cv::cuda::GpuMat&, cv::cuda::Stream&) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, const cv::_InputArray &) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<void(cv::cuda::GpuMat::*)(cv::cuda::GpuMat&, cv::cuda::GpuMat&) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, const cv::_InputArray &, cv::cuda::Stream&) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<void(cv::cuda::GpuMat::*)(cv::cuda::GpuMat&, cv::cuda::GpuMat&, cv::cuda::Stream&) const>("copy_to", &cv::cuda::GpuMat::copyTo).
    define_method<cv::cuda::GpuMat&(cv::cuda::GpuMat::*)(cv::Scalar_<double>)>("set_to", &cv::cuda::GpuMat::setTo).
    define_method<cv::cuda::GpuMat&(cv::cuda::GpuMat::*)(cv::Scalar_<double>, cv::cuda::Stream&)>("set_to", &cv::cuda::GpuMat::setTo).
    define_method<cv::cuda::GpuMat&(cv::cuda::GpuMat::*)(cv::Scalar_<double>, const cv::_InputArray &)>("set_to", &cv::cuda::GpuMat::setTo).
    define_method<cv::cuda::GpuMat&(cv::cuda::GpuMat::*)(cv::Scalar_<double>, const cv::_InputArray &, cv::cuda::Stream&)>("set_to", &cv::cuda::GpuMat::setTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, int) const>("convert_to", &cv::cuda::GpuMat::convertTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, int, cv::cuda::Stream&) const>("convert_to", &cv::cuda::GpuMat::convertTo).
    define_method<void(cv::cuda::GpuMat::*)(cv::cuda::GpuMat&, int, cv::cuda::Stream&) const>("convert_to", &cv::cuda::GpuMat::convertTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, int, double, double) const>("convert_to", &cv::cuda::GpuMat::convertTo).
    define_method<void(cv::cuda::GpuMat::*)(cv::cuda::GpuMat&, int, double, double) const>("convert_to", &cv::cuda::GpuMat::convertTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, int, double, cv::cuda::Stream&) const>("convert_to", &cv::cuda::GpuMat::convertTo).
    define_method<void(cv::cuda::GpuMat::*)(const cv::_OutputArray &, int, double, double, cv::cuda::Stream&) const>("convert_to", &cv::cuda::GpuMat::convertTo).
    ...
    define_method<unsigned char*(cv::cuda::GpuMat::*)(int)>("ptr", &cv::cuda::GpuMat::ptr).
    define_method<const unsigned char*(cv::cuda::GpuMat::*)(int) const>("ptr", &cv::cuda::GpuMat::ptr).
    ...
    define_method<cv::cuda::GpuMat(cv::cuda::GpuMat::*)(cv::Rect_<int>) const>("()", &cv::cuda::GpuMat::operator()).
    define_method<cv::cuda::GpuMat(cv::cuda::GpuMat::*)(int, int) const>("reshape", &cv::cuda::GpuMat::reshape).
    define_method<void(cv::cuda::GpuMat::*)(cv::Size_<int>&, cv::Point_<int>&) const>("locate_roi", &cv::cuda::GpuMat::locateROI).
    ...
    define_method<unsigned long long(cv::cuda::GpuMat::*)() const>("elem_size", &cv::cuda::GpuMat::elemSize).
    define_method<unsigned long long(cv::cuda::GpuMat::*)() const>("elem_size1", &cv::cuda::GpuMat::elemSize1).
    ...
    define_method<unsigned long long(cv::cuda::GpuMat::*)() const>("step1", &cv::cuda::GpuMat::step1).
    define_method<cv::Size_<int>(cv::cuda::GpuMat::*)() const>("size", &cv::cuda::GpuMat::size).
  ...
  Class rb_cCvCudaGpuMatAllocator = define_class_under<cv::cuda::GpuMat::Allocator>(rb_cCvCudaGpuMat, "Allocator").
    define_method<bool(cv::cuda::GpuMat::Allocator::*)(cv::cuda::GpuMat*, int, int, unsigned long long)>("allocate", &cv::cuda::GpuMat::Allocator::allocate).
  ...
  Class rb_cCvCudaGpuData = define_class_under<cv::cuda::GpuData>(rb_mCvCuda, "GpuData").
    define_constructor(Constructor<cv::cuda::GpuData, unsigned long long>()).
  ...
  Class rb_cCvCudaGpuMatND = define_class_under<cv::cuda::GpuMatND>(rb_mCvCuda, "GpuMatND").
    ...
    define_constructor(Constructor<cv::cuda::GpuMatND, std::vector<int>, int>()).
    define_constructor(Constructor<cv::cuda::GpuMatND, std::vector<int>, int, void*, std::vector<unsigned long long>>()).
    define_method<void(cv::cuda::GpuMatND::*)(std::vector<int>, int)>("create", &cv::cuda::GpuMatND::create).
    ...
    define_method<cv::cuda::GpuMat(cv::cuda::GpuMatND::*)(std::vector<int>, cv::Range, cv::Range) const>("create_gpu_mat_header", &cv::cuda::GpuMatND::createGpuMatHeader).
    define_method<cv::cuda::GpuMat(cv::cuda::GpuMatND::*)() const>("create_gpu_mat_header", &cv::cuda::GpuMatND::createGpuMatHeader).
    define_method<cv::cuda::GpuMat(cv::cuda::GpuMatND::*)(std::vector<int>, cv::Range, cv::Range) const>("()", &cv::cuda::GpuMatND::operator()).
    ...
    define_method<void(cv::cuda::GpuMatND::*)(const cv::_InputArray &)>("upload", &cv::cuda::GpuMatND::upload).
    define_method<void(cv::cuda::GpuMatND::*)(const cv::_InputArray &, cv::cuda::Stream&)>("upload", &cv::cuda::GpuMatND::upload).
    define_method<void(cv::cuda::GpuMatND::*)(const cv::_OutputArray &) const>("download", &cv::cuda::GpuMatND::download).
    define_method<void(cv::cuda::GpuMatND::*)(const cv::_OutputArray &, cv::cuda::Stream&) const>("download", &cv::cuda::GpuMatND::download).
    ...
    define_method<unsigned long long(cv::cuda::GpuMatND::*)() const>("elem_size", &cv::cuda::GpuMatND::elemSize).
    define_method<unsigned long long(cv::cuda::GpuMatND::*)() const>("elem_size1", &cv::cuda::GpuMatND::elemSize1).
    ...
    define_method<unsigned char*(cv::cuda::GpuMatND::*)() const>("get_device_ptr", &cv::cuda::GpuMatND::getDevicePtr).
    define_method<unsigned long long(cv::cuda::GpuMatND::*)() const>("total", &cv::cuda::GpuMatND::total).
    define_method<unsigned long long(cv::cuda::GpuMatND::*)() const>("total_mem_size", &cv::cuda::GpuMatND::totalMemSize).
  ...
  rb_mCvCuda.define_module_function<void(*)(int, int, int, const cv::_OutputArray &)>("create_continuous", &cv::cuda::createContinuous);
  
  rb_mCvCuda.define_module_function<void(*)(int, int, int, const cv::_OutputArray &)>("ensure_size_is_enough", &cv::cuda::ensureSizeIsEnough);
  
  rb_mCvCuda.define_module_function<cv::cuda::GpuMat(*)(int, int, int, unsigned long long, unsigned long long)>("create_gpu_mat_from_cuda_memory", &cv::cuda::createGpuMatFromCudaMemory);
  
  rb_mCvCuda.define_module_function<cv::cuda::GpuMat(*)(cv::Size_<int>, int, unsigned long long, unsigned long long)>("create_gpu_mat_from_cuda_memory", &cv::cuda::createGpuMatFromCudaMemory);
  ...
  Class rb_cCvCudaBufferPool = define_class_under<cv::cuda::BufferPool>(rb_mCvCuda, "BufferPool").
    ...
    define_method<cv::cuda::GpuMat(cv::cuda::BufferPool::*)(cv::Size_<int>, int)>("get_buffer", &cv::cuda::BufferPool::getBuffer).
  ...
  rb_mCvCuda.define_module_function<void(*)(int, unsigned long long, int)>("set_buffer_pool_config", &cv::cuda::setBufferPoolConfig);
  ...
  Class rb_cCvCudaHostMem = define_class_under<cv::cuda::HostMem>(rb_mCvCuda, "HostMem").
    ...
    define_constructor(Constructor<cv::cuda::HostMem, cv::Size_<int>, int, cv::cuda::HostMem::AllocType>()).
    define_constructor(Constructor<cv::cuda::HostMem, const cv::_InputArray &, cv::cuda::HostMem::AllocType>()).
    ...
    define_method<void(cv::cuda::HostMem::*)(cv::Size_<int>, int)>("create", &cv::cuda::HostMem::create).
    ...
    define_method<unsigned long long(cv::cuda::HostMem::*)() const>("elem_size", &cv::cuda::HostMem::elemSize).
    define_method<unsigned long long(cv::cuda::HostMem::*)() const>("elem_size1", &cv::cuda::HostMem::elemSize1).
    ...
    define_method<unsigned long long(cv::cuda::HostMem::*)() const>("step1", &cv::cuda::HostMem::step1).
    define_method<cv::Size_<int>(cv::cuda::HostMem::*)() const>("size", &cv::cuda::HostMem::size).
  ...
  Enum<cv::cuda::HostMem::AllocType> rb_cCvCudaHostMemAllocType = define_enum<cv::cuda::HostMem::AllocType>("AllocType", rb_cCvCudaHostMem).
  ...
  Class rb_cCvCudaStream = define_class_under<cv::cuda::Stream>(rb_mCvCuda, "Stream").
    ...
    define_constructor(Constructor<cv::cuda::Stream, const unsigned long long>()).
   ...
   // define_method<void(cv::cuda::Stream::*)(void (*)(int, void *), void*)>("enqueue_host_callback", &cv::cuda::Stream::enqueueHostCallback).
  ...
  rb_mCvCuda.define_module_function<cv::cuda::Stream(*)(unsigned long long)>("wrap_stream", &cv::cuda::wrapStream);
  ...
  Enum<cv::cuda::Event::CreateFlags> rb_cCvCudaEventCreateFlags = define_enum<cv::cuda::Event::CreateFlags>("CreateFlags", rb_cCvCudaEvent).
  ...
  Enum<cv::cuda::FeatureSet> rb_cCvCudaFeatureSet = define_enum<cv::cuda::FeatureSet>("FeatureSet", rb_mCvCuda).
  ...
  Class rb_cCvCudaDeviceInfo = define_class_under<cv::cuda::DeviceInfo>(rb_mCvCuda, "DeviceInfo").
    ...
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("total_global_mem", &cv::cuda::DeviceInfo::totalGlobalMem).
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("shared_mem_per_block", &cv::cuda::DeviceInfo::sharedMemPerBlock).
    ...
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("mem_pitch", &cv::cuda::DeviceInfo::memPitch).
    define_method<int(cv::cuda::DeviceInfo::*)() const>("max_threads_per_block", &cv::cuda::DeviceInfo::maxThreadsPerBlock).
    define_method<cv::Vec<int, 3>(cv::cuda::DeviceInfo::*)() const>("max_threads_dim", &cv::cuda::DeviceInfo::maxThreadsDim).
    define_method<cv::Vec<int, 3>(cv::cuda::DeviceInfo::*)() const>("max_grid_size", &cv::cuda::DeviceInfo::maxGridSize).
    define_method<int(cv::cuda::DeviceInfo::*)() const>("clock_rate", &cv::cuda::DeviceInfo::clockRate).
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("total_const_mem", &cv::cuda::DeviceInfo::totalConstMem).
    ...
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("texture_alignment", &cv::cuda::DeviceInfo::textureAlignment).
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("texture_pitch_alignment", &cv::cuda::DeviceInfo::texturePitchAlignment).
    ...
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_texture2_d", &cv::cuda::DeviceInfo::maxTexture2D).
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_texture2_d_mipmap", &cv::cuda::DeviceInfo::maxTexture2DMipmap).
    define_method<cv::Vec<int, 3>(cv::cuda::DeviceInfo::*)() const>("max_texture2_d_linear", &cv::cuda::DeviceInfo::maxTexture2DLinear).
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_texture2_d_gather", &cv::cuda::DeviceInfo::maxTexture2DGather).
    define_method<cv::Vec<int, 3>(cv::cuda::DeviceInfo::*)() const>("max_texture3_d", &cv::cuda::DeviceInfo::maxTexture3D).
    define_method<int(cv::cuda::DeviceInfo::*)() const>("max_texture_cubemap", &cv::cuda::DeviceInfo::maxTextureCubemap).
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_texture1_d_layered", &cv::cuda::DeviceInfo::maxTexture1DLayered).
    define_method<cv::Vec<int, 3>(cv::cuda::DeviceInfo::*)() const>("max_texture2_d_layered", &cv::cuda::DeviceInfo::maxTexture2DLayered).
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_texture_cubemap_layered", &cv::cuda::DeviceInfo::maxTextureCubemapLayered).
    define_method<int(cv::cuda::DeviceInfo::*)() const>("max_surface1_d", &cv::cuda::DeviceInfo::maxSurface1D).
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_surface2_d", &cv::cuda::DeviceInfo::maxSurface2D).
    define_method<cv::Vec<int, 3>(cv::cuda::DeviceInfo::*)() const>("max_surface3_d", &cv::cuda::DeviceInfo::maxSurface3D).
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_surface1_d_layered", &cv::cuda::DeviceInfo::maxSurface1DLayered).
    define_method<cv::Vec<int, 3>(cv::cuda::DeviceInfo::*)() const>("max_surface2_d_layered", &cv::cuda::DeviceInfo::maxSurface2DLayered).
    define_method<int(cv::cuda::DeviceInfo::*)() const>("max_surface_cubemap", &cv::cuda::DeviceInfo::maxSurfaceCubemap).
    define_method<cv::Vec<int, 2>(cv::cuda::DeviceInfo::*)() const>("max_surface_cubemap_layered", &cv::cuda::DeviceInfo::maxSurfaceCubemapLayered).
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("surface_alignment", &cv::cuda::DeviceInfo::surfaceAlignment).
    ...
    define_method<void(cv::cuda::DeviceInfo::*)(unsigned long long&, unsigned long long&) const>("query_memory", &cv::cuda::DeviceInfo::queryMemory).
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("free_memory", &cv::cuda::DeviceInfo::freeMemory).
    define_method<unsigned long long(cv::cuda::DeviceInfo::*)() const>("total_memory", &cv::cuda::DeviceInfo::totalMemory).
  ...
  Enum<cv::cuda::DeviceInfo::ComputeMode> rb_cCvCudaDeviceInfoComputeMode = define_enum<cv::cuda::DeviceInfo::ComputeMode>("ComputeMode", rb_cCvCudaDeviceInfo).
  ...
  //rb_mCvCuda.define_module_function<void(*)(const cv::_InputArray &, const cv::_OutputArray &, cv::cuda::Stream&)>("convert_fp16", &cv::cuda::convertFp16);
