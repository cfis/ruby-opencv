...
void Init_Opengl()
{
  ...
  rb_mCvOgl.define_module_function("convert_to_gl_texture2_d", &cv::ogl::convertToGLTexture2D,
    Arg("src"), Arg("texture"));
  
  rb_mCvOgl.define_module_function("convert_from_gl_texture2_d", &cv::ogl::convertFromGLTexture2D,
    Arg("texture"), Arg("dst"));
