...
void Init_Opengl()
{
  ...
  Class rb_cCvOglBuffer = define_class_under<cv::ogl::Buffer>(rb_mCvOgl, "Buffer").
    ...
    define_method<void(cv::ogl::Buffer::*)(cv::InputArray, cv::cuda::Stream&, cv::ogl::Buffer::Target, bool)>("copy_from", &cv::ogl::Buffer::copyFrom,
      Arg("arr"), Arg("stream"), Arg("target"), Arg("auto_release")).
  ...
  Class rb_cCvOglTexture2D = define_class_under<cv::ogl::Texture2D>(rb_mCvOgl, "Texture2D").
    ...
    define_method<void(cv::ogl::Texture2D::*)(cv::OutputArray, int, bool) const>("copy_to", &cv::ogl::Texture2D::copyTo,
      Arg("arr"), Arg("ddepth") = NULL, Arg("auto_release")).
  ...
  rb_mCvOgl.define_module_function<void(*)(cv::InputArray, cv::ogl::Texture2D&)>("convert_to_gl_texture2_d", &cv::ogl::convertToGLTexture2D,
    Arg("src"), Arg("texture"));
  
  rb_mCvOgl.define_module_function<void(*)(const cv::ogl::Texture2D&, cv::OutputArray)>("convert_from_gl_texture2_d", &cv::ogl::convertFromGLTexture2D,
    Arg("texture"), Arg("dst"));
  
  rb_mCvOgl.define_module_function<cv::UMat(*)(const cv::ogl::Buffer&, cv::AccessFlag)>("map_gl_buffer", &cv::ogl::mapGLBuffer,
    Arg("buffer"), Arg("access_flags"));
