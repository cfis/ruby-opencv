...
inline void Quat_builder(Data_Type_T& klass)
{
  klass.define_constant("CV_QUAT_EPS", cv::Quat<_Tp>::CV_QUAT_EPS).
    ...
    template define_method("log", &cv::Quat<_Tp>::log,
      Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT)).
    template define_method<cv::Quat<_Tp>(cv::Quat<_Tp>::*)(const _Tp, cv::QuatAssumeType) const>("power", &cv::Quat<_Tp>::power,
      Arg("x"), Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT)).
    ...
    template define_method<cv::Quat<_Tp>(cv::Quat<_Tp>::*)(const cv::Quat<_Tp>&, cv::QuatAssumeType) const>("power", &cv::Quat<_Tp>::power,
      Arg("q"), Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT)).
    ...
    template define_method("is_normal?", &cv::Quat<_Tp>::isNormal,
      Arg("eps") = static_cast<_Tp>(CV_QUAT_EPS)).
    ...
    template define_singleton_function("nlerp", &cv::Quat<_Tp>::nlerp,
      Arg("q0"), Arg("q1"), Arg("t"), Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT)).
    template define_singleton_function("slerp", &cv::Quat<_Tp>::slerp,
      Arg("q0"), Arg("q1"), Arg("t"), Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT), Arg("direct_change") = static_cast<bool>(true)).
    template define_singleton_function("squad", &cv::Quat<_Tp>::squad,
      Arg("q0"), Arg("s0"), Arg("s1"), Arg("q1"), Arg("t"), Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT), Arg("direct_change") = static_cast<bool>(true)).
    template define_singleton_function("inter_point", &cv::Quat<_Tp>::interPoint,
      Arg("q0"), Arg("q1"), Arg("q2"), Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT)).
    template define_singleton_function("spline", &cv::Quat<_Tp>::spline,
      Arg("q0"), Arg("q1"), Arg("q2"), Arg("q3"), Arg("t"), Arg("assume_unit") = static_cast<QuatAssumeType>(QUAT_ASSUME_NOT_UNIT)).
