...
template<typename Data_Type_T, int imm, bool is_invalid, bool is_first, bool is_second, bool is_other>
inline void v_wasm_palignr_u8_class_builder(Data_Type_T& klass)
{
};
...
void Init_IntrinWasm()
{
  ...
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpacklo_i8x16", &cv::wasm_unpacklo_i8x16,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpacklo_i16x8", &cv::wasm_unpacklo_i16x8,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpacklo_i32x4", &cv::wasm_unpacklo_i32x4,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpacklo_i64x2", &cv::wasm_unpacklo_i64x2,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpackhi_i8x16", &cv::wasm_unpackhi_i8x16,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpackhi_i16x8", &cv::wasm_unpackhi_i16x8,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpackhi_i32x4", &cv::wasm_unpackhi_i32x4,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("wasm_unpackhi_i64x2", &cv::wasm_unpackhi_i64x2,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvtu8x16_i16x8", &cv::v128_cvtu8x16_i16x8,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvti8x16_i16x8", &cv::v128_cvti8x16_i16x8,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvtu8x16_i32x4", &cv::v128_cvtu8x16_i32x4,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvti8x16_i32x4", &cv::v128_cvti8x16_i32x4,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvtu16x8_i32x4", &cv::v128_cvtu16x8_i32x4,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvti16x8_i32x4", &cv::v128_cvti16x8_i32x4,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvtu32x4_i64x2", &cv::v128_cvtu32x4_i64x2,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvti32x4_i64x2", &cv::v128_cvti32x4_i64x2,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvtu8x16_i16x8_high", &cv::v128_cvtu8x16_i16x8_high,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvti8x16_i16x8_high", &cv::v128_cvti8x16_i16x8_high,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvtu16x8_i32x4_high", &cv::v128_cvtu16x8_i32x4_high,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvti16x8_i32x4_high", &cv::v128_cvti16x8_i32x4_high,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvtu32x4_i64x2_high", &cv::v128_cvtu32x4_i64x2_high,
    Arg("a"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("v128_cvti32x4_i64x2_high", &cv::v128_cvti32x4_i64x2_high,
    Arg("a"));
