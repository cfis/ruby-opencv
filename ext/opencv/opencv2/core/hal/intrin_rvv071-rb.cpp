...
void Init_IntrinRvv071()
{
  ...
  rb_mCv.define_module_function<cv::v_float32x4(*)()>("v_setzero_f32", &cv::v_setzero_f32);
  
  rb_mCv.define_module_function<cv::v_float32x4(*)(float)>("v_setall_f32", &cv::v_setall_f32,
    Arg("v"));
  
  rb_mCv.define_module_function<cv::v_float64x2(*)()>("v_setzero_f64", &cv::v_setzero_f64);
  
  rb_mCv.define_module_function<cv::v_float64x2(*)(double)>("v_setall_f64", &cv::v_setall_f64,
    Arg("v"));
  ...
  rb_cCvVFloat32x4.define_method("/=", [](cv::v_float32x4& self, const cv::v_float32x4& other) -> cv::v_float32x4&
  {
    return self /= other;
  });
  ...
  rb_cCvVFloat64x2.define_method("/=", [](cv::v_float64x2& self, const cv::v_float64x2& other) -> cv::v_float64x2&
  {
    return self /= other;
  });
  ...
  rb_mCv.define_module_function<void(*)(int)>("__builtin_riscv_fsrm", &cv::__builtin_riscv_fsrm,
    Arg("val"));
  
  rb_mCv.define_module_function<void(*)(void*)>("barrier1", &cv::barrier1,
    Arg("arg"));
