...
template<typename Data_Type_T, int imm, bool is_invalid, bool is_first, bool is_half, bool is_second, bool is_other>
inline void v_lsx_palignr_u8_class_builder(Data_Type_T& klass)
{
};
...
void Init_IntrinLsx()
{
  ...
  rb_mCv.define_module_function<int(*)(char, char, char, char, char, char, char, char, char, char, char, char, char, char, char, char)>("_v128_set_b", &cv::_v128_set_b,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"), Arg("v14"), Arg("v15"));
  
  rb_mCv.define_module_function<int(*)(short, short, short, short, short, short, short, short)>("_v128_setr_h", &cv::_v128_setr_h,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));
  
  rb_mCv.define_module_function<int(*)(int, int, int, int)>("_v128_setr_w", &cv::_v128_setr_w,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
  
  rb_mCv.define_module_function<int(*)(int, int, int, int)>("_v128_set_w", &cv::_v128_set_w,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
  
  rb_mCv.define_module_function<int(*)(int)>("_v128_setall_w", &cv::_v128_setall_w,
    Arg("v0"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("_v128_setr_d", &cv::_v128_setr_d,
    Arg("v0"), Arg("v1"));
  
  rb_mCv.define_module_function<int(*)(int, int)>("_v128_set_d", &cv::_v128_set_d,
    Arg("v0"), Arg("v1"));
  
  rb_mCv.define_module_function<int(*)(float, float, float, float)>("_v128_setr_ps", &cv::_v128_setr_ps,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
  
  rb_mCv.define_module_function<int(*)(float)>("_v128_setall_ps", &cv::_v128_setall_ps,
    Arg("v0"));
  
  rb_mCv.define_module_function<int(*)(double, double)>("_v128_setr_pd", &cv::_v128_setr_pd,
    Arg("v0"), Arg("v1"));
  
  rb_mCv.define_module_function<int(*)(double)>("_v128_setall_pd", &cv::_v128_setall_pd,
    Arg("v0"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_lsx_packus_h", &cv::_lsx_packus_h,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_lsx_packs_h", &cv::_lsx_packs_h,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_lsx_packus_w", &cv::_lsx_packus_w,
    Arg("a"), Arg("b"));
  ...
  Class rb_cCvVUint8x16 = define_class_under<cv::v_uint8x16>(rb_mCv, "VUint8x16").
    ...
    define_constructor(Constructor<cv::v_uint8x16, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"), Arg("v14"), Arg("v15")).
    define_method<int(cv::v_uint8x16::*)() const>("get0", &cv::v_uint8x16::get0).
  ...
  Class rb_cCvVInt8x16 = define_class_under<cv::v_int8x16>(rb_mCv, "VInt8x16").
    ...
    define_constructor(Constructor<cv::v_int8x16, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"), Arg("v14"), Arg("v15")).
    define_method<int(cv::v_int8x16::*)() const>("get0", &cv::v_int8x16::get0).
  ...
  Class rb_cCvVUint16x8 = define_class_under<cv::v_uint16x8>(rb_mCv, "VUint16x8").
    ...
    define_constructor(Constructor<cv::v_uint16x8, int, int, int, int, int, int, int, int>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7")).
    define_method<int(cv::v_uint16x8::*)() const>("get0", &cv::v_uint16x8::get0).
  ...
  Class rb_cCvVFloat32x4 = define_class_under<cv::v_float32x4>(rb_mCv, "VFloat32x4").
    ...
    define_method<int(cv::v_float32x4::*)() const>("get0toint", &cv::v_float32x4::get0toint).
  ...
  Class rb_cCvVUint64x2 = define_class_under<cv::v_uint64x2>(rb_mCv, "VUint64x2").
    ...
    define_constructor(Constructor<cv::v_uint64x2, int, int>(),
      Arg("v0"), Arg("v1")).
    define_method<int(cv::v_uint64x2::*)() const>("get0", &cv::v_uint64x2::get0).
  ...
  Class rb_cCvVInt64x2 = define_class_under<cv::v_int64x2>(rb_mCv, "VInt64x2").
    ...
    define_constructor(Constructor<cv::v_int64x2, int, int>(),
      Arg("v0"), Arg("v1")).
    define_method<int(cv::v_int64x2::*)() const>("get0", &cv::v_int64x2::get0).
  ...
  Class rb_cCvVFloat64x2 = define_class_under<cv::v_float64x2>(rb_mCv, "VFloat64x2").
    ...
    define_method<int(cv::v_float64x2::*)() const>("get0toint64", &cv::v_float64x2::get0toint64).
    define_attr("val", &cv::v_float64x2::val);
  
  
  rb_mCv.define_module_function<int(*)(const int&)>("_lsx_128_castps_si128", &cv::_lsx_128_castps_si128,
    Arg("v"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("_lsx_128_castpd_si128", &cv::_lsx_128_castpd_si128,
    Arg("v"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("_lsx_128_castsi128_ps", &cv::_lsx_128_castsi128_ps,
    Arg("v"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("_lsx_128_castsi128_pd", &cv::_lsx_128_castsi128_pd,
    Arg("v"));
  ...
  rb_cCvVUint8x16.define_method("*=", [](cv::v_uint8x16& self, const cv::v_uint8x16& other) -> cv::v_uint8x16&
  {
    return self *= other;
  });
  
  rb_cCvVInt8x16.define_method("*=", [](cv::v_int8x16& self, const cv::v_int8x16& other) -> cv::v_int8x16&
  {
    return self *= other;
  });
  
  rb_cCvVUint16x8.define_method("*=", [](cv::v_uint16x8& self, const cv::v_uint16x8& other) -> cv::v_uint16x8&
  {
    return self *= other;
  });
  
  rb_cCvVInt16x8.define_method("*=", [](cv::v_int16x8& self, const cv::v_int16x8& other) -> cv::v_int16x8&
  {
    return self *= other;
  });
  ...
  rb_mCv.define_module_function<cv::v_float32x4(*)(const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&)>("v_reduce_sum4", &cv::v_reduce_sum4,
    Arg("a"), Arg("b"), Arg("c"), Arg("d"));
  ...
  rb_mCv.define_module_function<cv::v_float32x4(*)(const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&)>("v_matmul", &cv::v_matmul,
    Arg("v"), Arg("m0"), Arg("m1"), Arg("m2"), Arg("m3"));
  
  rb_mCv.define_module_function<cv::v_float32x4(*)(const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&, const cv::v_float32x4&)>("v_matmuladd", &cv::v_matmuladd,
  ...
  rb_mCv.define_module_function<void(*)(int*, const cv::v_uint8x16&, const cv::v_uint8x16&, const cv::v_uint8x16&, const cv::v_uint8x16&, int)>("v_store_interleave", &cv::v_store_interleave,
    Arg("ptr"), Arg("a"), Arg("b"), Arg("c"), Arg("d"), Arg(""));
