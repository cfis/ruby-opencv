...
void Init_IntrinRvvScalable()
{
  ...
  rb_mCv.define_module_function<int(*)(const int&, const int&, const int&, const int&)>("v_reduce_sum4", &cv::v_reduce_sum4,
    Arg("a"), Arg("b"), Arg("c"), Arg("d"));
  ...
  rb_mCv.define_module_function<int(*)(const int&, const int&, const int&, const int&, const int&)>("v_matmul", &cv::v_matmul,
    Arg("v"), Arg("m0"), Arg("m1"), Arg("m2"), Arg("m3"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&, const int&, const int&, const int&)>("v_matmuladd", &cv::v_matmuladd,
