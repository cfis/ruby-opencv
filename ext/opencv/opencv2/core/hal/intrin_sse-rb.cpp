...
inline void v_sse_palignr_u8_class_builder(Data_Type_T& klass)
{
};
...
void Init_IntrinSse()
{
  ...
  rb_mCv.define_module_function<cv::v_uint64x2(*)()>("v_setzero_u64", &cv::v_setzero_u64);
  
  rb_mCv.define_module_function<cv::v_int64x2(*)()>("v_setzero_s64", &cv::v_setzero_s64);
  
  rb_mCv.define_module_function<cv::v_uint64x2(*)(uint64)>("v_setall_u64", &cv::v_setall_u64,
    Arg("val"));
  
  rb_mCv.define_module_function<cv::v_int64x2(*)(int64)>("v_setall_s64", &cv::v_setall_s64,
    Arg("val"));
  ...
  rb_mCv.define_module_function<__m128i(*)(__m128i, __m128i, __m128i)>("v_select_si128", &cv::v_select_si128,
  ...
  rb_mCv.define_module_function<__m128i(*)(__m128i)>("v_sign_epi64", &cv::v_sign_epi64,
    Arg("a"));
  
  rb_mCv.define_module_function<__m128i(*)(__m128i, int)>("v_srai_epi64", &cv::v_srai_epi64,
    Arg("a"), Arg("imm"));
