...
void Init_IntrinAvx512()
{
  ...
  Class rb_cCvVUint8x64 = define_class_under<cv::v_uint8x64>(rb_mCv, "VUint8x64").
  ...
  rb_cCvVUint8x64.define_method("*=", [](cv::v_uint8x64& self, const cv::v_uint8x64& other) -> cv::v_uint8x64&
  {
    return self *= other;
  });
  
  rb_cCvVInt8x64.define_method("*=", [](cv::v_int8x64& self, const cv::v_int8x64& other) -> cv::v_int8x64&
  {
    return self *= other;
  });
  
  rb_cCvVUint16x32.define_method("*=", [](cv::v_uint16x32& self, const cv::v_uint16x32& other) -> cv::v_uint16x32&
  {
    return self *= other;
  });
  
  rb_cCvVInt16x32.define_method("*=", [](cv::v_int16x32& self, const cv::v_int16x32& other) -> cv::v_int16x32&
  {
    return self *= other;
  });
  ...
  rb_mCv.define_module_function<cv::v_float32x16(*)(const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&)>("v_reduce_sum4", &cv::v_reduce_sum4,
    Arg("a"), Arg("b"), Arg("c"), Arg("d"));
  ...
  rb_mCv.define_module_function<cv::v_float32x16(*)(const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&)>("v_matmul", &cv::v_matmul,
    Arg("v"), Arg("m0"), Arg("m1"), Arg("m2"), Arg("m3"));
  
  rb_mCv.define_module_function<cv::v_float32x16(*)(const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&, const cv::v_float32x16&)>("v_matmuladd", &cv::v_matmuladd,
  ...
  rb_mCv.define_module_function<void(*)()>("v512_cleanup", &cv::v512_cleanup);
