...
void Init_IntrinLasx()
{
  ...
  rb_mCv.define_module_function<int(*)(short, short, short, short, short, short, short, short, short, short, short, short, short, short, short, short)>("_v256_setr_h", &cv::_v256_setr_h,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"), Arg("v14"), Arg("v15"));
  
  rb_mCv.define_module_function<int(*)(int, int, int, int, int, int, int, int)>("_v256_setr_w", &cv::_v256_setr_w,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));
  
  rb_mCv.define_module_function<int(*)(int, int, int, int, int, int, int, int)>("_v256_set_w", &cv::_v256_set_w,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));
  
  rb_mCv.define_module_function<int(*)(int)>("_v256_setall_w", &cv::_v256_setall_w,
    Arg("v0"));
  
  rb_mCv.define_module_function<int(*)(int, int, int, int)>("_v256_setr_d", &cv::_v256_setr_d,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
  
  rb_mCv.define_module_function<int(*)(int, int, int, int)>("_v256_set_d", &cv::_v256_set_d,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
  
  rb_mCv.define_module_function<int(*)(float, float, float, float, float, float, float, float)>("_v256_setr_ps", &cv::_v256_setr_ps,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));
  
  rb_mCv.define_module_function<int(*)(float)>("_v256_setall_ps", &cv::_v256_setall_ps,
    Arg("f32"));
  
  rb_mCv.define_module_function<int(*)(double, double, double, double)>("_v256_setr_pd", &cv::_v256_setr_pd,
    Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
  
  rb_mCv.define_module_function<int(*)(double)>("_v256_setall_pd", &cv::_v256_setall_pd,
    Arg("f64"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_lasx_packus_h", &cv::_lasx_packus_h,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_lasx_packs_h", &cv::_lasx_packs_h,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_lasx_packus_w", &cv::_lasx_packus_w,
    Arg("a"), Arg("b"));
  
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_lasx_packs_w", &cv::_lasx_packs_w,
    Arg("a"), Arg("b"));
  ...
  rb_mCv.define_module_function<int(*)(const int&, const int&)>("_v256_packs_epu32", &cv::_v256_packs_epu32,
    Arg("a"), Arg("b"));
  
  Class rb_cCvVUint8x32 = define_class_under<cv::v_uint8x32>(rb_mCv, "VUint8x32").
  ...
  rb_mCv.define_module_function<int(*)(const int&)>("_lasx_256_castpd_si256", &cv::_lasx_256_castpd_si256,
    Arg("v"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("_lasx_256_castsi256_ps", &cv::_lasx_256_castsi256_ps,
    Arg("v"));
  
  rb_mCv.define_module_function<int(*)(const int&)>("_lasx_256_castsi256_pd", &cv::_lasx_256_castsi256_pd,
    Arg("v"));
  ...
  rb_mCv.define_module_function<int(*)(const int&, const int&, const int)>("_v256_alignr_b", &cv::_v256_alignr_b,
    Arg("a"), Arg("b"), Arg("imm"));
  
  rb_mCv.define_module_function<cv::v_float64x4(*)(const cv::v_float64x4&, const cv::v_float64x4&)>("v256_alignr_64", &cv::v256_alignr_64,
    Arg("a"), Arg("b"));
  ...
  rb_cCvVUint8x32.define_method("*=", [](cv::v_uint8x32& self, const cv::v_uint8x32& other) -> cv::v_uint8x32&
  {
    return self *= other;
  });
  
  rb_cCvVInt8x32.define_method("*=", [](cv::v_int8x32& self, const cv::v_int8x32& other) -> cv::v_int8x32&
  {
    return self *= other;
  });
  
  rb_cCvVUint16x16.define_method("*=", [](cv::v_uint16x16& self, const cv::v_uint16x16& other) -> cv::v_uint16x16&
  {
    return self *= other;
  });
  
  rb_cCvVInt16x16.define_method("*=", [](cv::v_int16x16& self, const cv::v_int16x16& other) -> cv::v_int16x16&
  {
    return self *= other;
  });
  ...
  rb_mCv.define_module_function<cv::v_float32x8(*)(const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&)>("v_reduce_sum4", &cv::v_reduce_sum4,
    Arg("a"), Arg("b"), Arg("c"), Arg("d"));
  ...
  rb_mCv.define_module_function<cv::v_float32x8(*)(const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&)>("v_matmul", &cv::v_matmul,
    Arg("v"), Arg("m0"), Arg("m1"), Arg("m2"), Arg("m3"));
  
  rb_mCv.define_module_function<cv::v_float32x8(*)(const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&, const cv::v_float32x8&)>("v_matmuladd", &cv::v_matmuladd,
  ...
  rb_mCv.define_module_function<void(*)()>("v256_cleanup", &cv::v256_cleanup);
