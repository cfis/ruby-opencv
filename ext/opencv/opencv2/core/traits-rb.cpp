...
void Init_Traits()
{
  ...
  rb_cCvDataTypeHfloat.define_constant("Generic_type", (int)cv::DataType<hfloat>::generic_type);
  rb_cCvDataTypeHfloat.define_constant("Depth", (int)cv::DataType<hfloat>::depth);
  rb_cCvDataTypeHfloat.define_constant("Channels", (int)cv::DataType<hfloat>::channels);
  rb_cCvDataTypeHfloat.define_constant("Fmt", (int)cv::DataType<hfloat>::fmt);
  rb_cCvDataTypeHfloat.define_constant("Type", (int)cv::DataType<hfloat>::type);
