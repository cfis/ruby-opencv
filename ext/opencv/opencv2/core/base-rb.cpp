...
void Init_Base()
{
  ...
  Enum<cv::Error::Code> rb_cCvErrorCode = define_enum<cv::Error::Code>("Code", rb_mCvError).
  ...
  Enum<cv::DecompTypes> rb_cCvDecompTypes = define_enum<cv::DecompTypes>("DecompTypes", rb_mCv).
  ...
  Enum<cv::NormTypes> rb_cCvNormTypes = define_enum<cv::NormTypes>("NormTypes", rb_mCv).
  ...
  Enum<cv::CmpTypes> rb_cCvCmpTypes = define_enum<cv::CmpTypes>("CmpTypes", rb_mCv).
  ...
  Enum<cv::GemmFlags> rb_cCvGemmFlags = define_enum<cv::GemmFlags>("GemmFlags", rb_mCv).
  ...
  Enum<cv::DftFlags> rb_cCvDftFlags = define_enum<cv::DftFlags>("DftFlags", rb_mCv).
  ...
  Enum<cv::BorderTypes> rb_cCvBorderTypes = define_enum<cv::BorderTypes>("BorderTypes", rb_mCv).
  ...
  rb_mCv.define_module_function<void(*)(int, const std::basic_string<char>&, const char*, const char*, int)>("error", &cv::error);
  
  Class rb_cCvHamming = define_class_under<cv::Hamming>(rb_mCv, "Hamming").
    define_method<int(cv::Hamming::*)(const unsigned char*, const unsigned char*, int) const>("operator()", &cv::Hamming::operator());
  
  rb_mCv.define_module_function<int(*)(unsigned char)>("cv_abs", &cv::cv_abs);
  
  rb_mCv.define_module_function<int(*)(signed char)>("cv_abs", &cv::cv_abs);
  
  rb_mCv.define_module_function<int(*)(unsigned short)>("cv_abs", &cv::cv_abs);
  ...
  rb_mCv.define_module_function<int(*)(const unsigned char*, const unsigned char*, int)>("norm_l1", &cv::normL1);
  ...
  rb_mCv.define_module_function<int(*)(float*, unsigned long long, int, float*, unsigned long long, int)>("lu", &cv::LU);
  
  rb_mCv.define_module_function<int(*)(double*, unsigned long long, int, double*, unsigned long long, int)>("lu", &cv::LU);
  
  rb_mCv.define_module_function<bool(*)(float*, unsigned long long, int, float*, unsigned long long, int)>("cholesky", &cv::Cholesky);
  
  rb_mCv.define_module_function<bool(*)(double*, unsigned long long, int, double*, unsigned long long, int)>("cholesky", &cv::Cholesky);
  ...
  rb_mCvIpp.define_module_function<void(*)(int, const char*, const char*, int)>("set_ipp_status", &cv::ipp::setIppStatus);
  
  rb_mCvIpp.define_module_function<int(*)()>("get_ipp_status", &cv::ipp::getIppStatus);
  
  rb_mCvIpp.define_module_function<std::basic_string<char>(*)()>("get_ipp_error_location", &cv::ipp::getIppErrorLocation);
  ...
  rb_mCvIpp.define_module_function<std::basic_string<char>(*)()>("get_ipp_version", &cv::ipp::getIppVersion);
