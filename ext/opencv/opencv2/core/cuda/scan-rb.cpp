...
void Init_Scan()
{
  ...
  rb_mCvCudaDevice.define_module_function<int(*)(int, volatile int*, unsigned int)>("warp_scan_inclusive", &cv::cuda::device::warpScanInclusive,
    Arg("idata"), Arg("s_data"), Arg("tid"));
  
  rb_mCvCudaDevice.define_module_function<int(*)(int, volatile int*, unsigned int)>("warp_scan_exclusive", &cv::cuda::device::warpScanExclusive,
    Arg("idata"), Arg("s_data"), Arg("tid"));
  
  rb_mCvCudaDevice.define_module_function<int(*)(int, volatile int*, unsigned int)>("block_scan_inclusive", &cv::cuda::device::blockScanInclusive,
    Arg("idata"), Arg("s_data"), Arg("tid"));
