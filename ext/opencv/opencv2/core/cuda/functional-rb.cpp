...
inline void ShiftDispatcher_builder(Data_Type_T& klass)
{
};
...
void Init_Functional()
{
  ...
  Class rb_cCvCudaDeviceAbsFuncUnsignedChar = define_class_under<cv::cuda::device::abs_func<unsigned char>>(rb_mCvCudaDevice, "AbsFuncUnsignedChar").
  ...
  Class rb_cCvCudaDeviceAbsFuncSignedChar = define_class_under<cv::cuda::device::abs_func<signed char>>(rb_mCvCudaDevice, "AbsFuncSignedChar").
  ...
  Class rb_cCvCudaDeviceAbsFuncUnsignedShort = define_class_under<cv::cuda::device::abs_func<unsigned short>>(rb_mCvCudaDevice, "AbsFuncUnsignedShort").
  ...
  Class rb_cCvCudaDeviceAbsFuncUnsignedInt = define_class_under<cv::cuda::device::abs_func<unsigned int>>(rb_mCvCudaDevice, "AbsFuncUnsignedInt").
