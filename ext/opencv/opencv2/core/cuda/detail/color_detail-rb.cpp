...
void Init_ColorDetail()
{
  ...
  rb_mCvCudaDeviceColorDetail.define_constant("Yuv_shift", cv::cuda::device::color_detail::color_detail::yuv_shift);
  rb_mCvCudaDeviceColorDetail.define_constant("Xyz_shift", cv::cuda::device::color_detail::color_detail::xyz_shift);
  rb_mCvCudaDeviceColorDetail.define_constant("Gray_shift", cv::cuda::device::color_detail::color_detail::gray_shift);
  rb_mCvCudaDeviceColorDetail.define_constant("R2Y", cv::cuda::device::color_detail::color_detail::R2Y);
  rb_mCvCudaDeviceColorDetail.define_constant("G2Y", cv::cuda::device::color_detail::color_detail::G2Y);
  rb_mCvCudaDeviceColorDetail.define_constant("B2Y", cv::cuda::device::color_detail::color_detail::B2Y);
  rb_mCvCudaDeviceColorDetail.define_constant("RY15", cv::cuda::device::color_detail::color_detail::RY15);
  rb_mCvCudaDeviceColorDetail.define_constant("GY15", cv::cuda::device::color_detail::color_detail::GY15);
  rb_mCvCudaDeviceColorDetail.define_constant("BY15", cv::cuda::device::color_detail::color_detail::BY15);
  rb_mCvCudaDeviceColorDetail.define_constant("BLOCK_SIZE", cv::cuda::device::color_detail::color_detail::BLOCK_SIZE);
  ...
  rb_mCvCudaDeviceColorDetail.define_constant("LAB_CBRT_TAB_SIZE", cv::cuda::device::color_detail::color_detail::LAB_CBRT_TAB_SIZE);
  rb_mCvCudaDeviceColorDetail.define_constant("GAMMA_TAB_SIZE", cv::cuda::device::color_detail::color_detail::GAMMA_TAB_SIZE);
  rb_mCvCudaDeviceColorDetail.define_constant("Lab_shift", cv::cuda::device::color_detail::color_detail::lab_shift);
  rb_mCvCudaDeviceColorDetail.define_constant("Gamma_shift", cv::cuda::device::color_detail::color_detail::gamma_shift);
  rb_mCvCudaDeviceColorDetail.define_constant("Lab_shift2", cv::cuda::device::color_detail::color_detail::lab_shift2);
  rb_mCvCudaDeviceColorDetail.define_constant("LAB_CBRT_TAB_SIZE_B", cv::cuda::device::color_detail::color_detail::LAB_CBRT_TAB_SIZE_B);
