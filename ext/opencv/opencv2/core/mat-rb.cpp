...
void Init_Mat()
{
  ...
  Class rb_cCvInputArray = define_class_under<cv::_InputArray>(rb_mCv, "InputArray").
    ...
    define_method("step", &cv::_InputArray::step,
      Arg("i") = static_cast<int>(-1)).
    define_method("is_mat?", &cv::_InputArray::isMat).
    define_method("is_u_mat?", &cv::_InputArray::isUMat).
    define_method("is_mat_vector?", &cv::_InputArray::isMatVector).
    define_method("is_u_mat_vector?", &cv::_InputArray::isUMatVector).
    define_method("is_matx?", &cv::_InputArray::isMatx).
    define_method("is_vector?", &cv::_InputArray::isVector).
    define_method("is_gpu_mat?", &cv::_InputArray::isGpuMat).
    define_method("is_gpu_mat_vector?", &cv::_InputArray::isGpuMatVector);
  ...
  rb_cCvMat = define_class_under<cv::Mat>(rb_mCv, "Mat").
    ...
    define_method<cv::Mat(cv::Mat::*)(const std::vector<cv::Range>&) const>("()", &cv::Mat::operator(),
      Arg("ranges")).
    define_method("is_continuous?", &cv::Mat::isContinuous).
    define_method("is_submatrix?", &cv::Mat::isSubmatrix).
  ...
  Class rb_cMat1b = define_class_under<cv::Mat_<unsigned char>, cv::Mat>(rb_mCv, "Mat1b").
    define(&Mat__builder<Data_Type<cv::Mat_<unsigned char>>, unsigned char>);
  
  Class rb_cMat2b = define_class_under<cv::Mat_<cv::Vec<unsigned char, 2>>, cv::Mat>(rb_mCv, "Mat2b").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned char, 2>>>, cv::Vec<unsigned char, 2>>);
  
  Class rb_cMat3b = define_class_under<cv::Mat_<cv::Vec<unsigned char, 3>>, cv::Mat>(rb_mCv, "Mat3b").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned char, 3>>>, cv::Vec<unsigned char, 3>>);
  
  Class rb_cMat4b = define_class_under<cv::Mat_<cv::Vec<unsigned char, 4>>, cv::Mat>(rb_mCv, "Mat4b").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned char, 4>>>, cv::Vec<unsigned char, 4>>);
  
  Class rb_cMat1s = define_class_under<cv::Mat_<short>, cv::Mat>(rb_mCv, "Mat1s").
    define(&Mat__builder<Data_Type<cv::Mat_<short>>, short>);
  
  Class rb_cMat2s = define_class_under<cv::Mat_<cv::Vec<short, 2>>, cv::Mat>(rb_mCv, "Mat2s").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<short, 2>>>, cv::Vec<short, 2>>);
  
  Class rb_cMat3s = define_class_under<cv::Mat_<cv::Vec<short, 3>>, cv::Mat>(rb_mCv, "Mat3s").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<short, 3>>>, cv::Vec<short, 3>>);
  
  Class rb_cMat4s = define_class_under<cv::Mat_<cv::Vec<short, 4>>, cv::Mat>(rb_mCv, "Mat4s").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<short, 4>>>, cv::Vec<short, 4>>);
  
  Class rb_cMat1w = define_class_under<cv::Mat_<unsigned short>, cv::Mat>(rb_mCv, "Mat1w").
    define(&Mat__builder<Data_Type<cv::Mat_<unsigned short>>, unsigned short>);
  
  Class rb_cMat2w = define_class_under<cv::Mat_<cv::Vec<unsigned short, 2>>, cv::Mat>(rb_mCv, "Mat2w").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned short, 2>>>, cv::Vec<unsigned short, 2>>);
  
  Class rb_cMat3w = define_class_under<cv::Mat_<cv::Vec<unsigned short, 3>>, cv::Mat>(rb_mCv, "Mat3w").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned short, 3>>>, cv::Vec<unsigned short, 3>>);
  
  Class rb_cMat4w = define_class_under<cv::Mat_<cv::Vec<unsigned short, 4>>, cv::Mat>(rb_mCv, "Mat4w").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned short, 4>>>, cv::Vec<unsigned short, 4>>);
  
  Class rb_cMat1i = define_class_under<cv::Mat_<int>, cv::Mat>(rb_mCv, "Mat1i").
    define(&Mat__builder<Data_Type<cv::Mat_<int>>, int>);
  
  Class rb_cMat2i = define_class_under<cv::Mat_<cv::Vec<int, 2>>, cv::Mat>(rb_mCv, "Mat2i").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<int, 2>>>, cv::Vec<int, 2>>);
  
  Class rb_cMat3i = define_class_under<cv::Mat_<cv::Vec<int, 3>>, cv::Mat>(rb_mCv, "Mat3i").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<int, 3>>>, cv::Vec<int, 3>>);
  
  Class rb_cMat4i = define_class_under<cv::Mat_<cv::Vec<int, 4>>, cv::Mat>(rb_mCv, "Mat4i").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<int, 4>>>, cv::Vec<int, 4>>);
  
  Class rb_cMat1f = define_class_under<cv::Mat_<float>, cv::Mat>(rb_mCv, "Mat1f").
    define(&Mat__builder<Data_Type<cv::Mat_<float>>, float>);
  
  Class rb_cMat2f = define_class_under<cv::Mat_<cv::Vec<float, 2>>, cv::Mat>(rb_mCv, "Mat2f").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<float, 2>>>, cv::Vec<float, 2>>);
  
  Class rb_cMat3f = define_class_under<cv::Mat_<cv::Vec<float, 3>>, cv::Mat>(rb_mCv, "Mat3f").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<float, 3>>>, cv::Vec<float, 3>>);
  
  Class rb_cMat4f = define_class_under<cv::Mat_<cv::Vec<float, 4>>, cv::Mat>(rb_mCv, "Mat4f").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<float, 4>>>, cv::Vec<float, 4>>);
  
  Class rb_cMat1d = define_class_under<cv::Mat_<double>, cv::Mat>(rb_mCv, "Mat1d").
    define(&Mat__builder<Data_Type<cv::Mat_<double>>, double>);
  
  Class rb_cMat2d = define_class_under<cv::Mat_<cv::Vec<double, 2>>, cv::Mat>(rb_mCv, "Mat2d").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<double, 2>>>, cv::Vec<double, 2>>);
  
  Class rb_cMat3d = define_class_under<cv::Mat_<cv::Vec<double, 3>>, cv::Mat>(rb_mCv, "Mat3d").
    define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<double, 3>>>, cv::Vec<double, 3>>);
  
  Class rb_cMat4d = define_class_under<cv::Mat_<cv::Vec<double, 4>>, cv::Mat>(rb_mCv, "Mat4d").
  ...
  Class rb_cCvUMat = define_class_under<cv::UMat>(rb_mCv, "UMat").
    ...
    define_method<cv::UMat(cv::UMat::*)(const std::vector<cv::Range>&) const>("()", &cv::UMat::operator(),
      Arg("ranges")).
    define_method("is_continuous?", &cv::UMat::isContinuous).
    define_method("is_submatrix?", &cv::UMat::isSubmatrix).
