...
void Init_Mat()
{
  ...
  // Row access
  using PointerView_Tuple_T = typename detail::tuple_map<PointerView, Mat_Tuple_T>::type;
  using PointerView_Variant_T = detail::tuple_to_variant<PointerView_Tuple_T>::type;
  rb_cCvMat.define_method("ptr", [](cv::Mat& self, int row) -> PointerView_Variant_T
  {
    switch (self.type())
    {
      case CV_8UC1:
        return PointerView<unsigned char>(self.ptr<unsigned char>(row), self.cols);
      case CV_8UC2:
        return PointerView<cv::Vec<unsigned char, 2>>(self.ptr<cv::Vec<unsigned char, 2>>(row), self.cols);
      case CV_8UC3:
        return PointerView<cv::Vec<unsigned char, 3>>(self.ptr<cv::Vec<unsigned char, 3>>(row), self.cols);
      case CV_8UC4:
        return PointerView<cv::Vec<unsigned char, 4>>(self.ptr<cv::Vec<unsigned char, 4>>(row), self.cols);
      case CV_16UC1:
        return PointerView<unsigned short>(self.ptr<unsigned short>(row), self.cols);
      case CV_16UC2:
        return PointerView<cv::Vec<unsigned short, 2>>(self.ptr<cv::Vec<unsigned short, 2>>(row), self.cols);
      case CV_16UC3:
        return PointerView<cv::Vec<unsigned short, 3>>(self.ptr<cv::Vec<unsigned short, 3>>(row), self.cols);
      case CV_16UC4:
        return PointerView<cv::Vec<unsigned short, 4>>(self.ptr<cv::Vec<unsigned short, 4>>(row), self.cols);
      case CV_16SC1:
        return PointerView<short>(self.ptr<short>(row), self.cols);
      case CV_16SC2:
        return PointerView<cv::Vec<short, 2>>(self.ptr<cv::Vec<short, 2>>(row), self.cols);
      case CV_16SC3:
        return PointerView<cv::Vec<short, 3>>(self.ptr<cv::Vec<short, 3>>(row), self.cols);
      case CV_16SC4:
        return PointerView<cv::Vec<short, 4>>(self.ptr<cv::Vec<short, 4>>(row), self.cols);
      case CV_32SC1:
        return PointerView<int>(self.ptr<int>(row), self.cols);
      case CV_32SC2:
        return PointerView<cv::Vec<int, 2>>(self.ptr<cv::Vec<int, 2>>(row), self.cols);
      case CV_32SC3:
        return PointerView<cv::Vec<int, 3>>(self.ptr<cv::Vec<int, 3>>(row), self.cols);
      case CV_32SC4:
        return PointerView<cv::Vec<int, 4>>(self.ptr<cv::Vec<int, 4>>(row), self.cols);
      case CV_32FC1:
        return PointerView<float>(self.ptr<float>(row), self.cols);
      case CV_32FC2:
        return PointerView<cv::Vec<float, 2>>(self.ptr<cv::Vec<float, 2>>(row), self.cols);
      case CV_32FC3:
        return PointerView<cv::Vec<float, 3>>(self.ptr<cv::Vec<float, 3>>(row), self.cols);
      case CV_32FC4:
        return PointerView<cv::Vec<float, 4>>(self.ptr<cv::Vec<float, 4>>(row), self.cols);
      case CV_64FC1:
        return PointerView<double>(self.ptr<double>(row), self.cols);
      case CV_64FC2:
        return PointerView<cv::Vec<double, 2>>(self.ptr<cv::Vec<double, 2>>(row), self.cols);
      case CV_64FC3:
        return PointerView<cv::Vec<double, 3>>(self.ptr<cv::Vec<double, 3>>(row), self.cols);
      case CV_64FC4:
        return PointerView<cv::Vec<double, 4>>(self.ptr<cv::Vec<double, 4>>(row), self.cols);
      default:
        throw std::runtime_error("Unsupported type: " + std::to_string(self.type()));
    }
  });
