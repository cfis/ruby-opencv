...
inline void MatCommaInitializer__builder(Data_Object_T& klass)
{
  klass.define_constructor(Constructor<cv::MatCommaInitializer_::MatCommaInitializer_<_Tp>, cv::Mat_<_Tp>*>());
};

template<typename Data_Object_T, typename _Tp>
inline void Mat__builder(Data_Object_T& klass)
{
  klass.define_constructor(Constructor<cv::Mat_::Mat_<_Tp>>()).
    ...
    define_constructor(Constructor<cv::Mat_::Mat_<_Tp>, cv::Size_<int>>()).
    define_constructor(Constructor<cv::Mat_::Mat_<_Tp>, cv::Size_<int>, const _Tp&>()).
    ...
    define_constructor(Constructor<cv::Mat_::Mat_<_Tp>, int, int, _Tp*, unsigned long long>()).
    define_constructor(Constructor<cv::Mat_::Mat_<_Tp>, int, const int*, _Tp*, const unsigned long long*>()).
    define_constructor(Constructor<cv::Mat_::Mat_<_Tp>, const cv::Mat_<_Tp>&, const cv::Range&, const cv::Range&>()).
    define_constructor(Constructor<cv::Mat_::Mat_<_Tp>, const cv::Mat_<_Tp>&, const cv::Rect_<int>&>()).
    ...
    template define_iterator<cv::MatIterator_<_Tp>(cv::Mat_<_Tp>::*)()>(&cv::Mat_<_Tp>::begin, &cv::Mat_<_Tp>::end, "each").
    template define_iterator<cv::MatConstIterator_<_Tp>(cv::Mat_<_Tp>::*)() const>(&cv::Mat_<_Tp>::begin, &cv::Mat_<_Tp>::end, "each_const").
    template define_iterator<std::reverse_iterator<cv::MatIterator_<_Tp>>(cv::Mat_<_Tp>::*)()>(&cv::Mat_<_Tp>::rbegin, &cv::Mat_<_Tp>::rend, "each_reverse").
    template define_iterator<std::reverse_iterator<cv::MatConstIterator_<_Tp>>(cv::Mat_<_Tp>::*)() const>(&cv::Mat_<_Tp>::rbegin, &cv::Mat_<_Tp>::rend, "each_reverse_const").
    template define_method<void(cv::Mat_<_Tp>::*)(int, int)>("create", &cv::Mat_<_Tp>::create).
    template define_method<void(cv::Mat_<_Tp>::*)(cv::Size_<int>)>("create", &cv::Mat_<_Tp>::create).
    ...
    template define_method<unsigned long long(cv::Mat_<_Tp>::*)() const>("elem_size", &cv::Mat_<_Tp>::elemSize).
    template define_method<unsigned long long(cv::Mat_<_Tp>::*)() const>("elem_size1", &cv::Mat_<_Tp>::elemSize1).
    ...
    template define_method<unsigned long long(cv::Mat_<_Tp>::*)(int) const>("step1", &cv::Mat_<_Tp>::step1).
    template define_method<unsigned long long(cv::Mat_<_Tp>::*)(int) const>("step_t", &cv::Mat_<_Tp>::stepT).
    template define_singleton_function<cv::MatExpr(*)(int, int)>("zeros", &cv::Mat_<_Tp>::zeros).
    template define_singleton_function<cv::MatExpr(*)(cv::Size_<int>)>("zeros", &cv::Mat_<_Tp>::zeros).
    ...
    template define_singleton_function<cv::MatExpr(*)(cv::Size_<int>)>("ones", &cv::Mat_<_Tp>::ones).
    ...
    template define_singleton_function<cv::MatExpr(*)(cv::Size_<int>)>("eye", &cv::Mat_<_Tp>::eye).
    ...
    template define_method<cv::Mat_<_Tp>(cv::Mat_<_Tp>::*)(const cv::Rect_<int>&) const>("()", &cv::Mat_<_Tp>::operator()).
    ...
    template define_method<_Tp&(cv::Mat_<_Tp>::*)(cv::Point_<int>)>("()", &cv::Mat_<_Tp>::operator()).
    template define_method<const _Tp&(cv::Mat_<_Tp>::*)(cv::Point_<int>) const>("()", &cv::Mat_<_Tp>::operator()).
...
template<typename Data_Object_T, typename _Tp>
inline void SparseMat__builder(Data_Object_T& klass)
{
  klass.define_constructor(Constructor<cv::SparseMat_::SparseMat_<_Tp>>()).
    ...
    template define_method<_Tp&(cv::SparseMat_<_Tp>::*)(int, unsigned long long*)>("ref", &cv::SparseMat_<_Tp>::ref).
    template define_method<_Tp&(cv::SparseMat_<_Tp>::*)(int, int, unsigned long long*)>("ref", &cv::SparseMat_<_Tp>::ref).
    template define_method<_Tp&(cv::SparseMat_<_Tp>::*)(int, int, int, unsigned long long*)>("ref", &cv::SparseMat_<_Tp>::ref).
    template define_method<_Tp&(cv::SparseMat_<_Tp>::*)(const int*, unsigned long long*)>("ref", &cv::SparseMat_<_Tp>::ref).
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(int, unsigned long long*) const>("()", &cv::SparseMat_<_Tp>::operator()).
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(int, int, unsigned long long*) const>("()", &cv::SparseMat_<_Tp>::operator()).
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(int, int, int, unsigned long long*) const>("()", &cv::SparseMat_<_Tp>::operator()).
    template define_method<_Tp(cv::SparseMat_<_Tp>::*)(const int*, unsigned long long*) const>("()", &cv::SparseMat_<_Tp>::operator()).
...
template<typename Data_Object_T, typename _Tp>
inline void MatConstIterator__builder(Data_Object_T& klass)
{
  klass.define_constructor(Constructor<cv::MatConstIterator_::MatConstIterator_<_Tp>>()).
    ...
    define_constructor(Constructor<cv::MatConstIterator_::MatConstIterator_<_Tp>, const cv::Mat_<_Tp>*, cv::Point_<int>>()).
    ...
    template define_method<const _Tp&(cv::MatConstIterator_<_Tp>::*)(long long) const>("[]", &cv::MatConstIterator_<_Tp>::operator[]).
    template define_method<cv::MatConstIterator_<_Tp>&(cv::MatConstIterator_<_Tp>::*)(long long)>("+=", &cv::MatConstIterator_<_Tp>::operator+=).
    template define_method<cv::MatConstIterator_<_Tp>&(cv::MatConstIterator_<_Tp>::*)(long long)>("-=", &cv::MatConstIterator_<_Tp>::operator-=).
    ...
    template define_method<cv::MatConstIterator_<_Tp>&(cv::MatConstIterator_<_Tp>::*)()>("++", &cv::MatConstIterator_<_Tp>::operator++).
    template define_method<cv::MatConstIterator_<_Tp>(cv::MatConstIterator_<_Tp>::*)(int)>("++", &cv::MatConstIterator_<_Tp>::operator++).
    template define_method<cv::Point_<int>(cv::MatConstIterator_<_Tp>::*)() const>("pos", &cv::MatConstIterator_<_Tp>::pos);
};

template<typename Data_Object_T, typename _Tp>
inline void MatIterator__builder(Data_Object_T& klass)
{
  klass.define_constructor(Constructor<cv::MatIterator_::MatIterator_<_Tp>>()).
    ...
    define_constructor(Constructor<cv::MatIterator_::MatIterator_<_Tp>, cv::Mat_<_Tp>*, cv::Point_<int>>()).
    ...
    template define_method<_Tp&(cv::MatIterator_<_Tp>::*)(long long) const>("[]", &cv::MatIterator_<_Tp>::operator[]).
    template define_method<cv::MatIterator_<_Tp>&(cv::MatIterator_<_Tp>::*)(long long)>("+=", &cv::MatIterator_<_Tp>::operator+=).
    template define_method<cv::MatIterator_<_Tp>&(cv::MatIterator_<_Tp>::*)(long long)>("-=", &cv::MatIterator_<_Tp>::operator-=).
...
template<typename Data_Object_T, typename _Tp>
inline void SparseMatConstIterator__builder(Data_Object_T& klass)
{
...
template<typename Data_Object_T, typename _Tp>
inline void SparseMatIterator__builder(Data_Object_T& klass)
{
...
void Init_Mat()
{
  ...
  Enum<cv::AccessFlag> rb_cCvAccessFlag = define_enum<cv::AccessFlag>("AccessFlag", rb_mCv).
  ...
  Class rb_cCvInputArray = define_class_under<cv::_InputArray>(rb_mCv, "InputArray").
    ...
    define_method<cv::Size_<int>(cv::_InputArray::*)() const>("get_sz", &cv::_InputArray::getSz).
    ...
    define_method<cv::Size_<int>(cv::_InputArray::*)(int) const>("size", &cv::_InputArray::size).
    ...
    define_method<unsigned long long(cv::_InputArray::*)(int) const>("total", &cv::_InputArray::total).
    ...
    define_method<unsigned long long(cv::_InputArray::*)(int) const>("offset", &cv::_InputArray::offset).
    define_method<unsigned long long(cv::_InputArray::*)(int) const>("step", &cv::_InputArray::step).
  ...
  Enum<cv::_InputArray::KindFlag> rb_cCvInputArrayKindFlag = define_enum<cv::_InputArray::KindFlag>("KindFlag", rb_cCvInputArray).
  ...
  Class rb_cCvOutputArray = define_class_under<cv::_OutputArray, cv::_InputArray>(rb_mCv, "OutputArray").
    ...
    define_method<void(cv::_OutputArray::*)(cv::Size_<int>, int, int, bool, cv::_OutputArray::DepthMask) const>("create", &cv::_OutputArray::create).
  ...
  Enum<cv::_OutputArray::DepthMask> rb_cCvOutputArrayDepthMask = define_enum<cv::_OutputArray::DepthMask>("DepthMask", rb_cCvOutputArray).
  ...
  rb_mCv.define_module_function<const cv::_InputOutputArray &(*)()>("no_array", &cv::noArray);
  
  Enum<cv::UMatUsageFlags> rb_cCvUMatUsageFlags = define_enum<cv::UMatUsageFlags>("UMatUsageFlags", rb_mCv).
  ...
  Class rb_cCvMatAllocator = define_class_under<cv::MatAllocator>(rb_mCv, "MatAllocator").
    define_method<cv::UMatData*(cv::MatAllocator::*)(int, const int*, int, void*, unsigned long long*, cv::AccessFlag, cv::UMatUsageFlags) const>("allocate", &cv::MatAllocator::allocate).
  ...
  Enum<cv::UMatData::MemoryFlag> rb_cCvUMatDataMemoryFlag = define_enum<cv::UMatData::MemoryFlag>("MemoryFlag", rb_cCvUMatData).
  ...
  Class rb_cCvMatSize = define_class_under<cv::MatSize>(rb_mCv, "MatSize").
    ...
    define_method<cv::Size_<int>(cv::MatSize::*)() const>("()", &cv::MatSize::operator()).
  ...
  Class rb_cCvMatStep = define_class_under<cv::MatStep>(rb_mCv, "MatStep").
    ...
    define_constructor(Constructor<cv::MatStep, unsigned long long>()).
    define_method<const unsigned long long&(cv::MatStep::*)(int) const noexcept>("[]", &cv::MatStep::operator[]).
    define_method<unsigned long long&(cv::MatStep::*)(int) noexcept>("[]", &cv::MatStep::operator[]).
    define_method<cv::MatStep&(cv::MatStep::*)(unsigned long long)>("=", &cv::MatStep::operator=).
    define_attr("p", &cv::MatStep::p);
  
  Class rb_cCvMat = define_class_under<cv::Mat>(rb_mCv, "Mat").
    define_constructor(Constructor<cv::Mat>()).
    define_constructor(Constructor<cv::Mat, int, int, int>()).
    define_constructor(Constructor<cv::Mat, cv::Size_<int>, int>()).
    define_constructor(Constructor<cv::Mat, int, int, int, const cv::Scalar_<double>&>()).
    define_constructor(Constructor<cv::Mat, cv::Size_<int>, int, const cv::Scalar_<double>&>()).
    define_constructor(Constructor<cv::Mat, int, const int*, int>()).
    define_constructor(Constructor<cv::Mat, const std::vector<int>&, int>()).
    define_constructor(Constructor<cv::Mat, int, const int*, int, const cv::Scalar_<double>&>()).
    define_constructor(Constructor<cv::Mat, const std::vector<int>&, int, const cv::Scalar_<double>&>()).
    define_constructor(Constructor<cv::Mat, const cv::Mat&>()).
    define_constructor(Constructor<cv::Mat, int, int, int, void*, unsigned long long>()).
    define_constructor(Constructor<cv::Mat, cv::Size_<int>, int, void*, unsigned long long>()).
    define_constructor(Constructor<cv::Mat, int, const int*, int, void*, const unsigned long long*>()).
    define_constructor(Constructor<cv::Mat, const std::vector<int>&, int, void*, const unsigned long long*>()).
    define_constructor(Constructor<cv::Mat, const cv::Mat&, const cv::Range&, const cv::Range&>()).
    define_constructor(Constructor<cv::Mat, const cv::Mat&, const cv::Rect_<int>&>()).
    ...
    define_method<void(cv::Mat::*)(const cv::_OutputArray &) const>("copy_to", &cv::Mat::copyTo).
    define_method<void(cv::Mat::*)(const cv::_OutputArray &, const cv::_InputArray &) const>("copy_to", &cv::Mat::copyTo).
    define_method<void(cv::Mat::*)(const cv::_OutputArray &, int, double, double) const>("convert_to", &cv::Mat::convertTo).
    define_method<void(cv::Mat::*)(cv::Mat&, int) const>("assign_to", &cv::Mat::assignTo).
    define_method<cv::Mat&(cv::Mat::*)(const cv::Scalar_<double>&)>("=", &cv::Mat::operator=).
    define_method<cv::Mat&(cv::Mat::*)(const cv::_InputArray &, const cv::_InputArray &)>("set_to", &cv::Mat::setTo).
    ...
    define_method<cv::MatExpr(cv::Mat::*)(const cv::_InputArray &, double) const>("mul", &cv::Mat::mul).
    define_method<cv::Mat(cv::Mat::*)(const cv::_InputArray &) const>("cross", &cv::Mat::cross).
    define_method<double(cv::Mat::*)(const cv::_InputArray &) const>("dot", &cv::Mat::dot).
    define_singleton_function<cv::MatExpr(*)(int, int, int)>("zeros", &cv::Mat::zeros).
    define_singleton_function<cv::MatExpr(*)(cv::Size_<int>, int)>("zeros", &cv::Mat::zeros).
    ...
    define_singleton_function<cv::MatExpr(*)(cv::Size_<int>, int)>("ones", &cv::Mat::ones).
    ...
    define_singleton_function<cv::MatExpr(*)(cv::Size_<int>, int)>("eye", &cv::Mat::eye).
    define_method<void(cv::Mat::*)(int, int, int)>("create", &cv::Mat::create).
    define_method<void(cv::Mat::*)(cv::Size_<int>, int)>("create", &cv::Mat::create).
    ...
    define_method<void(cv::Mat::*)(unsigned long long)>("reserve", &cv::Mat::reserve).
    define_method<void(cv::Mat::*)(unsigned long long)>("reserve_buffer", &cv::Mat::reserveBuffer).
    define_method<void(cv::Mat::*)(unsigned long long)>("resize", &cv::Mat::resize).
    define_method<void(cv::Mat::*)(unsigned long long, const cv::Scalar_<double>&)>("resize", &cv::Mat::resize).
    ...
    define_method<void(cv::Mat::*)(unsigned long long)>("pop_back", &cv::Mat::pop_back).
    define_method<void(cv::Mat::*)(cv::Size_<int>&, cv::Point_<int>&) const>("locate_roi", &cv::Mat::locateROI).
    ...
    define_method<cv::Mat(cv::Mat::*)(const cv::Rect_<int>&) const>("()", &cv::Mat::operator()).
    ...
    define_method<unsigned long long(cv::Mat::*)() const>("elem_size", &cv::Mat::elemSize).
    define_method<unsigned long long(cv::Mat::*)() const>("elem_size1", &cv::Mat::elemSize1).
    ...
    define_method<unsigned long long(cv::Mat::*)(int) const>("step1", &cv::Mat::step1).
    define_method<bool(cv::Mat::*)() const>("empty", &cv::Mat::empty).
    define_method<unsigned long long(cv::Mat::*)() const>("total", &cv::Mat::total).
    define_method<unsigned long long(cv::Mat::*)(int, int) const>("total", &cv::Mat::total).
    define_method<int(cv::Mat::*)(int, int, bool) const>("check_vector", &cv::Mat::checkVector).
    define_method<unsigned char*(cv::Mat::*)(int)>("ptr", &cv::Mat::ptr).
    define_method<const unsigned char*(cv::Mat::*)(int) const>("ptr", &cv::Mat::ptr).
    define_method<unsigned char*(cv::Mat::*)(int, int)>("ptr", &cv::Mat::ptr).
    define_method<const unsigned char*(cv::Mat::*)(int, int) const>("ptr", &cv::Mat::ptr).
    define_method<unsigned char*(cv::Mat::*)(int, int, int)>("ptr", &cv::Mat::ptr).
    define_method<const unsigned char*(cv::Mat::*)(int, int, int) const>("ptr", &cv::Mat::ptr).
    define_method<unsigned char*(cv::Mat::*)(const int*)>("ptr", &cv::Mat::ptr).
    define_method<const unsigned char*(cv::Mat::*)(const int*) const>("ptr", &cv::Mat::ptr).
  ...
  Data_Type<cv::Mat_<unsigned char>> rb_cMat1b = define_class_under<cv::Mat_<unsigned char>>(rb_mCv, "Mat1b");
  rb_cMat1b.define(&Mat__builder<Data_Type<cv::Mat_<unsigned char>>, unsigned char>);
  
  Data_Type<cv::Mat_<cv::Vec<unsigned char, 2>>> rb_cMat2b = define_class_under<cv::Mat_<cv::Vec<unsigned char, 2>>>(rb_mCv, "Mat2b");
  rb_cMat2b.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned char, 2>>>, cv::Vec<unsigned char, 2>>);
  
  Data_Type<cv::Mat_<cv::Vec<unsigned char, 3>>> rb_cMat3b = define_class_under<cv::Mat_<cv::Vec<unsigned char, 3>>>(rb_mCv, "Mat3b");
  rb_cMat3b.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned char, 3>>>, cv::Vec<unsigned char, 3>>);
  
  Data_Type<cv::Mat_<cv::Vec<unsigned char, 4>>> rb_cMat4b = define_class_under<cv::Mat_<cv::Vec<unsigned char, 4>>>(rb_mCv, "Mat4b");
  rb_cMat4b.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned char, 4>>>, cv::Vec<unsigned char, 4>>);
  
  Data_Type<cv::Mat_<short>> rb_cMat1s = define_class_under<cv::Mat_<short>>(rb_mCv, "Mat1s");
  rb_cMat1s.define(&Mat__builder<Data_Type<cv::Mat_<short>>, short>);
  
  Data_Type<cv::Mat_<cv::Vec<short, 2>>> rb_cMat2s = define_class_under<cv::Mat_<cv::Vec<short, 2>>>(rb_mCv, "Mat2s");
  rb_cMat2s.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<short, 2>>>, cv::Vec<short, 2>>);
  
  Data_Type<cv::Mat_<cv::Vec<short, 3>>> rb_cMat3s = define_class_under<cv::Mat_<cv::Vec<short, 3>>>(rb_mCv, "Mat3s");
  rb_cMat3s.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<short, 3>>>, cv::Vec<short, 3>>);
  
  Data_Type<cv::Mat_<cv::Vec<short, 4>>> rb_cMat4s = define_class_under<cv::Mat_<cv::Vec<short, 4>>>(rb_mCv, "Mat4s");
  rb_cMat4s.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<short, 4>>>, cv::Vec<short, 4>>);
  
  Data_Type<cv::Mat_<unsigned short>> rb_cMat1w = define_class_under<cv::Mat_<unsigned short>>(rb_mCv, "Mat1w");
  rb_cMat1w.define(&Mat__builder<Data_Type<cv::Mat_<unsigned short>>, unsigned short>);
  
  Data_Type<cv::Mat_<cv::Vec<unsigned short, 2>>> rb_cMat2w = define_class_under<cv::Mat_<cv::Vec<unsigned short, 2>>>(rb_mCv, "Mat2w");
  rb_cMat2w.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned short, 2>>>, cv::Vec<unsigned short, 2>>);
  
  Data_Type<cv::Mat_<cv::Vec<unsigned short, 3>>> rb_cMat3w = define_class_under<cv::Mat_<cv::Vec<unsigned short, 3>>>(rb_mCv, "Mat3w");
  rb_cMat3w.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned short, 3>>>, cv::Vec<unsigned short, 3>>);
  
  Data_Type<cv::Mat_<cv::Vec<unsigned short, 4>>> rb_cMat4w = define_class_under<cv::Mat_<cv::Vec<unsigned short, 4>>>(rb_mCv, "Mat4w");
  rb_cMat4w.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<unsigned short, 4>>>, cv::Vec<unsigned short, 4>>);
  
  Data_Type<cv::Mat_<int>> rb_cMat1i = define_class_under<cv::Mat_<int>>(rb_mCv, "Mat1i");
  rb_cMat1i.define(&Mat__builder<Data_Type<cv::Mat_<int>>, int>);
  
  Data_Type<cv::Mat_<cv::Vec<int, 2>>> rb_cMat2i = define_class_under<cv::Mat_<cv::Vec<int, 2>>>(rb_mCv, "Mat2i");
  rb_cMat2i.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<int, 2>>>, cv::Vec<int, 2>>);
  
  Data_Type<cv::Mat_<cv::Vec<int, 3>>> rb_cMat3i = define_class_under<cv::Mat_<cv::Vec<int, 3>>>(rb_mCv, "Mat3i");
  rb_cMat3i.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<int, 3>>>, cv::Vec<int, 3>>);
  
  Data_Type<cv::Mat_<cv::Vec<int, 4>>> rb_cMat4i = define_class_under<cv::Mat_<cv::Vec<int, 4>>>(rb_mCv, "Mat4i");
  rb_cMat4i.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<int, 4>>>, cv::Vec<int, 4>>);
  
  Data_Type<cv::Mat_<float>> rb_cMat1f = define_class_under<cv::Mat_<float>>(rb_mCv, "Mat1f");
  rb_cMat1f.define(&Mat__builder<Data_Type<cv::Mat_<float>>, float>);
  
  Data_Type<cv::Mat_<cv::Vec<float, 2>>> rb_cMat2f = define_class_under<cv::Mat_<cv::Vec<float, 2>>>(rb_mCv, "Mat2f");
  rb_cMat2f.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<float, 2>>>, cv::Vec<float, 2>>);
  
  Data_Type<cv::Mat_<cv::Vec<float, 3>>> rb_cMat3f = define_class_under<cv::Mat_<cv::Vec<float, 3>>>(rb_mCv, "Mat3f");
  rb_cMat3f.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<float, 3>>>, cv::Vec<float, 3>>);
  
  Data_Type<cv::Mat_<cv::Vec<float, 4>>> rb_cMat4f = define_class_under<cv::Mat_<cv::Vec<float, 4>>>(rb_mCv, "Mat4f");
  rb_cMat4f.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<float, 4>>>, cv::Vec<float, 4>>);
  
  Data_Type<cv::Mat_<double>> rb_cMat1d = define_class_under<cv::Mat_<double>>(rb_mCv, "Mat1d");
  rb_cMat1d.define(&Mat__builder<Data_Type<cv::Mat_<double>>, double>);
  
  Data_Type<cv::Mat_<cv::Vec<double, 2>>> rb_cMat2d = define_class_under<cv::Mat_<cv::Vec<double, 2>>>(rb_mCv, "Mat2d");
  rb_cMat2d.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<double, 2>>>, cv::Vec<double, 2>>);
  
  Data_Type<cv::Mat_<cv::Vec<double, 3>>> rb_cMat3d = define_class_under<cv::Mat_<cv::Vec<double, 3>>>(rb_mCv, "Mat3d");
  rb_cMat3d.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<double, 3>>>, cv::Vec<double, 3>>);
  
  Data_Type<cv::Mat_<cv::Vec<double, 4>>> rb_cMat4d = define_class_under<cv::Mat_<cv::Vec<double, 4>>>(rb_mCv, "Mat4d");
  rb_cMat4d.define(&Mat__builder<Data_Type<cv::Mat_<cv::Vec<double, 4>>>, cv::Vec<double, 4>>);
  ...
  Class rb_cCvUMat = define_class_under<cv::UMat>(rb_mCv, "UMat").
    ...
    define_constructor(Constructor<cv::UMat, cv::Size_<int>, int, cv::UMatUsageFlags>()).
    define_constructor(Constructor<cv::UMat, int, int, int, const cv::Scalar_<double>&, cv::UMatUsageFlags>()).
    define_constructor(Constructor<cv::UMat, cv::Size_<int>, int, const cv::Scalar_<double>&, cv::UMatUsageFlags>()).
    define_constructor(Constructor<cv::UMat, int, const int*, int, cv::UMatUsageFlags>()).
    define_constructor(Constructor<cv::UMat, int, const int*, int, const cv::Scalar_<double>&, cv::UMatUsageFlags>()).
    ...
    define_constructor(Constructor<cv::UMat, const cv::UMat&, const cv::Rect_<int>&>()).
    ...
    define_method<void(cv::UMat::*)(const cv::_OutputArray &) const>("copy_to", &cv::UMat::copyTo).
    define_method<void(cv::UMat::*)(const cv::_OutputArray &, const cv::_InputArray &) const>("copy_to", &cv::UMat::copyTo).
    define_method<void(cv::UMat::*)(const cv::_OutputArray &, int, double, double) const>("convert_to", &cv::UMat::convertTo).
    define_method<void(cv::UMat::*)(cv::UMat&, int) const>("assign_to", &cv::UMat::assignTo).
    define_method<cv::UMat&(cv::UMat::*)(const cv::Scalar_<double>&)>("=", &cv::UMat::operator=).
    define_method<cv::UMat&(cv::UMat::*)(const cv::_InputArray &, const cv::_InputArray &)>("set_to", &cv::UMat::setTo).
    ...
    define_method<cv::UMat(cv::UMat::*)(const cv::_InputArray &, double) const>("mul", &cv::UMat::mul).
    define_method<double(cv::UMat::*)(const cv::_InputArray &) const>("dot", &cv::UMat::dot).
    define_singleton_function<cv::UMat(*)(int, int, int, cv::UMatUsageFlags)>("zeros", &cv::UMat::zeros).
    define_singleton_function<cv::UMat(*)(cv::Size_<int>, int, cv::UMatUsageFlags)>("zeros", &cv::UMat::zeros).
    ...
    define_singleton_function<cv::UMat(*)(cv::Size_<int>, int)>("zeros", &cv::UMat::zeros).
    ...
    define_singleton_function<cv::UMat(*)(cv::Size_<int>, int, cv::UMatUsageFlags)>("ones", &cv::UMat::ones).
    ...
    define_singleton_function<cv::UMat(*)(cv::Size_<int>, int)>("ones", &cv::UMat::ones).
    ...
    define_singleton_function<cv::UMat(*)(cv::Size_<int>, int, cv::UMatUsageFlags)>("eye", &cv::UMat::eye).
    define_singleton_function<cv::UMat(*)(int, int, int)>("eye", &cv::UMat::eye).
    define_singleton_function<cv::UMat(*)(cv::Size_<int>, int)>("eye", &cv::UMat::eye).
    define_method<void(cv::UMat::*)(int, int, int, cv::UMatUsageFlags)>("create", &cv::UMat::create).
    define_method<void(cv::UMat::*)(cv::Size_<int>, int, cv::UMatUsageFlags)>("create", &cv::UMat::create).
    ...
    define_method<void(cv::UMat::*)(cv::Size_<int>&, cv::Point_<int>&) const>("locate_roi", &cv::UMat::locateROI).
    ...
    define_method<cv::UMat(cv::UMat::*)(const cv::Rect_<int>&) const>("()", &cv::UMat::operator()).
    ...
    define_method<unsigned long long(cv::UMat::*)() const>("elem_size", &cv::UMat::elemSize).
    define_method<unsigned long long(cv::UMat::*)() const>("elem_size1", &cv::UMat::elemSize1).
    ...
    define_method<unsigned long long(cv::UMat::*)(int) const>("step1", &cv::UMat::step1).
    define_method<bool(cv::UMat::*)() const>("empty", &cv::UMat::empty).
    define_method<unsigned long long(cv::UMat::*)() const>("total", &cv::UMat::total).
    ...
    define_method<void(cv::UMat::*)(unsigned long long*) const>("ndoffset", &cv::UMat::ndoffset).
  ...
  Class rb_cCvSparseMat = define_class_under<cv::SparseMat>(rb_mCv, "SparseMat").
    ...
    define_method<unsigned long long(cv::SparseMat::*)() const>("elem_size", &cv::SparseMat::elemSize).
    define_method<unsigned long long(cv::SparseMat::*)() const>("elem_size1", &cv::SparseMat::elemSize1).
    ...
    define_method<unsigned long long(cv::SparseMat::*)() const>("nzcount", &cv::SparseMat::nzcount).
    define_method<unsigned long long(cv::SparseMat::*)(int) const>("hash", &cv::SparseMat::hash).
    define_method<unsigned long long(cv::SparseMat::*)(int, int) const>("hash", &cv::SparseMat::hash).
    define_method<unsigned long long(cv::SparseMat::*)(int, int, int) const>("hash", &cv::SparseMat::hash).
    define_method<unsigned long long(cv::SparseMat::*)(const int*) const>("hash", &cv::SparseMat::hash).
    define_method<unsigned char*(cv::SparseMat::*)(int, bool, unsigned long long*)>("ptr", &cv::SparseMat::ptr).
    define_method<unsigned char*(cv::SparseMat::*)(int, int, bool, unsigned long long*)>("ptr", &cv::SparseMat::ptr).
    define_method<unsigned char*(cv::SparseMat::*)(int, int, int, bool, unsigned long long*)>("ptr", &cv::SparseMat::ptr).
    define_method<unsigned char*(cv::SparseMat::*)(const int*, bool, unsigned long long*)>("ptr", &cv::SparseMat::ptr).
    define_method<void(cv::SparseMat::*)(int, int, unsigned long long*)>("erase", &cv::SparseMat::erase).
    define_method<void(cv::SparseMat::*)(int, int, int, unsigned long long*)>("erase", &cv::SparseMat::erase).
    define_method<void(cv::SparseMat::*)(const int*, unsigned long long*)>("erase", &cv::SparseMat::erase).
   ...
   // define_iterator<cv::SparseMatConstIterator(cv::SparseMat::*)() const>(&cv::SparseMat::begin, &cv::SparseMat::end, "each_const").
    define_method<cv::SparseMat::Node*(cv::SparseMat::*)(unsigned long long)>("node", &cv::SparseMat::node).
    define_method<const cv::SparseMat::Node*(cv::SparseMat::*)(unsigned long long) const>("node", &cv::SparseMat::node).
    define_method<unsigned char*(cv::SparseMat::*)(const int*, unsigned long long)>("new_node", &cv::SparseMat::newNode).
    define_method<void(cv::SparseMat::*)(unsigned long long, unsigned long long, unsigned long long)>("remove_node", &cv::SparseMat::removeNode).
    define_method<void(cv::SparseMat::*)(unsigned long long)>("resize_hash_tab", &cv::SparseMat::resizeHashTab).
  ...
  Class rb_cCvMatConstIterator = define_class_under<cv::MatConstIterator>(rb_mCv, "MatConstIterator").
    ...
    define_constructor(Constructor<cv::MatConstIterator, const cv::Mat*, cv::Point_<int>>()).
    ...
    define_method<const unsigned char*(cv::MatConstIterator::*)() const>("*", &cv::MatConstIterator::operator*).
    define_method<const unsigned char*(cv::MatConstIterator::*)(long long) const>("[]", &cv::MatConstIterator::operator[]).
    define_method<cv::MatConstIterator&(cv::MatConstIterator::*)(long long)>("+=", &cv::MatConstIterator::operator+=).
    define_method<cv::MatConstIterator&(cv::MatConstIterator::*)(long long)>("-=", &cv::MatConstIterator::operator-=).
    ...
    define_method<cv::MatConstIterator&(cv::MatConstIterator::*)()>("++", &cv::MatConstIterator::operator++).
    define_method<cv::MatConstIterator(cv::MatConstIterator::*)(int)>("++", &cv::MatConstIterator::operator++).
    define_method<cv::Point_<int>(cv::MatConstIterator::*)() const>("pos", &cv::MatConstIterator::pos).
    define_method<void(cv::MatConstIterator::*)(int*) const>("pos", &cv::MatConstIterator::pos).
    define_method<long long(cv::MatConstIterator::*)() const>("lpos", &cv::MatConstIterator::lpos).
    define_method<void(cv::MatConstIterator::*)(long long, bool)>("seek", &cv::MatConstIterator::seek).
  ...
  Class rb_cCvNAryMatIterator = define_class_under<cv::NAryMatIterator>(rb_mCv, "NAryMatIterator").
    ...
    define_constructor(Constructor<cv::NAryMatIterator, const cv::Mat**, unsigned char**, int>()).
    define_constructor(Constructor<cv::NAryMatIterator, const cv::Mat**, cv::Mat*, int>()).
    define_method<void(cv::NAryMatIterator::*)(const cv::Mat**, cv::Mat*, unsigned char**, int)>("init", &cv::NAryMatIterator::init).
  ...
  Class rb_cCvMatOp = define_class_under<cv::MatOp>(rb_mCv, "MatOp").
    ...
    define_method<void(cv::MatOp::*)(const cv::MatExpr&, const cv::Scalar_<double>&, cv::MatExpr&) const>("add", &cv::MatOp::add).
    define_method<void(cv::MatOp::*)(const cv::MatExpr&, const cv::MatExpr&, cv::MatExpr&) const>("subtract", &cv::MatOp::subtract).
    define_method<void(cv::MatOp::*)(const cv::Scalar_<double>&, const cv::MatExpr&, cv::MatExpr&) const>("subtract", &cv::MatOp::subtract).
    ...
    define_method<cv::Size_<int>(cv::MatOp::*)(const cv::MatExpr&) const>("size", &cv::MatOp::size).
  ...
  Class rb_cCvMatExpr = define_class_under<cv::MatExpr>(rb_mCv, "MatExpr").
    ...
    define_constructor(Constructor<cv::MatExpr, const cv::MatOp*, int, const cv::Mat&, const cv::Mat&, const cv::Mat&, double, double, const cv::Scalar_<double>&>()).
    define_method<cv::Size_<int>(cv::MatExpr::*)() const>("size", &cv::MatExpr::size).
    ...
    define_method<cv::MatExpr(cv::MatExpr::*)(const cv::Rect_<int>&) const>("()", &cv::MatExpr::operator()).
  ...
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat&, const cv::Mat&)>("+", &cv::operator+);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat&, const cv::Scalar_<double>&)>("+", &cv::operator+);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Scalar_<double>&, const cv::Mat&)>("+", &cv::operator+);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::MatExpr&, const cv::Mat&)>("+", &cv::operator+);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat&, const cv::MatExpr&)>("+", &cv::operator+);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::MatExpr&, const cv::Scalar_<double>&)>("+", &cv::operator+);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Scalar_<double>&, const cv::MatExpr&)>("+", &cv::operator+);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::MatExpr&, const cv::MatExpr&)>("+", &cv::operator+);
  ...
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat&)>("-", &cv::operator-);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::MatExpr&)>("-", &cv::operator-);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat&, const cv::Mat&)>("*", &cv::operator*);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat&, double)>("*", &cv::operator*);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(double, const cv::Mat&)>("*", &cv::operator*);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::MatExpr&, const cv::Mat&)>("*", &cv::operator*);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::Mat&, const cv::MatExpr&)>("*", &cv::operator*);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(const cv::MatExpr&, double)>("*", &cv::operator*);
  
  rb_mCv.define_module_function<cv::MatExpr(*)(double, const cv::MatExpr&)>("*", &cv::operator*);
