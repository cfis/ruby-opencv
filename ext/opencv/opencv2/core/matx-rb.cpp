...
inline void Matx_builder(Data_Type_T& klass)
{
  klass.define_constant("Rows", (int)cv::Matx<_Tp, m, n>::rows).
    ...
    if constexpr (m * n == 1)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp>(),
        Arg("v0"));
    }

    if constexpr (m * n == 2)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"));
    }

    if constexpr (m * n == 3)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"));
    }

    if constexpr (m * n == 4)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
    }

    if constexpr (m * n == 5)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"));
    }

    if constexpr (m * n == 6)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"));
    }

    if constexpr (m * n == 7)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"));
    }

    if constexpr (m * n == 8)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));
    }

    if constexpr (m * n == 9)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"));
    }

    if constexpr (m * n == 10)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"));
    }

    if constexpr (m * n == 12)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"));
    }

    if constexpr (m * n == 14)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"));
    }

    if constexpr (m * n == 16)
    {
      klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
        Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"), Arg("v14"), Arg("v15"));
    }

    klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>, const _Tp*>(),
        Arg("vals")).
    ...
    klass.include_module(rb_mEnumerable).
      define_method("each", [](VALUE self) -> VALUE
      {
        ...
        {
          cv::Matx::Matx<_Tp, m, n>* matx = detail::From_Ruby<cv::Matx::Matx<_Tp, m, n>*>().convert(self);

          // The iterator returns references and we do NOT want to create a copy
    ...
    klass.define_method("+=", [](cv::Matx<_Tp, m, n>& self, const cv::Matx<_Tp, m, n>& other) -> cv::Matx<_Tp, m, n>&
    {
      return self += other;
    }).
    define_method("-=", [](cv::Matx<_Tp, m, n>& self, const cv::Matx<_Tp, m, n>& other) -> cv::Matx<_Tp, m, n>&
    {
      return self -= other;
    }).
    ...
    define_method("*=", [](cv::Matx<_Tp, m, n>& self, int alpha) -> cv::Matx<_Tp, m, n>&
    {
      return self *= alpha;
    }).
    define_method("*=", [](cv::Matx<_Tp, m, n>& self, float alpha) -> cv::Matx<_Tp, m, n>&
    {
      return self *= alpha;
    }).
    define_method("*=", [](cv::Matx<_Tp, m, n>& self, double alpha) -> cv::Matx<_Tp, m, n>&
    {
      return self *= alpha;
    }).
...
inline void Vec_builder(Data_Type_T& klass)
{
  ...
  if constexpr (cn == 1)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp>(),
      Arg("v0"));
  }

  if constexpr (cn == 2)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"));
  }

  if constexpr (cn == 3)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"));
  }

  if constexpr (cn == 4)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"));
  }

  if constexpr (cn == 5)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"));
  }

  if constexpr (cn == 6)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"));
  }

  if constexpr (cn == 7)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"));
  }

  if constexpr (cn == 8)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"));
  }

  if constexpr (cn == 9)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"));
  }

  if constexpr (cn == 10)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"));
  }

  if constexpr (cn == 14)
  {
    klass.define_constructor(Constructor<cv::Vec::Vec<_Tp, cn>, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp, _Tp>(),
      Arg("v0"), Arg("v1"), Arg("v2"), Arg("v3"), Arg("v4"), Arg("v5"), Arg("v6"), Arg("v7"), Arg("v8"), Arg("v9"), Arg("v10"), Arg("v11"), Arg("v12"), Arg("v13"));
  }
