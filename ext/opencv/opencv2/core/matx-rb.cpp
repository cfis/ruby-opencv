...
inline void Matx_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cv::Matx::Matx<_Tp, m, n>>()).
    ...
    template define_singleton_function<cv::Matx<_Tp, m, n>(*)(const cv::Matx<_Tp, m, n>::diag_type&)>("diag", &cv::Matx<_Tp, m, n>::diag,
      Arg("d")).
...
void Init_Matx()
{
  ...
  Class rb_cVec2b = define_class_under<cv::Vec<unsigned char, 2>>(rb_mCv, "Vec2b").
    define(&Vec_builder<Data_Type<cv::Vec<unsigned char, 2>>, unsigned char, 2>);
  
  Class rb_cVec3b = define_class_under<cv::Vec<unsigned char, 3>>(rb_mCv, "Vec3b").
    define(&Vec_builder<Data_Type<cv::Vec<unsigned char, 3>>, unsigned char, 3>);
  
  Class rb_cVec4b = define_class_under<cv::Vec<unsigned char, 4>>(rb_mCv, "Vec4b").
    define(&Vec_builder<Data_Type<cv::Vec<unsigned char, 4>>, unsigned char, 4>);
  
  Class rb_cVec2s = define_class_under<cv::Vec<short, 2>>(rb_mCv, "Vec2s").
    define(&Vec_builder<Data_Type<cv::Vec<short, 2>>, short, 2>);
  
  Class rb_cVec3s = define_class_under<cv::Vec<short, 3>>(rb_mCv, "Vec3s").
    define(&Vec_builder<Data_Type<cv::Vec<short, 3>>, short, 3>);
  
  Class rb_cVec4s = define_class_under<cv::Vec<short, 4>>(rb_mCv, "Vec4s").
    define(&Vec_builder<Data_Type<cv::Vec<short, 4>>, short, 4>);
  
  Class rb_cVec2w = define_class_under<cv::Vec<unsigned short, 2>>(rb_mCv, "Vec2w").
    define(&Vec_builder<Data_Type<cv::Vec<unsigned short, 2>>, unsigned short, 2>);
  
  Class rb_cVec3w = define_class_under<cv::Vec<unsigned short, 3>>(rb_mCv, "Vec3w").
    define(&Vec_builder<Data_Type<cv::Vec<unsigned short, 3>>, unsigned short, 3>);
  
  Class rb_cVec4w = define_class_under<cv::Vec<unsigned short, 4>>(rb_mCv, "Vec4w").
    define(&Vec_builder<Data_Type<cv::Vec<unsigned short, 4>>, unsigned short, 4>);
  
  Class rb_cVec2i = define_class_under<cv::Vec<int, 2>>(rb_mCv, "Vec2i").
    define(&Vec_builder<Data_Type<cv::Vec<int, 2>>, int, 2>);
  
  Class rb_cVec3i = define_class_under<cv::Vec<int, 3>>(rb_mCv, "Vec3i").
    define(&Vec_builder<Data_Type<cv::Vec<int, 3>>, int, 3>);
  
  Class rb_cVec4i = define_class_under<cv::Vec<int, 4>>(rb_mCv, "Vec4i").
    define(&Vec_builder<Data_Type<cv::Vec<int, 4>>, int, 4>);
  
  Class rb_cVec6i = define_class_under<cv::Vec<int, 6>>(rb_mCv, "Vec6i").
    define(&Vec_builder<Data_Type<cv::Vec<int, 6>>, int, 6>);
  
  Class rb_cVec8i = define_class_under<cv::Vec<int, 8>>(rb_mCv, "Vec8i").
    define(&Vec_builder<Data_Type<cv::Vec<int, 8>>, int, 8>);
  
  Class rb_cVec2f = define_class_under<cv::Vec<float, 2>>(rb_mCv, "Vec2f").
    define(&Vec_builder<Data_Type<cv::Vec<float, 2>>, float, 2>);
  
  Class rb_cVec3f = define_class_under<cv::Vec<float, 3>>(rb_mCv, "Vec3f").
    define(&Vec_builder<Data_Type<cv::Vec<float, 3>>, float, 3>);
  
  Class rb_cVec4f = define_class_under<cv::Vec<float, 4>>(rb_mCv, "Vec4f").
    define(&Vec_builder<Data_Type<cv::Vec<float, 4>>, float, 4>);
  
  Class rb_cVec6f = define_class_under<cv::Vec<float, 6>>(rb_mCv, "Vec6f").
    define(&Vec_builder<Data_Type<cv::Vec<float, 6>>, float, 6>);
  
  Class rb_cVec2d = define_class_under<cv::Vec<double, 2>>(rb_mCv, "Vec2d").
    define(&Vec_builder<Data_Type<cv::Vec<double, 2>>, double, 2>);
  
  Class rb_cVec3d = define_class_under<cv::Vec<double, 3>>(rb_mCv, "Vec3d").
    define(&Vec_builder<Data_Type<cv::Vec<double, 3>>, double, 3>);
  
  Class rb_cVec4d = define_class_under<cv::Vec<double, 4>>(rb_mCv, "Vec4d").
    define(&Vec_builder<Data_Type<cv::Vec<double, 4>>, double, 4>);
  
  Class rb_cVec6d = define_class_under<cv::Vec<double, 6>>(rb_mCv, "Vec6d").
  ...
  Class rb_cVec2l = define_class_under<cv::Vec<long long, 2>>(rb_mCv, "Vec2l").
    define(&Vec_builder<Data_Type<cv::Vec<long long, 2>>, long long, 2>);
}