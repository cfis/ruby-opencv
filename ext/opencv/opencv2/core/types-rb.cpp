...
void Init_Types()
{
  ...
  Class rb_cPoint = define_class_under<cv::Point_<int>>(rb_mCv, "Point").
  ...
  Class rb_cSize = define_class_under<cv::Size_<int>>(rb_mCv, "Size").
  ...
  Class rb_cRect = define_class_under<cv::Rect_<int>>(rb_mCv, "Rect").
  ...
  Class rb_cCvTermCriteria = define_class_under<cv::TermCriteria>(rb_mCv, "TermCriteria").
    ...
    define_method("is_valid?", &cv::TermCriteria::isValid).
