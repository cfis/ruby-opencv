...
inline void Point__builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cv::Point_::Point_<_Tp>>()).
    ...
    define_method("*=", [](cv::Point_<_Tp>& self, float value) -> cv::Point_<_Tp>&
    {
      return self *= value;
    }).
    define_method("*=", [](cv::Point_<_Tp>& self, double value) -> cv::Point_<_Tp>&
    {
      return self *= value;
    }).
    ...
    define_method("/=", [](cv::Point_<_Tp>& self, int value) -> cv::Point_<_Tp>&
    {
      return self /= value;
    }).
    define_method("/=", [](cv::Point_<_Tp>& self, float value) -> cv::Point_<_Tp>&
    ...
    define_method("+=", [](cv::Point_<_Tp>& self, const cv::Point_<_Tp>& other) -> cv::Point_<_Tp>&
    {
      return self += other;
    }).
...
inline void Point3__builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cv::Point3_::Point3_<_Tp>>()).
    ...
    define_method("*=", [](cv::Point3_<_Tp>& self, float value) -> cv::Point3_<_Tp>&
    {
      return self *= value;
    }).
    define_method("*=", [](cv::Point3_<_Tp>& self, double value) -> cv::Point3_<_Tp>&
    {
      return self *= value;
    }).
    ...
    define_method("/=", [](cv::Point3_<_Tp>& self, int value) -> cv::Point3_<_Tp>&
    {
      return self /= value;
    }).
    define_method("/=", [](cv::Point3_<_Tp>& self, float value) -> cv::Point3_<_Tp>&
    ...
    define_method("+=", [](cv::Point3_<_Tp>& self, const cv::Point3_<_Tp>& other) -> cv::Point3_<_Tp>&
    {
      return self += other;
    }).
...
inline void Size__builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cv::Size_::Size_<_Tp>>()).
    ...
    define_method("*=", [](cv::Size_<_Tp>& self, _Tp value) -> cv::Size_<_Tp>&
    {
      return self *= value;
    }).
    ...
    define_method("+=", [](cv::Size_<_Tp>& self, const cv::Size_<_Tp>& other) -> cv::Size_<_Tp>&
    {
      return self += other;
    }).
...
inline void Rect__builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cv::Rect_::Rect_<_Tp>>()).
    ...
    define_method("contains?", &cv::Rect_<_Tp>::contains,
      Arg("pt")).
