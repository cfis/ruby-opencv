...
void Init_Directx()
{
  ...
  rb_mCvDirectx.define_module_function("convert_to_d3_d11_texture2_d", &cv::directx::convertToD3D11Texture2D,
    Arg("src"), Arg("p_d3_d11_texture2_d"));
  
  rb_mCvDirectx.define_module_function("convert_from_d3_d11_texture2_d", &cv::directx::convertFromD3D11Texture2D,
    Arg("p_d3_d11_texture2_d"), Arg("dst"));
  
  rb_mCvDirectx.define_module_function("convert_to_d3_d10_texture2_d", &cv::directx::convertToD3D10Texture2D,
    Arg("src"), Arg("p_d3_d10_texture2_d"));
  
  rb_mCvDirectx.define_module_function("convert_from_d3_d10_texture2_d", &cv::directx::convertFromD3D10Texture2D,
