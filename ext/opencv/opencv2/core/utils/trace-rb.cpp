...
void Init_Trace()
{
  ...
  Class rb_cCvUtilsTraceDetailsRegion = define_class_under<cv::utils::trace::details::Region>(rb_mCvUtilsTraceDetails, "Region").
    ...
    define_method<bool(cv::utils::trace::details::Region::*)() const>("is_active", &cv::utils::trace::details::Region::isActive).
    define_method<void(cv::utils::trace::details::Region::*)()>("destroy", &cv::utils::trace::details::Region::destroy).
    define_constructor(Constructor<cv::utils::trace::details::Region, const cv::utils::trace::details::Region&>());
  
  
  
  Class rb_cCvUtilsTraceDetailsRegionLocationStaticStorage = define_class_under<cv::utils::trace::details::Region::LocationStaticStorage>(rb_cCvUtilsTraceDetailsRegion, "LocationStaticStorage").
  ...
  Enum<cv::utils::trace::details::RegionLocationFlag> rb_cCvUtilsTraceDetailsRegionLocationFlag = define_enum<cv::utils::trace::details::RegionLocationFlag>("RegionLocationFlag", rb_mCvUtilsTraceDetails).
  ...
  Class rb_cCvUtilsTraceDetailsTraceArg = define_class_under<cv::utils::trace::details::TraceArg>(rb_mCvUtilsTraceDetails, "TraceArg").
  ...
  rb_mCvUtilsTraceDetails.define_module_function<void(*)(const cv::utils::trace::details::TraceArg&, long long)>("trace_arg", &cv::utils::trace::details::traceArg);
