...
void Init_Ocl()
{
  ...
  Class rb_cCvOclDevice = define_class_under<cv::ocl::Device>(rb_mCvOcl, "Device").
    ...
    define_method("is_amd?", &cv::ocl::Device::isAMD).
    define_method("is_intel?", &cv::ocl::Device::isIntel).
    define_method("is_n_vidia?", &cv::ocl::Device::isNVidia).
  ...
  Class rb_cCvOclContext = define_class_under<cv::ocl::Context>(rb_mCvOcl, "Context").
    ...
    define_method("set_user_context", &cv::ocl::Context::setUserContext,
