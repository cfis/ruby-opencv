...
void Init_Softfloat()
{
  ...
  Class rb_cCvSoftfloat = define_class_under<cv::softfloat>(rb_mCv, "Softfloat").
    ...
    define_method("<=", &cv::softfloat::operator<=,
      Arg("")).
    define_method("is_na_n?", &cv::softfloat::isNaN).
    define_method("is_inf?", &cv::softfloat::isInf).
    define_method("is_subnormal?", &cv::softfloat::isSubnormal).
  ...
  Class rb_cCvSoftdouble = define_class_under<cv::softdouble>(rb_mCv, "Softdouble").
    ...
    define_method("<=", &cv::softdouble::operator<=,
      Arg("")).
    define_method("is_na_n?", &cv::softdouble::isNaN).
    define_method("is_inf?", &cv::softdouble::isInf).
    define_method("is_subnormal?", &cv::softdouble::isSubnormal).
  ...
  define_global_function("cv_trunc", &cvTrunc,
    Arg("a"));
