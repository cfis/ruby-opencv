...
void Init_Videoio()
{
  ...
  Enum<cv::VideoCaptureAPIs> rb_cCvVideoCaptureAPIs = define_enum<cv::VideoCaptureAPIs>("VideoCaptureAPIs", rb_mCv).
  ...
  Enum<cv::VideoCaptureProperties> rb_cCvVideoCaptureProperties = define_enum<cv::VideoCaptureProperties>("VideoCaptureProperties", rb_mCv).
  ...
  Enum<cv::VideoWriterProperties> rb_cCvVideoWriterProperties = define_enum<cv::VideoWriterProperties>("VideoWriterProperties", rb_mCv).
  ...
  Enum<cv::VideoAccelerationType> rb_cCvVideoAccelerationType = define_enum<cv::VideoAccelerationType>("VideoAccelerationType", rb_mCv).
  ...
  Enum<cv::VideoCaptureOBSensorDataType> rb_cCvVideoCaptureOBSensorDataType = define_enum<cv::VideoCaptureOBSensorDataType>("VideoCaptureOBSensorDataType", rb_mCv).
  ...
  Enum<cv::VideoCaptureOBSensorGenerators> rb_cCvVideoCaptureOBSensorGenerators = define_enum<cv::VideoCaptureOBSensorGenerators>("VideoCaptureOBSensorGenerators", rb_mCv).
  ...
  Enum<cv::VideoCaptureOBSensorProperties> rb_cCvVideoCaptureOBSensorProperties = define_enum<cv::VideoCaptureOBSensorProperties>("VideoCaptureOBSensorProperties", rb_mCv).
  ...
  Class rb_cCvVideoCapture = define_class_under<cv::VideoCapture>(rb_mCv, "VideoCapture").
    ...
    define_constructor(Constructor<cv::VideoCapture, const std::basic_string<char>&, int>()).
    define_constructor(Constructor<cv::VideoCapture, const std::basic_string<char>&, int, const std::vector<int>&>()).
    ...
    define_method<bool(cv::VideoCapture::*)(const std::basic_string<char>&, int)>("open", &cv::VideoCapture::open).
    define_method<bool(cv::VideoCapture::*)(const std::basic_string<char>&, int, const std::vector<int>&)>("open", &cv::VideoCapture::open).
    ...
    define_method<bool(cv::VideoCapture::*)(const cv::_OutputArray &, int)>("retrieve", &cv::VideoCapture::retrieve).
    define_method<cv::VideoCapture&(cv::VideoCapture::*)(cv::Mat&)>("operator>>", &cv::VideoCapture::operator>>).
    define_method<cv::VideoCapture&(cv::VideoCapture::*)(cv::UMat&)>("operator>>", &cv::VideoCapture::operator>>).
    define_method<bool(cv::VideoCapture::*)(const cv::_OutputArray &)>("read", &cv::VideoCapture::read).
    ...
    define_method<std::basic_string<char>(cv::VideoCapture::*)() const>("get_backend_name", &cv::VideoCapture::getBackendName).
    define_method<void(cv::VideoCapture::*)(bool)>("set_exception_mode", &cv::VideoCapture::setExceptionMode).
    define_method<bool(cv::VideoCapture::*)()>("get_exception_mode", &cv::VideoCapture::getExceptionMode).
    define_singleton_function<bool(*)(const std::vector<cv::VideoCapture>&, std::vector<int>&, long long)>("wait_any", &cv::VideoCapture::waitAny);
  ...
  Class rb_cCvVideoWriter = define_class_under<cv::VideoWriter>(rb_mCv, "VideoWriter").
    ...
    define_constructor(Constructor<cv::VideoWriter, const std::basic_string<char>&, int, double, cv::Size_<int>, bool>()).
    define_constructor(Constructor<cv::VideoWriter, const std::basic_string<char>&, int, int, double, cv::Size_<int>, bool>()).
    define_constructor(Constructor<cv::VideoWriter, const std::basic_string<char>&, int, double, const cv::Size_<int>&, const std::vector<int>&>()).
    define_constructor(Constructor<cv::VideoWriter, const std::basic_string<char>&, int, int, double, const cv::Size_<int>&, const std::vector<int>&>()).
    define_method<bool(cv::VideoWriter::*)(const std::basic_string<char>&, int, double, cv::Size_<int>, bool)>("open", &cv::VideoWriter::open).
    define_method<bool(cv::VideoWriter::*)(const std::basic_string<char>&, int, int, double, cv::Size_<int>, bool)>("open", &cv::VideoWriter::open).
    define_method<bool(cv::VideoWriter::*)(const std::basic_string<char>&, int, double, const cv::Size_<int>&, const std::vector<int>&)>("open", &cv::VideoWriter::open).
    define_method<bool(cv::VideoWriter::*)(const std::basic_string<char>&, int, int, double, const cv::Size_<int>&, const std::vector<int>&)>("open", &cv::VideoWriter::open).
    ...
    define_method<cv::VideoWriter&(cv::VideoWriter::*)(const cv::Mat&)>("operator<<", &cv::VideoWriter::operator<<).
    define_method<cv::VideoWriter&(cv::VideoWriter::*)(const cv::UMat&)>("operator<<", &cv::VideoWriter::operator<<).
    define_method<void(cv::VideoWriter::*)(const cv::_InputArray &)>("write", &cv::VideoWriter::write).
    ...
    define_method<std::basic_string<char>(cv::VideoWriter::*)() const>("get_backend_name", &cv::VideoWriter::getBackendName);
  
  Class rb_cCvDefaultDeleterCvCapture = define_class_under<cv::DefaultDeleter<CvCapture>>(rb_mCv, "DefaultDeleterCvCapture").
    define_method<void(cv::DefaultDeleter::*)(CvCapture*) const>("operator()", &cv::DefaultDeleter::operator());
  ...
  Class rb_cCvDefaultDeleterCvVideoWriter = define_class_under<cv::DefaultDeleter<CvVideoWriter>>(rb_mCv, "DefaultDeleterCvVideoWriter").
    define_method<void(cv::DefaultDeleter::*)(CvVideoWriter*) const>("operator()", &cv::DefaultDeleter::operator());
}