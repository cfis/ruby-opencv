...
void Init_Calib3d()
{
  ...
  rb_mCv.define_module_function("rodrigues", &cv::Rodrigues,
    Arg("src"), Arg("dst"), Arg("jacobian") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, int, double, cv::OutputArray, const int, const double)>("find_homography", &cv::findHomography,
    Arg("src_points"), Arg("dst_points"), Arg("method") = static_cast<int>(0), Arg("ransac_reproj_threshold") = static_cast<double>(3), Arg("mask") = static_cast<OutputArray>(noArray()), Arg("max_iters") = static_cast<const int>(2000), Arg("confidence") = static_cast<const double>(0.995));
  ...
  rb_mCv.define_module_function("rq_decomp3x3", &cv::RQDecomp3x3,
    Arg("src"), Arg("mtx_r"), Arg("mtx_q"), Arg("qx") = static_cast<OutputArray>(noArray()), Arg("qy") = static_cast<OutputArray>(noArray()), Arg("qz") = static_cast<OutputArray>(noArray()));
  
  rb_mCv.define_module_function("decompose_projection_matrix", &cv::decomposeProjectionMatrix,
    Arg("proj_matrix"), Arg("camera_matrix"), Arg("rot_matrix"), Arg("trans_vect"), Arg("rot_matrix_x") = static_cast<OutputArray>(noArray()), Arg("rot_matrix_y") = static_cast<OutputArray>(noArray()), Arg("rot_matrix_z") = static_cast<OutputArray>(noArray()), Arg("euler_angles") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function("compose_rt", &cv::composeRT,
    Arg("rvec1"), Arg("tvec1"), Arg("rvec2"), Arg("tvec2"), Arg("rvec3"), Arg("tvec3"), Arg("dr3dr1") = static_cast<OutputArray>(noArray()), Arg("dr3dt1") = static_cast<OutputArray>(noArray()), Arg("dr3dr2") = static_cast<OutputArray>(noArray()), Arg("dr3dt2") = static_cast<OutputArray>(noArray()), Arg("dt3dr1") = static_cast<OutputArray>(noArray()), Arg("dt3dt1") = static_cast<OutputArray>(noArray()), Arg("dt3dr2") = static_cast<OutputArray>(noArray()), Arg("dt3dt2") = static_cast<OutputArray>(noArray()));
  
  rb_mCv.define_module_function("project_points", &cv::projectPoints,
    Arg("object_points"), Arg("rvec"), Arg("tvec"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("image_points"), Arg("jacobian") = static_cast<OutputArray>(noArray()), Arg("aspect_ratio") = static_cast<double>(0));
  
  rb_mCv.define_module_function("solve_pn_p?", &cv::solvePnP,
    Arg("object_points"), Arg("image_points"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvec"), Arg("tvec"), Arg("use_extrinsic_guess") = static_cast<bool>(false), Arg("flags") = static_cast<int>(SOLVEPNP_ITERATIVE));
  ...
  rb_mCv.define_module_function<bool(*)(cv::InputArray, cv::InputArray, cv::InputOutputArray, cv::InputArray, cv::OutputArray, cv::OutputArray, cv::OutputArray, const cv::UsacParams&)>("solve_pn_p_ransac?", &cv::solvePnPRansac,
    Arg("object_points"), Arg("image_points"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvec"), Arg("tvec"), Arg("inliers"), Arg("params") = static_cast<const UsacParams &>(UsacParams()));
  ...
  rb_mCv.define_module_function("solve_pn_p_refine_lm", &cv::solvePnPRefineLM,
    Arg("object_points"), Arg("image_points"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvec"), Arg("tvec"), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::EPS + TermCriteria::COUNT, 20, FLT_EPSILON)));
  
  rb_mCv.define_module_function("solve_pn_p_refine_vvs", &cv::solvePnPRefineVVS,
    Arg("object_points"), Arg("image_points"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvec"), Arg("tvec"), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::EPS + TermCriteria::COUNT, 20, FLT_EPSILON)), Arg("vv_slambda") = static_cast<double>(1));
  
  rb_mCv.define_module_function("solve_pn_p_generic", &cv::solvePnPGeneric,
    Arg("object_points"), Arg("image_points"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvecs"), Arg("tvecs"), Arg("use_extrinsic_guess") = static_cast<bool>(false), Arg("flags") = static_cast<SolvePnPMethod>(SOLVEPNP_ITERATIVE), Arg("rvec") = static_cast<InputArray>(noArray()), Arg("tvec") = static_cast<InputArray>(noArray()), Arg("reprojection_error") = static_cast<OutputArray>(noArray()));
  
  rb_mCv.define_module_function("init_camera_matrix2_d", &cv::initCameraMatrix2D,
  ...
  rb_mCv.define_module_function("find_chessboard_corners?", &cv::findChessboardCorners,
    Arg("image"), Arg("pattern_size"), Arg("corners"), Arg("flags") = static_cast<int>(CALIB_CB_ADAPTIVE_THRESH + CALIB_CB_NORMALIZE_IMAGE));
  ...
  rb_mCv.define_module_function("estimate_chessboard_sharpness", &cv::estimateChessboardSharpness,
    Arg("image"), Arg("pattern_size"), Arg("corners"), Arg("rise_distance") = static_cast<float>(0.8F), Arg("vertical") = static_cast<bool>(false), Arg("sharpness") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<bool(*)(cv::InputArray, cv::Size, cv::OutputArray, int, const cv::Ptr<cv::Feature2D>&)>("find_circles_grid?", &cv::findCirclesGrid,
    Arg("image"), Arg("pattern_size"), Arg("centers"), Arg("flags") = static_cast<int>(CALIB_CB_SYMMETRIC_GRID), Arg("blob_detector") = static_cast<const Ptr<FeatureDetector> &>(SimpleBlobDetector::create()));
  ...
  rb_mCv.define_module_function<double(*)(cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::Size, cv::InputOutputArray, cv::InputOutputArray, cv::OutputArrayOfArrays, cv::OutputArrayOfArrays, cv::OutputArray, cv::OutputArray, cv::OutputArray, int, cv::TermCriteria)>("calibrate_camera", &cv::calibrateCamera,
    Arg("object_points"), Arg("image_points"), Arg("image_size"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvecs"), Arg("tvecs"), Arg("std_deviations_intrinsics"), Arg("std_deviations_extrinsics"), Arg("per_view_errors"), Arg("flags") = static_cast<int>(0), Arg("criteria") = static_cast<TermCriteria>(TermCriteria());
  ...
  rb_mCv.define_module_function<double(*)(cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::Size, cv::InputOutputArray, cv::InputOutputArray, cv::OutputArrayOfArrays, cv::OutputArrayOfArrays, int, cv::TermCriteria)>("calibrate_camera", &cv::calibrateCamera,
    Arg("object_points"), Arg("image_points"), Arg("image_size"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvecs"), Arg("tvecs"), Arg("flags") = static_cast<int>(0), Arg("criteria") = static_cast<TermCriteria>(TermCriteria());
  ...
  rb_mCv.define_module_function<double(*)(cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::Size, int, cv::InputOutputArray, cv::InputOutputArray, cv::OutputArrayOfArrays, cv::OutputArrayOfArrays, cv::OutputArray, int, cv::TermCriteria)>("calibrate_camera_ro", &cv::calibrateCameraRO,
    Arg("object_points"), Arg("image_points"), Arg("image_size"), Arg("i_fixed_point"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvecs"), Arg("tvecs"), Arg("new_obj_points"), Arg("flags") = static_cast<int>(0), Arg("criteria") = static_cast<TermCriteria>(TermCriteria());
  ...
  rb_mCv.define_module_function<double(*)(cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::InputOutputArray, cv::InputOutputArray, cv::InputOutputArray, cv::InputOutputArray, cv::Size, cv::OutputArray, cv::OutputArray, cv::OutputArray, cv::OutputArray, int, cv::TermCriteria)>("stereo_calibrate", &cv::stereoCalibrate,
    Arg("object_points"), Arg("image_points1"), Arg("image_points2"), Arg("camera_matrix1"), Arg("dist_coeffs1"), Arg("camera_matrix2"), Arg("dist_coeffs2"), Arg("image_size"), Arg("r"), Arg("t"), Arg("e"), Arg("f"), Arg("flags") = static_cast<int>(CALIB_FIX_INTRINSIC), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::COUNT+TermCriteria::EPS, 30, 1e-6)));
  ...
  rb_mCv.define_module_function("stereo_rectify", &cv::stereoRectify,
    Arg("camera_matrix1"), Arg("dist_coeffs1"), Arg("camera_matrix2"), Arg("dist_coeffs2"), Arg("image_size"), Arg("r"), Arg("t"), Arg("r1"), Arg("r2"), Arg("p1"), Arg("p2"), Arg("q"), Arg("flags") = static_cast<int>(CALIB_ZERO_DISPARITY), Arg("alpha") = static_cast<double>(-1), Arg("new_image_size") = static_cast<Size>(Size()), Arg("valid_pix_roi1") = static_cast<Rect *>(0), Arg("valid_pix_roi2") = static_cast<Rect *>(0));
  ...
  rb_mCv.define_module_function("get_optimal_new_camera_matrix", &cv::getOptimalNewCameraMatrix,
    Arg("camera_matrix"), Arg("dist_coeffs"), Arg("image_size"), Arg("alpha"), Arg("new_img_size") = static_cast<Size>(Size()), Arg("valid_pix_roi") = static_cast<Rect *>(0), Arg("center_principal_point") = static_cast<bool>(false));
  
  rb_mCv.define_module_function("calibrate_hand_eye", &cv::calibrateHandEye,
    Arg("r_gripper2base"), Arg("t_gripper2base"), Arg("r_target2cam"), Arg("t_target2cam"), Arg("r_cam2gripper"), Arg("t_cam2gripper"), Arg("method") = static_cast<HandEyeCalibrationMethod>(CALIB_HAND_EYE_TSAI));
  
  rb_mCv.define_module_function("calibrate_robot_world_hand_eye", &cv::calibrateRobotWorldHandEye,
    Arg("r_world2cam"), Arg("t_world2cam"), Arg("r_base2gripper"), Arg("t_base2gripper"), Arg("r_base2world"), Arg("t_base2world"), Arg("r_gripper2cam"), Arg("t_gripper2cam"), Arg("method") = static_cast<RobotWorldHandEyeCalibrationMethod>(CALIB_ROBOT_WORLD_HAND_EYE_SHAH));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, int, double, double, int, cv::OutputArray)>("find_fundamental_mat", &cv::findFundamentalMat,
    Arg("points1"), Arg("points2"), Arg("method"), Arg("ransac_reproj_threshold"), Arg("confidence"), Arg("max_iters"), Arg("mask") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, int, double, double, cv::OutputArray)>("find_fundamental_mat", &cv::findFundamentalMat,
    Arg("points1"), Arg("points2"), Arg("method") = static_cast<int>(FM_RANSAC), Arg("ransac_reproj_threshold") = static_cast<double>(3.), Arg("confidence") = static_cast<double>(0.99), Arg("mask") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, cv::OutputArray, int, double, double)>("find_fundamental_mat", &cv::findFundamentalMat,
    Arg("points1"), Arg("points2"), Arg("mask"), Arg("method") = static_cast<int>(FM_RANSAC), Arg("ransac_reproj_threshold") = static_cast<double>(3.), Arg("confidence") = static_cast<double>(0.99));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, cv::InputArray, int, double, double, int, cv::OutputArray)>("find_essential_mat", &cv::findEssentialMat,
    Arg("points1"), Arg("points2"), Arg("camera_matrix"), Arg("method") = static_cast<int>(RANSAC), Arg("prob") = static_cast<double>(0.999), Arg("threshold") = static_cast<double>(1.0), Arg("max_iters") = static_cast<int>(1000), Arg("mask") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, double, cv::Point2d, int, double, double, int, cv::OutputArray)>("find_essential_mat", &cv::findEssentialMat,
    Arg("points1"), Arg("points2"), Arg("focal") = static_cast<double>(1.0), Arg("pp") = static_cast<Point2d>(Point2d(0, 0)), Arg("method") = static_cast<int>(RANSAC), Arg("prob") = static_cast<double>(0.999), Arg("threshold") = static_cast<double>(1.0), Arg("max_iters") = static_cast<int>(1000), Arg("mask") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, int, double, double, cv::OutputArray)>("find_essential_mat", &cv::findEssentialMat,
    Arg("points1"), Arg("points2"), Arg("camera_matrix1"), Arg("dist_coeffs1"), Arg("camera_matrix2"), Arg("dist_coeffs2"), Arg("method") = static_cast<int>(RANSAC), Arg("prob") = static_cast<double>(0.999), Arg("threshold") = static_cast<double>(1.0), Arg("mask") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<int(*)(cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::OutputArray, cv::OutputArray, cv::OutputArray, int, double, double, cv::InputOutputArray)>("recover_pose", &cv::recoverPose,
    Arg("points1"), Arg("points2"), Arg("camera_matrix1"), Arg("dist_coeffs1"), Arg("camera_matrix2"), Arg("dist_coeffs2"), Arg("e"), Arg("r"), Arg("t"), Arg("method") = static_cast<int>(cv::RANSAC), Arg("prob") = static_cast<double>(0.999), Arg("threshold") = static_cast<double>(1.0), Arg("mask") = static_cast<InputOutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<int(*)(cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::OutputArray, cv::OutputArray, cv::InputOutputArray)>("recover_pose", &cv::recoverPose,
    Arg("e"), Arg("points1"), Arg("points2"), Arg("camera_matrix"), Arg("r"), Arg("t"), Arg("mask") = static_cast<InputOutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<int(*)(cv::InputArray, cv::InputArray, cv::InputArray, cv::OutputArray, cv::OutputArray, double, cv::Point2d, cv::InputOutputArray)>("recover_pose", &cv::recoverPose,
    Arg("e"), Arg("points1"), Arg("points2"), Arg("r"), Arg("t"), Arg("focal") = static_cast<double>(1.0), Arg("pp") = static_cast<Point2d>(Point2d(0, 0)), Arg("mask") = static_cast<InputOutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<int(*)(cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::OutputArray, cv::OutputArray, double, cv::InputOutputArray, cv::OutputArray)>("recover_pose", &cv::recoverPose,
    Arg("e"), Arg("points1"), Arg("points2"), Arg("camera_matrix"), Arg("r"), Arg("t"), Arg("distance_thresh"), Arg("mask") = static_cast<InputOutputArray>(noArray()), Arg("triangulated_points") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function("filter_speckles", &cv::filterSpeckles,
    Arg("img"), Arg("new_val"), Arg("max_speckle_size"), Arg("max_diff"), Arg("buf") = static_cast<InputOutputArray>(noArray()));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, cv::OutputArray, int, double, ::size_t, double, ::size_t)>("estimate_affine2_d", &cv::estimateAffine2D,
    Arg("from"), Arg("to"), Arg("inliers") = static_cast<OutputArray>(noArray()), Arg("method") = static_cast<int>(RANSAC), Arg("ransac_reproj_threshold") = static_cast<double>(3), Arg("max_iters") = static_cast<size_t>(2000), Arg("confidence") = static_cast<double>(0.99), Arg("refine_iters") = static_cast<size_t>(10));
  ...
  rb_mCv.define_module_function("estimate_affine_partial2_d", &cv::estimateAffinePartial2D,
    Arg("from"), Arg("to"), Arg("inliers") = static_cast<OutputArray>(noArray()), Arg("method") = static_cast<int>(RANSAC), Arg("ransac_reproj_threshold") = static_cast<double>(3), Arg("max_iters") = static_cast<size_t>(2000), Arg("confidence") = static_cast<double>(0.99), Arg("refine_iters") = static_cast<size_t>(10));
  ...
  rb_mCv.define_module_function("filter_homography_decomp_by_visible_refpoints", &cv::filterHomographyDecompByVisibleRefpoints,
    Arg("rotations"), Arg("normals"), Arg("before_points"), Arg("after_points"), Arg("possible_solutions"), Arg("points_mask") = static_cast<InputArray>(noArray()));
  ...
  rb_mCv.define_module_function("undistort", &cv::undistort,
    Arg("src"), Arg("dst"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("new_camera_matrix") = static_cast<InputArray>(noArray()));
  ...
  rb_mCv.define_module_function<float(*)(cv::InputArray, cv::InputArray, cv::Size, int, int, cv::OutputArray, cv::OutputArray, cv::UndistortTypes, double)>("init_wide_angle_proj_map", &cv::initWideAngleProjMap,
    Arg("camera_matrix"), Arg("dist_coeffs"), Arg("image_size"), Arg("dest_image_width"), Arg("m1type"), Arg("map1"), Arg("map2"), Arg("proj_type") = static_cast<enum UndistortTypes>(PROJ_SPHERICAL_EQRECT), Arg("alpha") = static_cast<double>(0));
  ...
  rb_mCv.define_module_function("get_default_new_camera_matrix", &cv::getDefaultNewCameraMatrix,
    Arg("camera_matrix"), Arg("imgsize") = static_cast<Size>(Size()), Arg("center_principal_point") = static_cast<bool>(false));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, cv::OutputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray)>("undistort_points", &cv::undistortPoints,
    Arg("src"), Arg("dst"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("r") = static_cast<InputArray>(noArray()), Arg("p") = static_cast<InputArray>(noArray()));
  ...
  rb_mCv.define_module_function("undistort_image_points", &cv::undistortImagePoints,
    Arg("src"), Arg("dst"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("") = static_cast<TermCriteria>(TermCriteria(TermCriteria::MAX_ITER + TermCriteria::EPS, 5,));
  ...
  rb_mCvFisheye.define_module_function<void(*)(cv::InputArray, cv::OutputArray, const cv::Affine3d&, cv::InputArray, cv::InputArray, double, cv::OutputArray)>("project_points", &cv::fisheye::projectPoints,
    Arg("object_points"), Arg("image_points"), Arg("affine"), Arg("k"), Arg("d"), Arg("alpha") = static_cast<double>(0), Arg("jacobian") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCvFisheye.define_module_function<void(*)(cv::InputArray, cv::OutputArray, cv::InputArray, cv::InputArray, cv::InputArray, cv::InputArray, double, cv::OutputArray)>("project_points", &cv::fisheye::projectPoints,
    Arg("object_points"), Arg("image_points"), Arg("rvec"), Arg("tvec"), Arg("k"), Arg("d"), Arg("alpha") = static_cast<double>(0), Arg("jacobian") = static_cast<OutputArray>(noArray()));
  
  rb_mCvFisheye.define_module_function("distort_points", &cv::fisheye::distortPoints,
  ...
  rb_mCvFisheye.define_module_function("undistort_points", &cv::fisheye::undistortPoints,
    Arg("distorted"), Arg("undistorted"), Arg("k"), Arg("d"), Arg("r") = static_cast<InputArray>(noArray()), Arg("p") = static_cast<InputArray>(noArray()), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::MAX_ITER + TermCriteria::EPS, 10, 1e-8)));
  ...
  rb_mCvFisheye.define_module_function("undistort_image", &cv::fisheye::undistortImage,
    Arg("distorted"), Arg("undistorted"), Arg("k"), Arg("d"), Arg("knew") = static_cast<InputArray>(cv::noArray()), Arg("new_size") = static_cast<const Size &>(Size()));
  ...
  rb_mCvFisheye.define_module_function("estimate_new_camera_matrix_for_undistort_rectify", &cv::fisheye::estimateNewCameraMatrixForUndistortRectify,
    Arg("k"), Arg("d"), Arg("image_size"), Arg("r"), Arg("p"), Arg("balance") = static_cast<double>(0.0), Arg("new_size") = static_cast<const Size &>(Size()), Arg("fov_scale") = static_cast<double>(1.0));
  
  rb_mCvFisheye.define_module_function("calibrate", &cv::fisheye::calibrate,
    Arg("object_points"), Arg("image_points"), Arg("image_size"), Arg("k"), Arg("d"), Arg("rvecs"), Arg("tvecs"), Arg("flags") = static_cast<int>(0), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 100, DBL_EPSILON)));
  
  rb_mCvFisheye.define_module_function("stereo_rectify", &cv::fisheye::stereoRectify,
    Arg("k1"), Arg("d1"), Arg("k2"), Arg("d2"), Arg("image_size"), Arg("r"), Arg("tvec"), Arg("r1"), Arg("r2"), Arg("p1"), Arg("p2"), Arg("q"), Arg("flags"), Arg("new_image_size") = static_cast<const Size &>(Size()), Arg("balance") = static_cast<double>(0.0), Arg("fov_scale") = static_cast<double>(1.0));
  ...
  rb_mCvFisheye.define_module_function<double(*)(cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::InputOutputArray, cv::InputOutputArray, cv::InputOutputArray, cv::InputOutputArray, cv::Size, cv::OutputArray, cv::OutputArray, cv::OutputArrayOfArrays, cv::OutputArrayOfArrays, int, cv::TermCriteria)>("stereo_calibrate", &cv::fisheye::stereoCalibrate,
    Arg("object_points"), Arg("image_points1"), Arg("image_points2"), Arg("k1"), Arg("d1"), Arg("k2"), Arg("d2"), Arg("image_size"), Arg("r"), Arg("t"), Arg("rvecs"), Arg("tvecs"), Arg("flags") = static_cast<int>(fisheye::CALIB_FIX_INTRINSIC), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 100, DBL_EPSILON)));
  ...
  rb_mCvFisheye.define_module_function<double(*)(cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::InputArrayOfArrays, cv::InputOutputArray, cv::InputOutputArray, cv::InputOutputArray, cv::InputOutputArray, cv::Size, cv::OutputArray, cv::OutputArray, int, cv::TermCriteria)>("stereo_calibrate", &cv::fisheye::stereoCalibrate,
    Arg("object_points"), Arg("image_points1"), Arg("image_points2"), Arg("k1"), Arg("d1"), Arg("k2"), Arg("d2"), Arg("image_size"), Arg("r"), Arg("t"), Arg("flags") = static_cast<int>(fisheye::CALIB_FIX_INTRINSIC), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 100, DBL_EPSILON)));
  
  rb_mCvFisheye.define_module_function("solve_pn_p?", &cv::fisheye::solvePnP,
    Arg("object_points"), Arg("image_points"), Arg("camera_matrix"), Arg("dist_coeffs"), Arg("rvec"), Arg("tvec"), Arg("use_extrinsic_guess") = static_cast<bool>(false), Arg("flags") = static_cast<int>(SOLVEPNP_ITERATIVE), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::MAX_ITER + TermCriteria::EPS, 10, 1e-8)));
