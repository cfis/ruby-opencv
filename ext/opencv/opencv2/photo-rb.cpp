...
void Init_Photo()
{
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, cv::OutputArray, const std::vector<float>&, int, int, int)>("fast_nl_means_denoising", &cv::fastNlMeansDenoising,
    Arg("src"), Arg("dst"), Arg("h"), Arg("template_window_size") = static_cast<int>(7), Arg("search_window_size") = static_cast<int>(21), Arg("norm_type") = static_cast<int>(NORM_L2));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArrayOfArrays, cv::OutputArray, int, int, const std::vector<float>&, int, int, int)>("fast_nl_means_denoising_multi", &cv::fastNlMeansDenoisingMulti,
    Arg("src_imgs"), Arg("dst"), Arg("img_to_denoise_index"), Arg("temporal_window_size"), Arg("h"), Arg("template_window_size") = static_cast<int>(7), Arg("search_window_size") = static_cast<int>(21), Arg("norm_type") = static_cast<int>(NORM_L2));
