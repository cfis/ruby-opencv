...
void Init_Highgui()
{
  ...
  rb_mCv.define_module_function("named_window", &cv::namedWindow,
    Arg("winname"), Arg("flags") = static_cast<int>(WINDOW_AUTOSIZE));
  ...
  rb_mCv.define_module_function("create_trackbar", &cv::createTrackbar,
    Arg("trackbarname"), Arg("winname"), Arg("value"), Arg("count"), Arg("on_change") = static_cast<TrackbarCallback>(0), Arg("userdata") = static_cast<void *>(0));
  ...
  rb_mCv.define_module_function("set_open_gl_draw_callback", &cv::setOpenGlDrawCallback,
    Arg("winname"), Arg("on_open_gl_draw"), Arg("userdata") = static_cast<void *>(0));
  ...
  rb_mCv.define_module_function("font_qt", &cv::fontQt,
    Arg("name_font"), Arg("point_size") = static_cast<int>(-1), Arg("color") = static_cast<Scalar>(Scalar::all(0)), Arg("weight") = static_cast<int>(QT_FONT_NORMAL), Arg("style") = static_cast<int>(QT_STYLE_NORMAL), Arg("spacing") = static_cast<int>(0));
  ...
  rb_mCv.define_module_function<void(*)(const cv::Mat&, const cv::String&, cv::Point, const cv::String&, int, cv::Scalar, int, int, int)>("add_text", &cv::addText,
    Arg("img"), Arg("text"), Arg("org"), Arg("name_font"), Arg("point_size") = static_cast<int>(-1), Arg("color") = static_cast<Scalar>(Scalar::all(0)), Arg("weight") = static_cast<int>(QT_FONT_NORMAL), Arg("style") = static_cast<int>(QT_STYLE_NORMAL), Arg("spacing") = static_cast<int>(0));
  ...
  rb_mCv.define_module_function("create_button", &cv::createButton,
    Arg("bar_name"), Arg("on_change"), Arg("userdata") = static_cast<void *>(0), Arg("type") = static_cast<int>(QT_PUSH_BUTTON), Arg("initial_button_state") = static_cast<bool>(false));
