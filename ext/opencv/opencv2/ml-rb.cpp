...
void Init_Ml()
{
  ...
  Class rb_cCvMlTrainData = define_class_under<cv::ml::TrainData>(rb_mCvMl, "TrainData").
    ...
    define_method("get_train_samples", &cv::ml::TrainData::getTrainSamples,
      Arg("layout") = static_cast<int>(ROW_SAMPLE), Arg("compress_samples") = static_cast<bool>(true), Arg("compress_vars") = static_cast<bool>(true)).
    ...
    define_singleton_function("create", &cv::ml::TrainData::create,
      Arg("samples"), Arg("layout"), Arg("responses"), Arg("var_idx") = static_cast<InputArray>(noArray()), Arg("sample_idx") = static_cast<InputArray>(noArray()), Arg("sample_weights") = static_cast<InputArray>(noArray()), Arg("var_type") = static_cast<InputArray>(noArray()));
  ...
  Class rb_cCvMlStatModel = define_class_under<cv::ml::StatModel, cv::Algorithm>(rb_mCvMl, "StatModel").
    ...
    define_method("is_trained?", &cv::ml::StatModel::isTrained).
    define_method("is_classifier?", &cv::ml::StatModel::isClassifier).
    ...
    define_method("predict", &cv::ml::StatModel::predict,
      Arg("samples"), Arg("results") = static_cast<OutputArray>(noArray()), Arg("flags") = static_cast<int>(0));
  ...
  Class rb_cCvMlKNearest = define_class_under<cv::ml::KNearest, cv::ml::StatModel>(rb_mCvMl, "KNearest").
    ...
    define_method("find_nearest", &cv::ml::KNearest::findNearest,
      Arg("samples"), Arg("k"), Arg("results"), Arg("neighbor_responses") = static_cast<OutputArray>(noArray()), Arg("dist") = static_cast<OutputArray>(noArray())).
  ...
  Class rb_cCvMlSVM = define_class_under<cv::ml::SVM, cv::ml::StatModel>(rb_mCvMl, "SVM").
    ...
    define_method<bool(cv::ml::SVM::*)(const cv::Ptr<cv::ml::TrainData>&, int, cv::ml::ParamGrid, cv::ml::ParamGrid, cv::ml::ParamGrid, cv::ml::ParamGrid, cv::ml::ParamGrid, cv::ml::ParamGrid, bool)>("train_auto?", &cv::ml::SVM::trainAuto,
      Arg("data"), Arg("k_fold") = static_cast<int>(10), Arg("cgrid") = static_cast<ParamGrid>(getDefaultGrid(C)), Arg("gamma_grid") = static_cast<ParamGrid>(getDefaultGrid(GAMMA)), Arg("p_grid") = static_cast<ParamGrid>(getDefaultGrid(P)), Arg("nu_grid") = static_cast<ParamGrid>(getDefaultGrid(NU)), Arg("coeff_grid") = static_cast<ParamGrid>(getDefaultGrid(COEF)), Arg("degree_grid") = static_cast<ParamGrid>(getDefaultGrid(DEGREE)), Arg("balanced") = static_cast<bool>(false)).
    define_method<bool(cv::ml::SVM::*)(cv::InputArray, int, cv::InputArray, int, cv::Ptr<cv::ml::ParamGrid>, cv::Ptr<cv::ml::ParamGrid>, cv::Ptr<cv::ml::ParamGrid>, cv::Ptr<cv::ml::ParamGrid>, cv::Ptr<cv::ml::ParamGrid>, cv::Ptr<cv::ml::ParamGrid>, bool)>("train_auto?", &cv::ml::SVM::trainAuto,
      Arg("samples"), Arg("layout"), Arg("responses"), Arg("k_fold") = static_cast<int>(10), Arg("cgrid") = static_cast<Ptr<ParamGrid>>(SVM::getDefaultGridPtr(SVM::C)), Arg("gamma_grid") = static_cast<Ptr<ParamGrid>>(SVM::getDefaultGridPtr(SVM::GAMMA)), Arg("p_grid") = static_cast<Ptr<ParamGrid>>(SVM::getDefaultGridPtr(SVM::P)), Arg("nu_grid") = static_cast<Ptr<ParamGrid>>(SVM::getDefaultGridPtr(SVM::NU)), Arg("coeff_grid") = static_cast<Ptr<ParamGrid>>(SVM::getDefaultGridPtr(SVM::COEF)), Arg("degree_grid") = static_cast<Ptr<ParamGrid>>(SVM::getDefaultGridPtr(SVM::DEGREE)), Arg("balanced") = static_cast<bool>(false)).
  ...
  Class rb_cCvMlEM = define_class_under<cv::ml::EM, cv::ml::StatModel>(rb_mCvMl, "EM").
    ...
    define_method("train_em?", &cv::ml::EM::trainEM,
      Arg("samples"), Arg("log_likelihoods") = static_cast<OutputArray>(noArray()), Arg("labels") = static_cast<OutputArray>(noArray()), Arg("probs") = static_cast<OutputArray>(noArray())).
    define_method("train_e?", &cv::ml::EM::trainE,
      Arg("samples"), Arg("means0"), Arg("covs0") = static_cast<InputArray>(noArray()), Arg("weights0") = static_cast<InputArray>(noArray()), Arg("log_likelihoods") = static_cast<OutputArray>(noArray()), Arg("labels") = static_cast<OutputArray>(noArray()), Arg("probs") = static_cast<OutputArray>(noArray())).
    define_method("train_m?", &cv::ml::EM::trainM,
      Arg("samples"), Arg("probs0"), Arg("log_likelihoods") = static_cast<OutputArray>(noArray()), Arg("labels") = static_cast<OutputArray>(noArray()), Arg("probs") = static_cast<OutputArray>(noArray())).
  ...
  Class rb_cCvMlSVMSGD = define_class_under<cv::ml::SVMSGD, cv::ml::StatModel>(rb_mCvMl, "SVMSGD").
    ...
    define_method("set_optimal_parameters", &cv::ml::SVMSGD::setOptimalParameters,
      Arg("svmsgd_type") = static_cast<int>(SVMSGD::ASGD), Arg("margin_type") = static_cast<int>(SVMSGD::SOFT_MARGIN)).
