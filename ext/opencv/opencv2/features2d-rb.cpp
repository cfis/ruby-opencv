...
inline void SL2_builder(Data_Type_T& klass)
{
  klass.define_constant("NormType", cv::SL2<T>::normType).
    template define_method("()", &cv::SL2<T>::operator(),
...
inline void L2_builder(Data_Type_T& klass)
{
  klass.define_constant("NormType", cv::L2<T>::normType).
    template define_method("()", &cv::L2<T>::operator(),
      Arg("a"), Arg("b"), Arg("size"));
};
...
inline void L1_builder(Data_Type_T& klass)
{
  klass.define_constant("NormType", cv::L1<T>::normType).
    template define_method("()", &cv::L1<T>::operator(),
      Arg("a"), Arg("b"), Arg("size"));
};
...
void Init_Features2d()
{
  ...
  Class rb_cCvFeature2D = define_class_under<cv::Feature2D, cv::Algorithm>(rb_mCv, "Feature2D").
    ...
    define_method<void(cv::Feature2D::*)(cv::InputArray, std::vector<cv::KeyPoint>&, cv::InputArray)>("detect", &cv::Feature2D::detect,
      Arg("image"), Arg("keypoints"), Arg("mask") = static_cast<InputArray>(noArray())).
    define_method<void(cv::Feature2D::*)(cv::InputArrayOfArrays, std::vector<std::vector<cv::KeyPoint>>&, cv::InputArrayOfArrays)>("detect", &cv::Feature2D::detect,
      Arg("images"), Arg("keypoints"), Arg("masks") = static_cast<InputArrayOfArrays>(noArray())).
  ...
  Class rb_cCvORB = define_class_under<cv::ORB, cv::Feature2D>(rb_mCv, "ORB").
    ...
    define_singleton_function("create", &cv::ORB::create,
      Arg("nfeatures") = static_cast<int>(500), Arg("scale_factor") = static_cast<float>(1.2f), Arg("nlevels") = static_cast<int>(8), Arg("edge_threshold") = static_cast<int>(31), Arg("first_level") = static_cast<int>(0), Arg("wta_k") = static_cast<int>(2), Arg("score_type") = static_cast<ORB::ScoreType>(ORB::HARRIS_SCORE), Arg("patch_size") = static_cast<int>(31), Arg("fast_threshold") = static_cast<int>(20)).
  ...
  Class rb_cCvFastFeatureDetector = define_class_under<cv::FastFeatureDetector, cv::Feature2D>(rb_mCv, "FastFeatureDetector").
    define_singleton_function("create", &cv::FastFeatureDetector::create,
      Arg("threshold") = static_cast<int>(10), Arg("nonmax_suppression") = static_cast<bool>(true), Arg("type") = static_cast<FastFeatureDetector::DetectorType>(FastFeatureDetector::TYPE_9_16)).
  ...
  Class rb_cCvAgastFeatureDetector = define_class_under<cv::AgastFeatureDetector, cv::Feature2D>(rb_mCv, "AgastFeatureDetector").
    define_singleton_function("create", &cv::AgastFeatureDetector::create,
      Arg("threshold") = static_cast<int>(10), Arg("nonmax_suppression") = static_cast<bool>(true), Arg("type") = static_cast<AgastFeatureDetector::DetectorType>(AgastFeatureDetector::OAST_9_16)).
  ...
  Class rb_cCvSimpleBlobDetector = define_class_under<cv::SimpleBlobDetector, cv::Feature2D>(rb_mCv, "SimpleBlobDetector").
    define_singleton_function("create", &cv::SimpleBlobDetector::create,
      Arg("parameters") = static_cast<const SimpleBlobDetector::Params &>(SimpleBlobDetector::Params())).
  ...
  Class rb_cCvKAZE = define_class_under<cv::KAZE, cv::Feature2D>(rb_mCv, "KAZE").
    define_singleton_function("create", &cv::KAZE::create,
      Arg("extended") = static_cast<bool>(false), Arg("upright") = static_cast<bool>(false), Arg("threshold") = static_cast<float>(0.001f), Arg("n_octaves") = static_cast<int>(4), Arg("n_octave_layers") = static_cast<int>(4), Arg("diffusivity") = static_cast<KAZE::DiffusivityType>(KAZE::DIFF_PM_G2)).
  ...
  Class rb_cCvAKAZE = define_class_under<cv::AKAZE, cv::Feature2D>(rb_mCv, "AKAZE").
    define_singleton_function("create", &cv::AKAZE::create,
      Arg("descriptor_type") = static_cast<AKAZE::DescriptorType>(AKAZE::DESCRIPTOR_MLDB), Arg("descriptor_size") = static_cast<int>(0), Arg("descriptor_channels") = static_cast<int>(3), Arg("threshold") = static_cast<float>(0.001f), Arg("n_octaves") = static_cast<int>(4), Arg("n_octave_layers") = static_cast<int>(4), Arg("diffusivity") = static_cast<KAZE::DiffusivityType>(KAZE::DIFF_PM_G2), Arg("max_points") = static_cast<int>(-1)).
  ...
  Class rb_cCvDescriptorMatcher = define_class_under<cv::DescriptorMatcher, cv::Algorithm>(rb_mCv, "DescriptorMatcher").
    ...
    define_method("is_mask_supported?", &cv::DescriptorMatcher::isMaskSupported).
    ...
    define_method<void(cv::DescriptorMatcher::*)(cv::InputArray, cv::InputArray, std::vector<cv::DMatch>&, cv::InputArray) const>("match", &cv::DescriptorMatcher::match,
      Arg("query_descriptors"), Arg("train_descriptors"), Arg("matches"), Arg("mask") = static_cast<InputArray>(noArray())).
    define_method<void(cv::DescriptorMatcher::*)(cv::InputArray, cv::InputArray, std::vector<std::vector<cv::DMatch>>&, int, cv::InputArray, bool) const>("knn_match", &cv::DescriptorMatcher::knnMatch,
      Arg("query_descriptors"), Arg("train_descriptors"), Arg("matches"), Arg("k"), Arg("mask") = static_cast<InputArray>(noArray()), Arg("compact_result") = static_cast<bool>(false)).
    define_method<void(cv::DescriptorMatcher::*)(cv::InputArray, cv::InputArray, std::vector<std::vector<cv::DMatch>>&, float, cv::InputArray, bool) const>("radius_match", &cv::DescriptorMatcher::radiusMatch,
      Arg("query_descriptors"), Arg("train_descriptors"), Arg("matches"), Arg("max_distance"), Arg("mask") = static_cast<InputArray>(noArray()), Arg("compact_result") = static_cast<bool>(false)).
    define_method<void(cv::DescriptorMatcher::*)(cv::InputArray, std::vector<cv::DMatch>&, cv::InputArrayOfArrays)>("match", &cv::DescriptorMatcher::match,
      Arg("query_descriptors"), Arg("matches"), Arg("masks") = static_cast<InputArrayOfArrays>(noArray())).
    define_method<void(cv::DescriptorMatcher::*)(cv::InputArray, std::vector<std::vector<cv::DMatch>>&, int, cv::InputArrayOfArrays, bool)>("knn_match", &cv::DescriptorMatcher::knnMatch,
      Arg("query_descriptors"), Arg("matches"), Arg("k"), Arg("masks") = static_cast<InputArrayOfArrays>(noArray()), Arg("compact_result") = static_cast<bool>(false)).
    define_method<void(cv::DescriptorMatcher::*)(cv::InputArray, std::vector<std::vector<cv::DMatch>>&, float, cv::InputArrayOfArrays, bool)>("radius_match", &cv::DescriptorMatcher::radiusMatch,
      Arg("query_descriptors"), Arg("matches"), Arg("max_distance"), Arg("masks") = static_cast<InputArrayOfArrays>(noArray()), Arg("compact_result") = static_cast<bool>(false)).
  ...
  Class rb_cCvDescriptorMatcherDescriptorCollection = define_class_under<cv::DescriptorMatcher::DescriptorCollection>(rb_cCvDescriptorMatcher, "DescriptorCollection").
    ...
    define_constructor(Constructor<cv::DescriptorMatcher::DescriptorCollection, const cv::DescriptorMatcher::DescriptorCollection&>(),
      Arg("collection")).
    define_method("set", &cv::DescriptorMatcher::DescriptorCollection::set,
      Arg("descriptors")).
    define_method("clear", &cv::DescriptorMatcher::DescriptorCollection::clear).
    define_method("get_descriptors", &cv::DescriptorMatcher::DescriptorCollection::getDescriptors).
    ...
    define_method<cv::Mat(cv::DescriptorMatcher::DescriptorCollection::*)(int) const>("get_descriptor", &cv::DescriptorMatcher::DescriptorCollection::getDescriptor,
      Arg("global_desc_idx")).
    define_method("get_local_idx", &cv::DescriptorMatcher::DescriptorCollection::getLocalIdx,
      Arg("global_desc_idx"), Arg("img_idx"), Arg("local_desc_idx")).
    define_method("size", &cv::DescriptorMatcher::DescriptorCollection::size);
  ...
  Class rb_cCvBFMatcher = define_class_under<cv::BFMatcher, cv::DescriptorMatcher>(rb_mCv, "BFMatcher").
    define_constructor(Constructor<cv::BFMatcher, int, bool>(),
      Arg("norm_type") = static_cast<int>(NORM_L2), Arg("cross_check") = static_cast<bool>(false)).
    define_method("is_mask_supported?", &cv::BFMatcher::isMaskSupported).
  ...
  Class rb_cCvFlannBasedMatcher = define_class_under<cv::FlannBasedMatcher, cv::DescriptorMatcher>(rb_mCv, "FlannBasedMatcher").
    define_constructor(Constructor<cv::FlannBasedMatcher, const cv::Ptr<cv::flann::IndexParams>&, const cv::Ptr<cv::flann::SearchParams>&>(),
      Arg("index_params") = static_cast<const Ptr<flann::IndexParams> &>(makePtr<flann::KDTreeIndexParams>()), Arg("search_params") = static_cast<const Ptr<flann::SearchParams> &>(makePtr<flann::SearchParams>())).
    ...
    define_method("is_mask_supported?", &cv::FlannBasedMatcher::isMaskSupported).
  ...
  rb_mCv.define_module_function("draw_keypoints", &cv::drawKeypoints,
    Arg("image"), Arg("keypoints"), Arg("out_image"), Arg("color") = static_cast<const Scalar &>(Scalar::all(-1)), Arg("flags") = static_cast<DrawMatchesFlags>(DrawMatchesFlags::DEFAULT));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, const std::vector<cv::KeyPoint>&, cv::InputArray, const std::vector<cv::KeyPoint>&, const std::vector<cv::DMatch>&, cv::InputOutputArray, const cv::Scalar&, const cv::Scalar&, const std::vector<char>&, cv::DrawMatchesFlags)>("draw_matches", &cv::drawMatches,
    Arg("img1"), Arg("keypoints1"), Arg("img2"), Arg("keypoints2"), Arg("matches1to2"), Arg("out_img"), Arg("match_color") = static_cast<const Scalar &>(Scalar::all(-1)), Arg("single_point_color") = static_cast<const Scalar &>(Scalar::all(-1)), Arg("matches_mask") = static_cast<const std::vector<char> &>(std::vector<char>()), Arg("flags") = static_cast<DrawMatchesFlags>(DrawMatchesFlags::DEFAULT));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, const std::vector<cv::KeyPoint>&, cv::InputArray, const std::vector<cv::KeyPoint>&, const std::vector<cv::DMatch>&, cv::InputOutputArray, const int, const cv::Scalar&, const cv::Scalar&, const std::vector<char>&, cv::DrawMatchesFlags)>("draw_matches", &cv::drawMatches,
    Arg("img1"), Arg("keypoints1"), Arg("img2"), Arg("keypoints2"), Arg("matches1to2"), Arg("out_img"), Arg("matches_thickness"), Arg("match_color") = static_cast<const Scalar &>(Scalar::all(-1)), Arg("single_point_color") = static_cast<const Scalar &>(Scalar::all(-1)), Arg("matches_mask") = static_cast<const std::vector<char> &>(std::vector<char>()), Arg("flags") = static_cast<DrawMatchesFlags>(DrawMatchesFlags::DEFAULT));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, const std::vector<cv::KeyPoint>&, cv::InputArray, const std::vector<cv::KeyPoint>&, const std::vector<std::vector<cv::DMatch>>&, cv::InputOutputArray, const cv::Scalar&, const cv::Scalar&, const std::vector<std::vector<char>>&, cv::DrawMatchesFlags)>("draw_matches", &cv::drawMatches,
    Arg("img1"), Arg("keypoints1"), Arg("img2"), Arg("keypoints2"), Arg("matches1to2"), Arg("out_img"), Arg("match_color") = static_cast<const Scalar &>(Scalar::all(-1)), Arg("single_point_color") = static_cast<const Scalar &>(Scalar::all(-1)), Arg("matches_mask") = static_cast<const std::vector<std::vector<char>> &>(std::vector<std::vector<char> >()), Arg("flags") = static_cast<DrawMatchesFlags>(DrawMatchesFlags::DEFAULT));
  
  rb_mCv.define_module_function("evaluate_feature_detector", &cv::evaluateFeatureDetector,
    Arg("img1"), Arg("img2"), Arg("h1to2"), Arg("keypoints1"), Arg("keypoints2"), Arg("repeatability"), Arg("corresp_count"), Arg("fdetector") = static_cast<const Ptr<FeatureDetector> &>(Ptr<FeatureDetector>()));
  ...
  Class rb_cCvBOWKMeansTrainer = define_class_under<cv::BOWKMeansTrainer, cv::BOWTrainer>(rb_mCv, "BOWKMeansTrainer").
    define_constructor(Constructor<cv::BOWKMeansTrainer, int, const cv::TermCriteria&, int, int>(),
      Arg("cluster_count"), Arg("termcrit") = static_cast<const TermCriteria &>(TermCriteria()), Arg("attempts") = static_cast<int>(3), Arg("flags") = static_cast<int>(KMEANS_PP_CENTERS)).
  ...
  Class rb_cCvBOWImgDescriptorExtractor = define_class_under<cv::BOWImgDescriptorExtractor>(rb_mCv, "BOWImgDescriptorExtractor").
    ...
    define_method<void(cv::BOWImgDescriptorExtractor::*)(cv::InputArray, std::vector<cv::KeyPoint>&, cv::OutputArray, std::vector<std::vector<int>>*, cv::Mat*)>("compute", &cv::BOWImgDescriptorExtractor::compute,
      Arg("image"), Arg("keypoints"), Arg("img_descriptor"), Arg("point_idxs_of_clusters") = static_cast<std::vector<std::vector<int>> *>(0), Arg("descriptors") = static_cast<Mat *>(0)).
