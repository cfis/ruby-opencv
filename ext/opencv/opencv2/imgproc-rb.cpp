...
void Init_Imgproc()
{
  ...
  Class rb_cCvGeneralizedHough = define_class_under<cv::GeneralizedHough, cv::Algorithm>(rb_mCv, "GeneralizedHough").
    define_method<void(cv::GeneralizedHough::*)(cv::InputArray, cv::Point)>("set_template", &cv::GeneralizedHough::setTemplate,
      Arg("templ"), Arg("templ_center") = static_cast<Point>(Point(-1, -1))).
    define_method<void(cv::GeneralizedHough::*)(cv::InputArray, cv::InputArray, cv::InputArray, cv::Point)>("set_template", &cv::GeneralizedHough::setTemplate,
      Arg("edges"), Arg("dx"), Arg("dy"), Arg("templ_center") = static_cast<Point>(Point(-1, -1))).
    define_method<void(cv::GeneralizedHough::*)(cv::InputArray, cv::OutputArray, cv::OutputArray)>("detect", &cv::GeneralizedHough::detect,
      Arg("image"), Arg("positions"), Arg("votes") = static_cast<OutputArray>(noArray())).
    define_method<void(cv::GeneralizedHough::*)(cv::InputArray, cv::InputArray, cv::InputArray, cv::OutputArray, cv::OutputArray)>("detect", &cv::GeneralizedHough::detect,
      Arg("edges"), Arg("dx"), Arg("dy"), Arg("positions"), Arg("votes") = static_cast<OutputArray>(noArray())).
  ...
  Class rb_cCvSubdiv2D = define_class_under<cv::Subdiv2D>(rb_mCv, "Subdiv2D").
    ...
    define_method("find_nearest", &cv::Subdiv2D::findNearest,
      Arg("pt"), Arg("nearest_pt") = static_cast<Point2f *>(0)).
    ...
    define_method("edge_org", &cv::Subdiv2D::edgeOrg,
      Arg("edge"), Arg("orgpt") = static_cast<Point2f *>(0)).
    define_method("edge_dst", &cv::Subdiv2D::edgeDst,
      Arg("edge"), Arg("dstpt") = static_cast<Point2f *>(0));
  ...
  Class rb_cCvSubdiv2DVertex = define_class_under<cv::Subdiv2D::Vertex>(rb_cCvSubdiv2D, "Vertex").
    ...
    define_constructor(Constructor<cv::Subdiv2D::Vertex, cv::Point2f, bool, int>(),
      Arg("pt"), Arg("isvirtual"), Arg("first_edge") = static_cast<int>(0)).
    define_method("isvirtual?", &cv::Subdiv2D::Vertex::isvirtual).
    define_method("isfree?", &cv::Subdiv2D::Vertex::isfree).
  ...
  Class rb_cCvSubdiv2DQuadEdge = define_class_under<cv::Subdiv2D::QuadEdge>(rb_cCvSubdiv2D, "QuadEdge").
    ...
    define_constructor(Constructor<cv::Subdiv2D::QuadEdge, int>(),
      Arg("edgeidx")).
    define_method("isfree?", &cv::Subdiv2D::QuadEdge::isfree);
  ...
  Class rb_cCvLineSegmentDetector = define_class_under<cv::LineSegmentDetector, cv::Algorithm>(rb_mCv, "LineSegmentDetector").
    define_method("detect", &cv::LineSegmentDetector::detect,
      Arg("image"), Arg("lines"), Arg("width") = static_cast<OutputArray>(noArray()), Arg("prec") = static_cast<OutputArray>(noArray()), Arg("nfa") = static_cast<OutputArray>(noArray())).
    ...
    define_method("compare_segments", &cv::LineSegmentDetector::compareSegments,
      Arg("size"), Arg("lines1"), Arg("lines2"), Arg("image") = static_cast<InputOutputArray>(noArray()));
  
  rb_mCv.define_module_function("create_line_segment_detector", &cv::createLineSegmentDetector,
    Arg("refine") = static_cast<int>(LSD_REFINE_STD), Arg("scale") = static_cast<double>(0.8), Arg("sigma_scale") = static_cast<double>(0.6), Arg("quant") = static_cast<double>(2.0), Arg("ang_th") = static_cast<double>(22.5), Arg("log_eps") = static_cast<double>(0), Arg("density_th") = static_cast<double>(0.7), Arg("n_bins") = static_cast<int>(1024));
  ...
  rb_mCv.define_module_function("get_structuring_element", &cv::getStructuringElement,
    Arg("shape"), Arg("ksize"), Arg("anchor") = static_cast<Point>(Point(-1,-1)));
  ...
  rb_mCv.define_module_function("gaussian_blur", &cv::GaussianBlur,
    Arg("src"), Arg("dst"), Arg("ksize"), Arg("sigma_x"), Arg("sigma_y") = static_cast<double>(0), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("bilateral_filter", &cv::bilateralFilter,
    Arg("src"), Arg("dst"), Arg("d"), Arg("sigma_color"), Arg("sigma_space"), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("box_filter", &cv::boxFilter,
    Arg("src"), Arg("dst"), Arg("ddepth"), Arg("ksize"), Arg("anchor") = static_cast<Point>(Point(-1,-1)), Arg("normalize") = static_cast<bool>(true), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("sqr_box_filter", &cv::sqrBoxFilter,
    Arg("src"), Arg("dst"), Arg("ddepth"), Arg("ksize"), Arg("anchor") = static_cast<Point>(Point(-1, -1)), Arg("normalize") = static_cast<bool>(true), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("blur", &cv::blur,
    Arg("src"), Arg("dst"), Arg("ksize"), Arg("anchor") = static_cast<Point>(Point(-1,-1)), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("stack_blur", &cv::stackBlur,
    Arg("src"), Arg("dst"), Arg("ksize"));
  
  rb_mCv.define_module_function("filter2_d", &cv::filter2D,
    Arg("src"), Arg("dst"), Arg("ddepth"), Arg("kernel"), Arg("anchor") = static_cast<Point>(Point(-1,-1)), Arg("delta") = static_cast<double>(0), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("sep_filter2_d", &cv::sepFilter2D,
    Arg("src"), Arg("dst"), Arg("ddepth"), Arg("kernel_x"), Arg("kernel_y"), Arg("anchor") = static_cast<Point>(Point(-1,-1)), Arg("delta") = static_cast<double>(0), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("sobel", &cv::Sobel,
    Arg("src"), Arg("dst"), Arg("ddepth"), Arg("dx"), Arg("dy"), Arg("ksize") = static_cast<int>(3), Arg("scale") = static_cast<double>(1), Arg("delta") = static_cast<double>(0), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("spatial_gradient", &cv::spatialGradient,
    Arg("src"), Arg("dx"), Arg("dy"), Arg("ksize") = static_cast<int>(3), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("scharr", &cv::Scharr,
    Arg("src"), Arg("dst"), Arg("ddepth"), Arg("dx"), Arg("dy"), Arg("scale") = static_cast<double>(1), Arg("delta") = static_cast<double>(0), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("laplacian", &cv::Laplacian,
    Arg("src"), Arg("dst"), Arg("ddepth"), Arg("ksize") = static_cast<int>(1), Arg("scale") = static_cast<double>(1), Arg("delta") = static_cast<double>(0), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  ...
  rb_mCv.define_module_function("corner_min_eigen_val", &cv::cornerMinEigenVal,
    Arg("src"), Arg("dst"), Arg("block_size"), Arg("ksize") = static_cast<int>(3), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("corner_harris", &cv::cornerHarris,
    Arg("src"), Arg("dst"), Arg("block_size"), Arg("ksize"), Arg("k"), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("corner_eigen_vals_and_vecs", &cv::cornerEigenValsAndVecs,
    Arg("src"), Arg("dst"), Arg("block_size"), Arg("ksize"), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("pre_corner_detect", &cv::preCornerDetect,
    Arg("src"), Arg("dst"), Arg("ksize"), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, cv::OutputArray, int, double, double, cv::InputArray, int, bool, double)>("good_features_to_track", &cv::goodFeaturesToTrack,
    Arg("image"), Arg("corners"), Arg("max_corners"), Arg("quality_level"), Arg("min_distance"), Arg("mask") = static_cast<InputArray>(noArray()), Arg("block_size") = static_cast<int>(3), Arg("use_harris_detector") = static_cast<bool>(false), Arg("k") = static_cast<double>(0.04));
  ...
  rb_mCv.define_module_function("erode", &cv::erode,
    Arg("src"), Arg("dst"), Arg("kernel"), Arg("anchor") = static_cast<Point>(Point(-1,-1)), Arg("iterations") = static_cast<int>(1), Arg("border_type") = static_cast<int>(BORDER_CONSTANT), Arg("border_value") = static_cast<const Scalar &>(morphologyDefaultBorderValue()));
  
  rb_mCv.define_module_function("dilate", &cv::dilate,
    Arg("src"), Arg("dst"), Arg("kernel"), Arg("anchor") = static_cast<Point>(Point(-1,-1)), Arg("iterations") = static_cast<int>(1), Arg("border_type") = static_cast<int>(BORDER_CONSTANT), Arg("border_value") = static_cast<const Scalar &>(morphologyDefaultBorderValue()));
  
  rb_mCv.define_module_function("morphology_ex", &cv::morphologyEx,
    Arg("src"), Arg("dst"), Arg("op"), Arg("kernel"), Arg("anchor") = static_cast<Point>(Point(-1,-1)), Arg("iterations") = static_cast<int>(1), Arg("border_type") = static_cast<int>(BORDER_CONSTANT), Arg("border_value") = static_cast<const Scalar &>(morphologyDefaultBorderValue()));
  
  rb_mCv.define_module_function("resize", &cv::resize,
    Arg("src"), Arg("dst"), Arg("dsize"), Arg("fx") = static_cast<double>(0), Arg("fy") = static_cast<double>(0), Arg("interpolation") = static_cast<int>(INTER_LINEAR));
  
  rb_mCv.define_module_function("warp_affine", &cv::warpAffine,
    Arg("src"), Arg("dst"), Arg("m"), Arg("dsize"), Arg("flags") = static_cast<int>(INTER_LINEAR), Arg("border_mode") = static_cast<int>(BORDER_CONSTANT), Arg("border_value") = static_cast<const Scalar &>(Scalar()));
  
  rb_mCv.define_module_function("warp_perspective", &cv::warpPerspective,
    Arg("src"), Arg("dst"), Arg("m"), Arg("dsize"), Arg("flags") = static_cast<int>(INTER_LINEAR), Arg("border_mode") = static_cast<int>(BORDER_CONSTANT), Arg("border_value") = static_cast<const Scalar &>(Scalar()));
  
  rb_mCv.define_module_function("remap", &cv::remap,
    Arg("src"), Arg("dst"), Arg("map1"), Arg("map2"), Arg("interpolation"), Arg("border_mode") = static_cast<int>(BORDER_CONSTANT), Arg("border_value") = static_cast<const Scalar &>(Scalar()));
  ...
  rb_mCv.define_module_function<cv::Mat(*)(cv::InputArray, cv::InputArray, int)>("get_perspective_transform", &cv::getPerspectiveTransform,
    Arg("src"), Arg("dst"), Arg("solve_method") = static_cast<int>(DECOMP_LU));
  ...
  rb_mCv.define_module_function("accumulate", &cv::accumulate,
    Arg("src"), Arg("dst"), Arg("mask") = static_cast<InputArray>(noArray()));
  ...
  rb_mCv.define_module_function("accumulate_product", &cv::accumulateProduct,
    Arg("src1"), Arg("src2"), Arg("dst"), Arg("mask") = static_cast<InputArray>(noArray()));
  
  rb_mCv.define_module_function("accumulate_weighted", &cv::accumulateWeighted,
    Arg("src"), Arg("dst"), Arg("alpha"), Arg("mask") = static_cast<InputArray>(noArray()));
  
  rb_mCv.define_module_function("phase_correlate", &cv::phaseCorrelate,
    Arg("src1"), Arg("src2"), Arg("window") = static_cast<InputArray>(noArray()), Arg("response") = static_cast<double *>(0));
  ...
  rb_mCv.define_module_function("pyr_down", &cv::pyrDown,
    Arg("src"), Arg("dst"), Arg("dstsize") = static_cast<const Size &>(Size()), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("pyr_up", &cv::pyrUp,
    Arg("src"), Arg("dst"), Arg("dstsize") = static_cast<const Size &>(Size()), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  
  rb_mCv.define_module_function("build_pyramid", &cv::buildPyramid,
    Arg("src"), Arg("dst"), Arg("maxlevel"), Arg("border_type") = static_cast<int>(BORDER_DEFAULT));
  ...
  rb_mCv.define_module_function("create_clahe", &cv::createCLAHE,
    Arg("clip_limit") = static_cast<double>(40.0), Arg("tile_grid_size") = static_cast<Size>(Size(8, 8)));
  
  rb_mCv.define_module_function("emd", &cv::EMD,
    Arg("signature1"), Arg("signature2"), Arg("dist_type"), Arg("cost") = static_cast<InputArray>(noArray()), Arg("lower_bound") = static_cast<float *>(0), Arg("flow") = static_cast<OutputArray>(noArray()));
  
  rb_mCv.define_module_function("wrapper_emd", &cv::wrapperEMD,
    Arg("signature1"), Arg("signature2"), Arg("dist_type"), Arg("cost") = static_cast<InputArray>(noArray()), Arg("lower_bound") = static_cast<Ptr<float>>(Ptr<float>()), Arg("flow") = static_cast<OutputArray>(noArray()));
  ...
  rb_mCv.define_module_function("pyr_mean_shift_filtering", &cv::pyrMeanShiftFiltering,
    Arg("src"), Arg("dst"), Arg("sp"), Arg("sr"), Arg("max_level") = static_cast<int>(1), Arg("termcrit") = static_cast<TermCriteria>(TermCriteria(TermCriteria::MAX_ITER+TermCriteria::EPS,5,1)));
  
  rb_mCv.define_module_function("grab_cut", &cv::grabCut,
    Arg("img"), Arg("mask"), Arg("rect"), Arg("bgd_model"), Arg("fgd_model"), Arg("iter_count"), Arg("mode") = static_cast<int>(GC_EVAL));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, cv::OutputArray, cv::OutputArray, int, int, int)>("distance_transform", &cv::distanceTransform,
    Arg("src"), Arg("dst"), Arg("labels"), Arg("distance_type"), Arg("mask_size"), Arg("label_type") = static_cast<int>(DIST_LABEL_CCOMP));
  ...
  rb_mCv.define_module_function<int(*)(cv::InputOutputArray, cv::InputOutputArray, cv::Point, cv::Scalar, cv::Rect*, cv::Scalar, cv::Scalar, int)>("flood_fill", &cv::floodFill,
    Arg("image"), Arg("mask"), Arg("seed_point"), Arg("new_val"), Arg("rect") = static_cast<Rect *>(0), Arg("lo_diff") = static_cast<Scalar>(Scalar()), Arg("up_diff") = static_cast<Scalar>(Scalar()), Arg("flags") = static_cast<int>(4));
  ...
  rb_mCv.define_module_function<int(*)(cv::InputOutputArray, cv::Point, cv::Scalar, cv::Rect*, cv::Scalar, cv::Scalar, int)>("flood_fill", &cv::floodFill,
    Arg("image"), Arg("seed_point"), Arg("new_val"), Arg("rect") = static_cast<Rect *>(0), Arg("lo_diff") = static_cast<Scalar>(Scalar()), Arg("up_diff") = static_cast<Scalar>(Scalar()), Arg("flags") = static_cast<int>(4));
  ...
  rb_mCv.define_module_function("match_template", &cv::matchTemplate,
    Arg("image"), Arg("templ"), Arg("result"), Arg("method"), Arg("mask") = static_cast<InputArray>(noArray()));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputArray, cv::OutputArrayOfArrays, cv::OutputArray, int, int, cv::Point)>("find_contours", &cv::findContours,
    Arg("image"), Arg("contours"), Arg("hierarchy"), Arg("mode"), Arg("method"), Arg("offset") = static_cast<Point>(Point()));
  
  rb_mCv.define_module_function<void(*)(cv::InputArray, cv::OutputArrayOfArrays, int, int, cv::Point)>("find_contours", &cv::findContours,
    Arg("image"), Arg("contours"), Arg("mode"), Arg("method"), Arg("offset") = static_cast<Point>(Point()));
  ...
  rb_mCv.define_module_function("line", &cv::line,
    Arg("img"), Arg("pt1"), Arg("pt2"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, cv::Rect, const cv::Scalar&, int, int, int)>("rectangle", &cv::rectangle,
    Arg("img"), Arg("rec"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  
  rb_mCv.define_module_function("circle", &cv::circle,
    Arg("img"), Arg("center"), Arg("radius"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, cv::Point, cv::Size, double, double, double, const cv::Scalar&, int, int, int)>("ellipse", &cv::ellipse,
    Arg("img"), Arg("center"), Arg("axes"), Arg("angle"), Arg("start_angle"), Arg("end_angle"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, const cv::RotatedRect&, const cv::Scalar&, int, int)>("ellipse", &cv::ellipse,
    Arg("img"), Arg("box"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8));
  
  rb_mCv.define_module_function("draw_marker", &cv::drawMarker,
    Arg("img"), Arg("position"), Arg("color"), Arg("marker_type") = static_cast<int>(MARKER_CROSS), Arg("marker_size") = static_cast<int>(20), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(8));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, cv::InputArray, const cv::Scalar&, int, int)>("fill_convex_poly", &cv::fillConvexPoly,
    Arg("img"), Arg("points"), Arg("color"), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, const cv::Point*, int, const cv::Scalar&, int, int)>("fill_convex_poly", &cv::fillConvexPoly,
    Arg("img"), Arg("pts"), Arg("npts"), Arg("color"), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, cv::InputArrayOfArrays, const cv::Scalar&, int, int, cv::Point)>("fill_poly", &cv::fillPoly,
    Arg("img"), Arg("pts"), Arg("color"), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0), Arg("offset") = static_cast<Point>(Point()));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, const cv::Point**, const int*, int, const cv::Scalar&, int, int, cv::Point)>("fill_poly", &cv::fillPoly,
    Arg("img"), Arg("pts"), Arg("npts"), Arg("ncontours"), Arg("color"), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0), Arg("offset") = static_cast<Point>(Point()));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, cv::InputArrayOfArrays, bool, const cv::Scalar&, int, int, int)>("polylines", &cv::polylines,
    Arg("img"), Arg("pts"), Arg("is_closed"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  ...
  rb_mCv.define_module_function<void(*)(cv::InputOutputArray, const cv::Point**, const int*, int, bool, const cv::Scalar&, int, int, int)>("polylines", &cv::polylines,
    Arg("img"), Arg("pts"), Arg("npts"), Arg("ncontours"), Arg("is_closed"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("shift") = static_cast<int>(0));
  
  rb_mCv.define_module_function("draw_contours", &cv::drawContours,
    Arg("image"), Arg("contours"), Arg("contour_idx"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("hierarchy") = static_cast<InputArray>(noArray()), Arg("max_level") = static_cast<int>(INT_MAX), Arg("offset") = static_cast<Point>(Point()));
  ...
  rb_mCv.define_module_function("put_text", &cv::putText,
    Arg("img"), Arg("text"), Arg("org"), Arg("font_face"), Arg("font_scale"), Arg("color"), Arg("thickness") = static_cast<int>(1), Arg("line_type") = static_cast<int>(LINE_8), Arg("bottom_left_origin") = static_cast<bool>(false));
  ...
  Class rb_cCvLineIterator = define_class_under<cv::LineIterator>(rb_mCv, "LineIterator").
    ...
    define_method("*", &cv::LineIterator::operator*).
