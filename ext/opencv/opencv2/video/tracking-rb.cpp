...
void Init_Tracking()
{
  ...
  rb_mCv.define_module_function("build_optical_flow_pyramid", &cv::buildOpticalFlowPyramid,
    Arg("img"), Arg("pyramid"), Arg("win_size"), Arg("max_level"), Arg("with_derivatives") = static_cast<bool>(true), Arg("pyr_border") = static_cast<int>(BORDER_REFLECT_101), Arg("deriv_border") = static_cast<int>(BORDER_CONSTANT), Arg("try_reuse_input_image") = static_cast<bool>(true));
  
  rb_mCv.define_module_function("calc_optical_flow_pyr_lk", &cv::calcOpticalFlowPyrLK,
    Arg("prev_img"), Arg("next_img"), Arg("prev_pts"), Arg("next_pts"), Arg("status"), Arg("err"), Arg("win_size") = static_cast<Size>(Size(21,21)), Arg("max_level") = static_cast<int>(3), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::COUNT+TermCriteria::EPS, 30, 0.01)), Arg("flags") = static_cast<int>(0), Arg("min_eig_threshold") = static_cast<double>(1e-4));
  ...
  rb_mCv.define_module_function("estimate_rigid_transform", &cv::estimateRigidTransform,
  ...
  rb_mCv.define_module_function("compute_ecc", &cv::computeECC,
    Arg("template_image"), Arg("input_image"), Arg("input_mask") = static_cast<InputArray>(noArray()));
  ...
  rb_mCv.define_module_function<double(*)(cv::InputArray, cv::InputArray, cv::InputOutputArray, int, cv::TermCriteria, cv::InputArray)>("find_transform_ecc", &cv::findTransformECC,
    Arg("template_image"), Arg("input_image"), Arg("warp_matrix"), Arg("motion_type") = static_cast<int>(MOTION_AFFINE), Arg("criteria") = static_cast<TermCriteria>(TermCriteria(TermCriteria::COUNT+TermCriteria::EPS, 50, 0.001)), Arg("input_mask") = static_cast<InputArray>(noArray()));
  ...
  Class rb_cCvKalmanFilter = define_class_under<cv::KalmanFilter>(rb_mCv, "KalmanFilter").
    ...
    define_method("predict", &cv::KalmanFilter::predict,
      Arg("control") = static_cast<const Mat &>(Mat())).
  ...
  Class rb_cCvSparseOpticalFlow = define_class_under<cv::SparseOpticalFlow, cv::Algorithm>(rb_mCv, "SparseOpticalFlow").
    define_method("calc", &cv::SparseOpticalFlow::calc,
      Arg("prev_img"), Arg("next_img"), Arg("prev_pts"), Arg("next_pts"), Arg("status"), Arg("err") = static_cast<OutputArray>(cv::noArray()));
  ...
  Class rb_cCvDISOpticalFlow = define_class_under<cv::DISOpticalFlow, cv::DenseOpticalFlow>(rb_mCv, "DISOpticalFlow").
    ...
    define_singleton_function("create", &cv::DISOpticalFlow::create,
      Arg("preset") = static_cast<int>(DISOpticalFlow::PRESET_FAST));
  ...
  Class rb_cCvSparsePyrLKOpticalFlow = define_class_under<cv::SparsePyrLKOpticalFlow, cv::SparseOpticalFlow>(rb_mCv, "SparsePyrLKOpticalFlow").
    ...
    define_singleton_function("create", &cv::SparsePyrLKOpticalFlow::create,
      Arg("win_size") = static_cast<Size>(Size(21, 21)), Arg("max_level") = static_cast<int>(3), Arg("crit") = static_cast<TermCriteria>(TermCriteria(TermCriteria::COUNT+TermCriteria::EPS, 30, 0.01)), Arg("flags") = static_cast<int>(0), Arg("min_eig_threshold") = static_cast<double>(1e-4));
  ...
  Class rb_cCvTrackerMIL = define_class_under<cv::TrackerMIL, cv::Tracker>(rb_mCv, "TrackerMIL").
    define_singleton_function("create", &cv::TrackerMIL::create,
      Arg("parameters") = static_cast<const TrackerMIL::Params &>(TrackerMIL::Params()));
  ...
  Class rb_cCvTrackerGOTURN = define_class_under<cv::TrackerGOTURN, cv::Tracker>(rb_mCv, "TrackerGOTURN").
    define_singleton_function("create", &cv::TrackerGOTURN::create,
      Arg("parameters") = static_cast<const TrackerGOTURN::Params &>(TrackerGOTURN::Params()));
  ...
  Class rb_cCvTrackerDaSiamRPN = define_class_under<cv::TrackerDaSiamRPN, cv::Tracker>(rb_mCv, "TrackerDaSiamRPN").
    define_singleton_function("create", &cv::TrackerDaSiamRPN::create,
      Arg("parameters") = static_cast<const TrackerDaSiamRPN::Params &>(TrackerDaSiamRPN::Params())).
  ...
  Class rb_cCvTrackerNano = define_class_under<cv::TrackerNano, cv::Tracker>(rb_mCv, "TrackerNano").
    define_singleton_function("create", &cv::TrackerNano::create,
      Arg("parameters") = static_cast<const TrackerNano::Params &>(TrackerNano::Params())).
  ...
  Class rb_cCvTrackerVit = define_class_under<cv::TrackerVit, cv::Tracker>(rb_mCv, "TrackerVit").
    define_singleton_function("create", &cv::TrackerVit::create,
      Arg("parameters") = static_cast<const TrackerVit::Params &>(TrackerVit::Params())).
