...
void Init_Camera()
{
  ...
  Class rb_cCvDetailCameraParams = define_class_under<cv::detail::CameraParams>(rb_mCvDetail, "CameraParams").
    ...
    define_method<cv::detail::CameraParams&(cv::detail::CameraParams::*)(const cv::detail::CameraParams&)>("operator=", &cv::detail::CameraParams::operator=).
