...
void Init_MotionEstimators()
{
  ...
  Class rb_cCvDetailEstimator = define_class_under<cv::detail::Estimator>(rb_mCvDetail, "Estimator").
    define_method<bool(cv::detail::Estimator::*)(const std::vector<cv::detail::ImageFeatures>&, const std::vector<cv::detail::MatchesInfo>&, std::vector<cv::detail::CameraParams>&)>("operator()", &cv::detail::Estimator::operator());
  ...
  Class rb_cCvDetailBundleAdjusterBase = define_class_under<cv::detail::BundleAdjusterBase, cv::detail::Estimator>(rb_mCvDetail, "BundleAdjusterBase").
    ...
    define_constructor(Constructor<cv::detail::BundleAdjusterBase, int, int>());
  ...
  Enum<cv::detail::WaveCorrectKind> rb_cCvDetailWaveCorrectKind = define_enum<cv::detail::WaveCorrectKind>("WaveCorrectKind", rb_mCvDetail).
  ...
  rb_mCvDetail.define_module_function<std::basic_string<char>(*)(std::vector<std::basic_string<char>>&, std::vector<cv::detail::MatchesInfo>&, float)>("matches_graph_as_string", &cv::detail::matchesGraphAsString);
