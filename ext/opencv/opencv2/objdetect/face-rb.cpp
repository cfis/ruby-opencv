...
void Init_Face()
{
  ...
  Class rb_cCvFaceRecognizerSF = define_class_under<cv::FaceRecognizerSF>(rb_mCv, "FaceRecognizerSF").
    ...
    define_method("match", &cv::FaceRecognizerSF::match,
      Arg("face_feature1"), Arg("face_feature2"), Arg("dis_type") = static_cast<int>(FaceRecognizerSF::FR_COSINE)).
    define_singleton_function("create", &cv::FaceRecognizerSF::create,
