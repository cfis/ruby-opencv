...
void Init_DetectionBasedTracker()
{
  ...
  Class rb_cCvDetectionBasedTracker = define_class_under<cv::DetectionBasedTracker>(rb_mCv, "DetectionBasedTracker").
    ...
    define_method<int(cv::DetectionBasedTracker::*)(const cv::Rect_<int>&)>("add_object", &cv::DetectionBasedTracker::addObject);
  ...
  Class rb_cCvDetectionBasedTrackerIDetector = define_class_under<cv::DetectionBasedTracker::IDetector>(rb_cCvDetectionBasedTracker, "IDetector").
    define_constructor(Constructor<cv::DetectionBasedTracker::IDetector>()).
    ...
    define_method<void(cv::DetectionBasedTracker::IDetector::*)(const cv::Size_<int>&)>("set_min_object_size", &cv::DetectionBasedTracker::IDetector::setMinObjectSize).
    define_method<void(cv::DetectionBasedTracker::IDetector::*)(const cv::Size_<int>&)>("set_max_object_size", &cv::DetectionBasedTracker::IDetector::setMaxObjectSize).
    define_method<cv::Size_<int>(cv::DetectionBasedTracker::IDetector::*)() const>("get_min_object_size", &cv::DetectionBasedTracker::IDetector::getMinObjectSize).
    define_method<cv::Size_<int>(cv::DetectionBasedTracker::IDetector::*)() const>("get_max_object_size", &cv::DetectionBasedTracker::IDetector::getMaxObjectSize).
  ...
  Class rb_cCvDetectionBasedTrackerExtObject = define_class_under<cv::DetectionBasedTracker::ExtObject>(rb_cCvDetectionBasedTracker, "ExtObject").
    ...
    define_constructor(Constructor<cv::DetectionBasedTracker::ExtObject, int, cv::Rect_<int>, cv::DetectionBasedTracker::ObjectStatus>());
  ...
  Class rb_cCvDetectionBasedTrackerTrackedObject = define_class_under<cv::DetectionBasedTracker::TrackedObject>(rb_cCvDetectionBasedTracker, "TrackedObject").
    ...
    define_constructor(Constructor<cv::DetectionBasedTracker::TrackedObject, const cv::Rect_<int>&>()).
    define_singleton_function<int(*)()>("get_next_id", &cv::DetectionBasedTracker::TrackedObject::getNextId);
  
  Enum<cv::DetectionBasedTracker::ObjectStatus> rb_cCvDetectionBasedTrackerObjectStatus = define_enum<cv::DetectionBasedTracker::ObjectStatus>("ObjectStatus", rb_cCvDetectionBasedTracker).
