...
{
  klass.template define_method("*", &cvflann::ZeroIterator<T>::operator*).
    template define_method("[]", &cvflann::ZeroIterator<T>::operator[],
      Arg("")).
    template define_method<const cvflann::ZeroIterator<T>&(cvflann::ZeroIterator<T>::*)()>("++", &cvflann::ZeroIterator<T>::operator++).
    template define_method<cvflann::ZeroIterator<T>(cvflann::ZeroIterator<T>::*)(int)>("++", &cvflann::ZeroIterator<T>::operator++,
      Arg("")).
    template define_method("+=", &cvflann::ZeroIterator<T>::operator+=,
      Arg(""));
};
...
inline void MinkowskiDistance_builder(Data_Type_T& klass)
{
  klass.define_attr("order", &cvflann::MinkowskiDistance<T>::order).
    define_constructor(Constructor<cvflann::MinkowskiDistance::MinkowskiDistance<T>, int>(),
      Arg("order_"));
};
...
void Init_Dist()
{
  ...
  rb_cCvflannHammingLUT = define_class_under<cvflann::HammingLUT>(rb_mCvflann, "HammingLUT").
    ...
    define_method("call", &cvflann::HammingLUT::operator(),
  ...
  rb_cCvflannDNAmmingLUT = define_class_under<cvflann::DNAmmingLUT>(rb_mCvflann, "DNAmmingLUT").
    ...
    define_method("call", &cvflann::DNAmmingLUT::operator(),
      Arg("a"), Arg("b"), Arg("size"));
