...
inline void ZeroIterator_builder(Data_Type_T& klass)
{
  klass.define_method("dereference", &cvflann::ZeroIterator<T>::operator*).
    define_method("[]", &cvflann::ZeroIterator<T>::operator[],
      Arg("")).
    define_method<const cvflann::ZeroIterator<T>&(cvflann::ZeroIterator<T>::*)()>("increment", &cvflann::ZeroIterator<T>::operator++).
    define_method<cvflann::ZeroIterator<T>(cvflann::ZeroIterator<T>::*)(int)>("increment", &cvflann::ZeroIterator<T>::operator++,
      Arg("")).
