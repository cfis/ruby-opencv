...
{
  klass.define_method("*", &cvflann::ZeroIterator<T>::operator*).
    define_method("[]", &cvflann::ZeroIterator<T>::operator[],
      Arg("")).
    define_method<const cvflann::ZeroIterator<T>&(cvflann::ZeroIterator<T>::*)()>("++", &cvflann::ZeroIterator<T>::operator++).
    define_method<cvflann::ZeroIterator<T>(cvflann::ZeroIterator<T>::*)(int)>("++", &cvflann::ZeroIterator<T>::operator++,
      Arg("")).
    define_method("+=", &cvflann::ZeroIterator<T>::operator+=,
      Arg(""));
};
