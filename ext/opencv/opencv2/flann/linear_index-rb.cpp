...
{
  klass.define_constructor(Constructor<cvflann::LinearIndex::LinearIndex<Distance>, const cvflann::Matrix<ElementType>&, const cvflann::IndexParams&, Distance>(),
      Arg("input_data"), Arg("params") = static_cast<const IndexParams &>(LinearIndexParams()), Arg("d") = static_cast<Distance>(Distance())).
    define_constructor(Constructor<cvflann::LinearIndex::LinearIndex<Distance>, const cvflann::LinearIndex<Distance>&>(),
      Arg("")).
