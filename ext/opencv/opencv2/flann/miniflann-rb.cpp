...
void Init_Miniflann()
{
  ...
  Class rb_cCvFlannIndex = define_class_under<cv::flann::Index>(rb_mCvFlann, "Index").
    ...
    define_method("knn_search", &cv::flann::Index::knnSearch,
      Arg("query"), Arg("indices"), Arg("dists"), Arg("knn"), Arg("params") = static_cast<const SearchParams &>(SearchParams())).
    define_method("radius_search", &cv::flann::Index::radiusSearch,
      Arg("query"), Arg("indices"), Arg("dists"), Arg("radius"), Arg("max_results"), Arg("params") = static_cast<const SearchParams &>(SearchParams())).
