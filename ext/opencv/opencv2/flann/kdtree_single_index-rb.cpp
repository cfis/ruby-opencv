...
{
  klass.define_constructor(Constructor<cvflann::KDTreeSingleIndex::KDTreeSingleIndex<Distance>, const cvflann::Matrix<ElementType>&, const cvflann::IndexParams&, Distance>(),
      Arg("input_data"), Arg("params") = static_cast<const IndexParams &>(KDTreeSingleIndexParams()), Arg("d") = static_cast<Distance>(Distance())).
    define_constructor(Constructor<cvflann::KDTreeSingleIndex::KDTreeSingleIndex<Distance>, const cvflann::KDTreeSingleIndex<Distance>&>(),
      Arg("")).
