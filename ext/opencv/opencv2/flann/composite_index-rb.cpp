...
{
  klass.define_constructor(Constructor<cvflann::CompositeIndex::CompositeIndex<Distance>, const cvflann::Matrix<ElementType>&, const cvflann::IndexParams&, Distance>(),
      Arg("input_data"), Arg("params") = static_cast<const IndexParams &>(CompositeIndexParams()), Arg("d") = static_cast<Distance>(Distance())).
    define_constructor(Constructor<cvflann::CompositeIndex::CompositeIndex<Distance>, const cvflann::CompositeIndex<Distance>&>(),
      Arg("")).
