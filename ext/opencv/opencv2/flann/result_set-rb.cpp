...
inline void BranchStruct_builder(Data_Type_T& klass)
{
  klass.define_attr("node", &cvflann::BranchStruct<T, DistanceType>::node).
    ...
    define_constructor(Constructor<cvflann::BranchStruct::BranchStruct<T, DistanceType>>()).
    define_constructor(Constructor<cvflann::BranchStruct::BranchStruct<T, DistanceType>, const T&, DistanceType>(),
      Arg("a_node"), Arg("dist")).
...
{
  klass.define_constructor(Constructor<cvflann::KNNSimpleResultSet::KNNSimpleResultSet<DistanceType>, int>(),
      Arg("capacity_")).
...
{
  klass.define_constructor(Constructor<cvflann::KNNResultSet::KNNResultSet<DistanceType>, int>(),
      Arg("capacity_")).
...
{
  klass.define_constructor(Constructor<cvflann::RadiusResultSet::RadiusResultSet<DistanceType>, DistanceType, int*, DistanceType*, int>(),
...
inline void UniqueResultSet_builder(Data_Type_T& klass)
{
  klass.rb_cCvflannUniqueResultSetDistIndex = define_class<cvflann::UniqueResultSet::DistIndex>("DistIndex").
      define_constructor(Constructor<cvflann::UniqueResultSet::DistIndex, DistanceType, unsigned int>(),
        Arg("dist"), Arg("index")).
    ...
    define_constructor(Constructor<cvflann::UniqueResultSet::UniqueResultSet<DistanceType>>()).
    template define_method("full?", &cvflann::UniqueResultSet<DistanceType>::full).
    template define_method("clear", &cvflann::UniqueResultSet<DistanceType>::clear).
    template define_method("copy", &cvflann::UniqueResultSet<DistanceType>::copy,
      Arg("indices"), Arg("dist"), Arg("n_neighbors") = static_cast<int>(-1)).
    template define_method("sort_and_copy", &cvflann::UniqueResultSet<DistanceType>::sortAndCopy,
      Arg("indices"), Arg("dist"), Arg("n_neighbors") = static_cast<int>(-1)).
    template define_method("size", &cvflann::UniqueResultSet<DistanceType>::size).
    template define_method("worst_dist", &cvflann::UniqueResultSet<DistanceType>::worstDist);
};

template<typename Data_Type_T, typename DistanceType>
inline void KNNUniqueResultSet_builder(Data_Type_T& klass)
{
  klass.define_constructor(Constructor<cvflann::KNNUniqueResultSet::KNNUniqueResultSet<DistanceType>, unsigned int>(),
      Arg("capacity")).
...
{
  klass.define_constructor(Constructor<cvflann::RadiusUniqueResultSet::RadiusUniqueResultSet<DistanceType>, DistanceType>(),
      Arg("radius")).
...
{
  klass.define_constructor(Constructor<cvflann::KNNRadiusUniqueResultSet::KNNRadiusUniqueResultSet<DistanceType>, unsigned int, DistanceType>(),
