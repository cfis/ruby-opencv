...
inline void KMeansIndex_builder(Data_Type_T& klass)
{
  klass.define_attr("choose_centers", &cvflann::KMeansIndex<Distance>::chooseCenters).
    ...
    define_constructor(Constructor<cvflann::KMeansIndex::KMeansIndex<Distance>, const cvflann::Matrix<ElementType>&, const cvflann::IndexParams&, Distance>(),
      Arg("input_data"), Arg("params") = static_cast<const IndexParams &>(KMeansIndexParams()), Arg("d") = static_cast<Distance>(Distance())).
    define_constructor(Constructor<cvflann::KMeansIndex::KMeansIndex<Distance>, const cvflann::KMeansIndex<Distance>&>(),
      Arg("")).
...
{
  klass.define_constructor(Constructor<cvflann::KMeansIndex::KMeansDistanceComputer::KMeansDistanceComputer<CentersContainerType>, Distance, const cvflann::Matrix<ElementType>&, const int, const int*, const CentersContainerType&, const ::size_t, std::vector<int>&, std::vector<DistanceType>&>(),
