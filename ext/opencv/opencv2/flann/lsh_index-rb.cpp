...
{
  klass.define_constructor(Constructor<cvflann::LshIndex::LshIndex<Distance>, const cvflann::Matrix<ElementType>&, const cvflann::IndexParams&, Distance>(),
      Arg("input_data"), Arg("params") = static_cast<const IndexParams &>(LshIndexParams()), Arg("d") = static_cast<Distance>(Distance())).
    define_constructor(Constructor<cvflann::LshIndex::LshIndex<Distance>, const cvflann::LshIndex<Distance>&>(),
      Arg("")).
