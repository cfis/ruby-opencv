...
{
  klass.define_constructor(Constructor<cvflann::KDTreeIndex::KDTreeIndex<Distance>, const cvflann::Matrix<ElementType>&, const cvflann::IndexParams&, Distance>(),
      Arg("input_data"), Arg("params") = static_cast<const IndexParams &>(KDTreeIndexParams()), Arg("d") = static_cast<Distance>(Distance())).
    define_constructor(Constructor<cvflann::KDTreeIndex::KDTreeIndex<Distance>, const cvflann::KDTreeIndex<Distance>&>(),
      Arg("")).
