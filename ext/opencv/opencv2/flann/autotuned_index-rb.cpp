...
{
  klass.define_constructor(Constructor<cvflann::AutotunedIndex::AutotunedIndex<Distance>, const cvflann::Matrix<ElementType>&, const cvflann::IndexParams&, Distance>(),
      Arg("input_data"), Arg("params") = static_cast<const IndexParams &>(AutotunedIndexParams()), Arg("d") = static_cast<Distance>(Distance())).
    define_constructor(Constructor<cvflann::AutotunedIndex::AutotunedIndex<Distance>, const cvflann::AutotunedIndex<Distance>&>(),
      Arg("")).
